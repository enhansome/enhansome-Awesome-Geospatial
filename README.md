...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,729 | 🐛 163 | 🌐 Go | 📅 2026-09-02 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 356 | 🌐 Java | 📅 2026-09-09 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 626 | 🐛 7 | 🌐 C | 📅 2026-09-09 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [H2GIS](https://github.com/orbisgis/h2gis) ⭐ 222 | 🐛 36 | 🌐 PLpgSQL | 📅 2026-06-24 - A spatial extension of the H2 database.
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,247 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-09 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,585 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-09 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,535 | 🐛 118 | 🌐 HTML | 📅 2026-08-25 - An open-source JavaScript library for integrated 2D/3D maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,061 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-08 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,307 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-09 - An SVG mapping component library for React, built on top of d3-geo.
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,051 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data into vector tiles on the fly.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,363 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-09 - A library for building rich, web-based geospatial data explorers.
...
* [d3-geo](https://github.com/d3/d3-geo) ⭐ 1,100 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 - A library for creating maps based on D3.js.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 34 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-09 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-09 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 243 | 🐛 23 | 🌐 Python | 📅 2026-09-09 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 186 | 🐛 2 | 🌐 Python | 📅 2026-09-02 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,599 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,125 | 🐛 456 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,832 | 🐛 98 | 🌐 Python | 📅 2026-09-08 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [NLMR](https://github.com/ropensci/NLMR) ⭐ 68 | 🐛 11 | 🌐 R | 📅 2026-08-31 - R package to simulate neutral landscape models.
...
* [H3](https://github.com/uber/h3) ⭐ 6,531 | 🐛 167 | 🌐 C | 📅 2026-09-03 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,945 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
...
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,139 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-09 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,600 | 🐛 779 | 🌐 C++ | 📅 2026-09-09 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,460 | 🐛 113 | 🌐 Python | 📅 2026-09-09 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,183 | 🐛 941 | 🌐 C++ | 📅 2026-09-09 - Open Source Routing Engine for OpenStreetMap.
...
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,855 | 🐛 50 | 🌐 C++ | 📅 2026-09-08 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,800 | 🐛 61 | 🌐 C | 📅 2026-09-09 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 58 | 🌐 C++ | 📅 2026-09-08 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [libspatialindex](https://github.com/libspatialindex/libspatialindex) ⭐ 796 | 🐛 25 | 🌐 C++ | 📅 2026-09-09 - C++ implementation of R\*-tree, an MVR-tree and a TPR-tree with C API.
...
* [RoutingKit](https://github.com/RoutingKit/RoutingKit) ⭐ 439 | 🐛 43 | 🌐 C++ | 📅 2026-04-13 - RoutingKit is a C++ library that provides advanced route planning functionality.
...
* [LASzip](https://github.com/LASzip/LASzip) ⭐ 234 | 🐛 26 | 🌐 C++ | 📅 2026-08-21 - Quickly turns bulky LAS files into compact LAZ files without information loss.
...
* [SRTM](https://github.com/adriankumpf/srtm) ⭐ 7 | 🐛 1 | 🌐 Elixir | 📅 2026-09-09 - Query locations for elevation data from the NASA Shuttle Radar Topography Mission.

## Fortran

* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 114 | 🐛 35 | 🌐 Fortran | 📅 2026-09-09 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [pg\_featureserv](https://github.com/CrunchyData/pg_featureserv) ⭐ 539 | 🐛 62 | 🌐 Go | 📅 2025-09-17 - Lightweight RESTful Geospatial Feature Server for PostGIS in Go.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,678 | 🐛 242 | 🌐 Java | 📅 2026-09-09 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,040 | 🐛 46 | 🌐 Java | 📅 2026-09-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,232 | 🐛 225 | 🌐 Java | 📅 2026-09-05 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,694 | 🐛 1,663 | 🌐 JavaScript | 📅 2026-09-09 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,570 | 🐛 518 | 🌐 TypeScript | 📅 2026-09-09 - WebGL2 powered geospatial visualization layers.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,946 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,773 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,358 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [flatbush](https://github.com/mourner/flatbush) ⭐ 1,599 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-08 - A really fast static spatial index for 2D points and rectangles in JavaScript.
* [JSTS](https://github.com/bjornharrtell/jsts) ⭐ 1,562 | 🐛 9 | 🌐 JavaScript | 📅 2025-01-02 - Port of the Java JTS library.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,363 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-09 - A library for building rich, web-based geospatial data explorers.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,343 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,238 | 🐛 256 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,099 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-08 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,083 | 🐛 246 | 🌐 JavaScript | 📅 2026-09-07 - Draw tools for mapbox-gl-js.
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,046 | 🐛 95 | 🌐 JavaScript | 📅 2026-05-26 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
...
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 820 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
...
* [Euclid.ts](https://github.com/mathigon/euclid.js) ⭐ 135 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-12 - 2D Euclidean geometry classes, utilities, and drawing tools.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-25 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 59 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-08 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 9 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-07 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [GeoStats.jl](https://github.com/JuliaEarth/GeoStats.jl) ⭐ 591 | 🐛 5 | 🌐 Julia | 📅 2026-08-27 - An extensible framework for high-performance geostatistics in Julia.
...
* [GeoData.jl](https://github.com/rafaqz/Rasters.jl) ⭐ 264 | 🐛 170 | 🌐 Julia | 📅 2026-08-26 - Standardising geospatial raster data in the Julia language.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 221 | 🐛 27 | 🌐 Julia | 📅 2026-09-03 - Generic Mapping Tools Library Wrapper for Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-09 - Interface for Reading from the Earth System Datacube.
...
* [geopy](https://github.com/geopy/geopy) ⭐ 4,860 | 🐛 54 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,023 | 🐛 53 | 🌐 Python | 📅 2026-09-09 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,359 | 🐛 8 | 🌐 Python | 📅 2026-09-07 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,411 | 🐛 35 | 🌐 Python | 📅 2026-08-28 - Implementation of Trajectory classes and functions built on top of GeoPandas.
...
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 971 | 🐛 79 | 🌐 Python | 📅 2026-09-09 - xarray-spatial implements common raster analysis functions using Numba and provides an easy-to-install, easy-to-extend codebase for raster analysis.
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 890 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 58 | 🌐 C++ | 📅 2026-09-08 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 186 | 🌐 Python | 📅 2026-09-09 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 637 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [pandana](https://github.com/UDST/pandana) ⭐ 428 | 🐛 45 | 🌐 C++ | 📅 2026-09-02 - Pandas Network Analysis - dataframes of network queries, quickly.
...
* [EOReader](https://github.com/sertit/eoreader) ⭐ 347 | 🐛 61 | 🌐 Python | 📅 2026-09-09 - EOReader is a multi-satellite reader allowing you to open optical and SAR data.
...
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 50 | 🌐 Python | 📅 2026-09-07 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,445 | 🐛 69 | 🌐 R | 📅 2026-09-09 - Simple Features for R.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 947 | 🐛 20 | 🌐 R | 📅 2026-09-09 - Package to download official spatial data sets of Brazil.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 263 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [osrm R](https://github.com/rCarto/osrm) ⭐ 254 | 🐛 1 | 🌐 R | 📅 2026-09-02 - Interface Between R and the OpenStreetMap-Based Routing Service OSRM.
* [mapsf](https://github.com/riatelab/mapsf) ⭐ 246 | 🐛 2 | 🌐 R | 📅 2026-09-03 - Thematic cartography with R.
...
* [osmextract](https://github.com/ropensci/osmextract) ⭐ 195 | 🐛 31 | 🌐 R | 📅 2026-09-03 - Download and import OpenStreetMap data from Geofabrik and other providers.
...
* [biomod2](https://github.com/biomodhub/biomod2) ⭐ 127 | 🐛 24 | 🌐 R | 📅 2026-09-01 - Computer platform for ensemble forecasting of species distributions, enabling the treatment of a range of methodological uncertainties in models and the examination of species-environment relationships.
...
* [phenofit](https://github.com/kongdd/phenofit) ⭐ 93 | 🐛 3 | 🌐 R | 📅 2026-07-09 - A state-of-the-art Vegetation Phenology extraction package.
...
* [biodivMapR](https://github.com/jbferet/biodivMapR) ⭐ 64 | 🐛 0 | 🌐 R | 📅 2026-09-08 - R package for α- and β-diversity mapping using remotely-sensed images.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,791 | 🐛 125 | 🌐 Rust | 📅 2026-09-09 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,169 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,902 | 🐛 50 | 🌐 Rust | 📅 2026-09-09 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,929 | 🐛 133 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,753 | 🐛 139 | 🌐 Rust | 📅 2026-09-09 - A high-performance, general-purpose graph library for Python, written in Rust.
...
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 913 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 820 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 641 | 🐛 43 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 638 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23 - 3D Gaussian Splatting renderer for WebAssembly with lock-free multithreading.
...
* [rstar](https://github.com/georust/rstar) ⭐ 557 | 🐛 49 | 🌐 Rust | 📅 2026-09-07 - R\*-tree library for the rust ecosystem.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 501 | 🐛 120 | 🌐 Rust | 📅 2026-09-09 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 470 | 🐛 45 | 🌐 Rust | 📅 2026-09-04 - Zero-Copy reading and writing of geospatial data.
* [gdal](https://github.com/georust/rust-gdal) ⭐ 448 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 424 | 🐛 85 | 🌐 Rust | 📅 2026-09-01 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
...
* [spade](https://github.com/Stoeoef/spade) ⭐ 336 | 🐛 16 | 🌐 Rust | 📅 2026-03-24 - Delaunay Triangulations for the Rust ecosystem.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 270 | 🐛 23 | 🌐 Rust | 📅 2026-09-08 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [image-tiff](https://github.com/image-rs/image-tiff) ⭐ 167 | 🐛 32 | 🌐 Rust | 📅 2026-09-06 - TIFF decoding and encoding library in pure Rust.
...
* [stac-rs](https://github.com/gadomski/stac-rs) ⭐ 144 | 🐛 29 | 🌐 Rust | 📅 2026-09-08 - Rust implementation of the SpatioTemporal Asset Catalog (STAC) specification.
...
* [RINEX](https://github.com/georust/rinex) ⭐ 126 | 🐛 32 | 🌐 Rust | 📅 2026-09-09 - RINEX analysis & and processing.
...
* [PMTiles (for Rust)](https://github.com/stadiamaps/pmtiles-rs) ⭐ 110 | 🐛 11 | 🌐 Rust | 📅 2026-09-08 - Rust implementation of PMTiles
* [tzf-rs](https://github.com/ringsaturn/tzf-rs) ⭐ 108 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - Get timezone via longitude\&latitude in Rust in a fast way
...
* [plateau-gis-converter](https://github.com/MIERUNE/plateau-gis-converter) ⭐ 104 | 🐛 53 | 🌐 Rust | 📅 2026-09-07 - A GUI and CLI tool for converting PLATEAU's 3D city models (CityGML) of Japan into various geospatial formats, including 3D Tiles, MVT, and GeoPackage.
...
* [Proj4rs](https://github.com/3liz/proj4rs) ⭐ 79 | 🐛 2 | 🌐 Rust | 📅 2026-09-09 - Rust adaptation of Proj4
* [gtfs-structures](https://github.com/rust-transit/gtfs-structure) ⭐ 78 | 🐛 22 | 🌐 Rust | 📅 2026-09-01 - Read GTFS files into structs, with smart references.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 74 | 🐛 13 | 🌐 Rust | 📅 2026-09-09 - Manage, convert and enrich transit data.
...
* [wkt](https://github.com/georust/rust-wkt) ⭐ 56 | 🐛 19 | 🌐 Rust | 📅 2026-09-08 - Rust read/write support for well-known text (WKT).
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 66 | 🌐 Jupyter Notebook | 📅 2026-09-09 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-07 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 3 | 🌐 Rust | 📅 2026-09-08 - utils & tiles w/ (rs & pyo3).
...
* [pgstac-rs](https://github.com/gadomski/pgstac-rs) ⚠️ Archived - Rust interface for [pgstac](https://github.com/stac-utils/pgstac) ⭐ 223 | 🐛 72 | 🌐 PLpgSQL | 📅 2026-08-31.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 248 | 🌐 Scala | 📅 2026-09-07 - GeoTrellis is a Scala library and framework that uses Spark to work with raster data.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 215 | 🌐 Swift | 📅 2026-09-09 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,364 | 🐛 3,508 | 🌐 C++ | 📅 2026-09-09 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,194 | 🐛 612 | 🌐 C++ | 📅 2026-09-09 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-09 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 568 | 🐛 32 | 🌐 Kotlin | 📅 2026-09-09 - Add interactive vector tile maps to your Compose app
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 248 | 🌐 Scala | 📅 2026-09-07 - GeoTrellis is a geographic data processing engine for high performance applications.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,363 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,399 | 🐛 70 | 🌐 Python | 📅 2026-09-09 - Python Data. Leaflet.js Maps.
...
* [GeoJs](https://github.com/OpenGeoscience/geojs) ⭐ 471 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-08 - High-performance visualization and interactive data exploration of scientific and geospatial location aware datasets.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,352 | 🐛 61 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,169 | 🐛 114 | 🌐 Java | 📅 2026-09-07 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [Osm2pgsql](https://github.com/openstreetmap/osm2pgsql) ⭐ 1,682 | 🐛 37 | 🌐 C++ | 📅 2026-07-24 - osm2pgsql is a tool for loading OpenStreetMap data into a PostgreSQL.
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 977 | 🐛 221 | 🌐 C | 📅 2026-09-09 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 430 | 🐛 181 | 🌐 Python | 📅 2026-09-09 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 282 | 🐛 0 | 🌐 Python | 📅 2026-09-09 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 316 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 319,561 | 🐛 18 | 🌐 Python | 📅 2026-09-01
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,248 | 🐛 0 | 📅 2026-09-04
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,173 | 🐛 23 | 🌐 Python | 📅 2026-09-06
* [Awesome Frontend GIS](https://github.com/joewdavies/awesome-frontend-gis) ⭐ 858 | 🐛 8 | 📅 2026-08-18 - Geographic Information Systems (GIS) for web browsers. For managing, analyzing, editing, and visualizing geographic data.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 583 | 🐛 4 | 📅 2025-02-20
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 536 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-09-04
...
* [Awesome SQLite](https://github.com/planetopendata/awesome-sqlite) ⭐ 403 | 🐛 9 | 📅 2026-08-22
...
* [Awesome Earth Observation Instruments](https://github.com/awesome-spectral-indices/awesome-earth-observation-instruments) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-23 - A machine-readable catalogue of Earth observation instruments with spectral, spatial, temporal, and operational characteristics.
