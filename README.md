...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 621 | 🐛 6 | 🌐 C | 📅 2026-08-16 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [duckdb-raster](https://github.com/ahuarte47/duckdb-raster) ⭐ 52 | 🐛 0 | 🌐 C++ | 📅 2026-08-16 - DuckDB Extension for reading and writing raster files using SQL.
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,355 | 🐛 889 | 🌐 TypeScript | 📅 2026-08-13 - A library for building rich, web-based geospatial data explorers.
...
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,145 | 🐛 26 | 🌐 Python | 📅 2026-08-15 - A dynamic Web Map tile server.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-16 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-16 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 187 | 🐛 22 | 🌐 Python | 📅 2026-08-16 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 157 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,576 | 🐛 821 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,796 | 🐛 109 | 🌐 Python | 📅 2026-08-13 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,465 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [wxee](https://github.com/aazuspan/wxee) ⭐ 216 | 🐛 1 | 🌐 Python | 📅 2025-08-23 - A Python interface between Earth Engine and xarray for processing weather and climate data.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,918 | 🐛 868 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
...
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,110 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 767 | 🐛 110 | 🌐 Python | 📅 2026-08-11 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [H3](https://github.com/uber/h3) ⭐ 6,465 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,582 | 🐛 759 | 🌐 C++ | 📅 2026-08-16 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,074 | 🐛 933 | 🌐 C++ | 📅 2026-08-16 - Open Source Routing Engine for OpenStreetMap.
...
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,833 | 🐛 50 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
...
* [OpenOrienteering Mapper](https://github.com/OpenOrienteering/mapper) ⭐ 492 | 🐛 553 | 🌐 C++ | 📅 2026-07-21 - OpenOrienteering Mapper is a software for creating maps for the orienteering sport.
...
* [BoxTree](https://github.com/tidwall/boxtree) ⭐ 347 | 🐛 2 | 🌐 Go | 📅 2026-08-11 - An R-tree implementation for Go.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,632 | 🐛 243 | 🌐 Java | 📅 2026-08-15 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 2,993 | 🐛 47 | 🌐 Java | 📅 2026-08-15 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,413 | 🐛 484 | 🌐 TypeScript | 📅 2026-08-16 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,485 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-06 - React friendly API wrapper around MapboxGL JS.
* [gmaps.js](https://github.com/hpneo/gmaps) ⚠️ Archived - gmaps.js allows you to use the potential of Google Maps in a simple way.
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,914 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,347 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-10 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,083 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-16 - A cross provider JavaScript library for drawing on maps
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-16 - Interface for Reading from the Earth System Datacube.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,277 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,561 | 🐛 159 | 🌐 Python | 📅 2026-08-14 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,438 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,407 | 🐛 33 | 🌐 Python | 📅 2026-08-09 - Implementation of Trajectory classes and functions built on top of GeoPandas.
...
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 961 | 🐛 89 | 🌐 Python | 📅 2026-08-16 - xarray-spatial implements common raster analysis functions using Numba and provides an easy-to-install, easy-to-extend codebase for raster analysis.
...
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 181 | 🌐 Python | 📅 2026-08-16 - Pythonic interface for the Generic Mapping Tools (GMT).
* [networkit](https://github.com/networkit/networkit) ⭐ 870 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [rioxarray](https://github.com/corteva/rioxarray) ⭐ 621 | 🐛 81 | 🌐 Python | 📅 2026-07-27 - rasterio xarray extension.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 611 | 🐛 46 | 🌐 Python | 📅 2026-08-11 - A Python Framework for Large-Scale SAR Satellite Data Processing.
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 597 | 🐛 0 | 🌐 Python | 📅 2026-07-27 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [openrouteservice-py](https://github.com/GIScience/openrouteservice-py) ⭐ 455 | 🐛 16 | 🌐 Python | 📅 2025-02-05 - The Python API to consume openrouteservice(s) painlessly!
...
* [geospatial](https://github.com/giswqs/geospatial) ⭐ 431 | 🐛 11 | 🌐 Dockerfile | 📅 2026-08-10 - A collection of Python packages for geospatial analysis and data visualization.
...
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 310 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,189 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 776 | 🐛 63 | 🌐 R | 📅 2026-08-10 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 703 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 615 | 🐛 14 | 🌐 C++ | 📅 2026-08-16 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
...
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 185 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,189 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,486 | 🐛 141 | 🌐 Rust | 📅 2026-08-16 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,153 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,832 | 🐛 79 | 🌐 Rust | 📅 2026-08-15 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
...
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,189 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 909 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 816 | 🐛 36 | 🌐 Rust | 📅 2026-08-10 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 634 | 🐛 40 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
...
* [rstar](https://github.com/georust/rstar) ⭐ 552 | 🐛 42 | 🌐 Rust | 📅 2026-08-13 - R\*-tree library for the rust ecosystem.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 488 | 🐛 131 | 🌐 Rust | 📅 2026-08-16 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [Cavalier Contours](https://github.com/jbuckmccready/cavalier_contours) ⭐ 227 | 🐛 12 | 🌐 Rust | 📅 2026-08-16 - 2D polyline/shape library for offsetting, combining, etc.
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 203 | 🐛 2 | 🌐 Rust | 📅 2026-08-16 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
...
* [iTriangle](https://github.com/iShape-Rust/iTriangle) ⭐ 156 | 🐛 4 | 🌐 Rust | 📅 2026-08-16 - A fast, stable, and robust 2d triangulation library.
...
* [gtfs-structures](https://github.com/rust-transit/gtfs-structure) ⭐ 77 | 🐛 22 | 🌐 Rust | 📅 2026-08-16 - Read GTFS files into structs, with smart references.
...
* [Polylabel-rs](https://github.com/urschrei/polylabel-rs) ⭐ 61 | 🐛 3 | 🌐 Rust | 📅 2026-06-28 - A Rust implementation of the Polylabel algorithm, with FFI.
* [earcut-rs](https://github.com/ciscorn/earcut-rs) ⭐ 56 | 🐛 3 | 🌐 Rust | 📅 2026-07-26 - Port of the Earcut polygon triangulation library with performance in mind.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-16 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [Routers](https://github.com/routers-org/routers) ⭐ 2 | 🐛 13 | 🌐 Rust | 📅 2026-08-13 - Set of routing tools designed for system-agnostic maps.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,109 | 🐛 3,451 | 🌐 C++ | 📅 2026-08-16 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,142 | 🐛 562 | 🌐 C++ | 📅 2026-08-15 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
...
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 537 | 🐛 61 | 🌐 Kotlin | 📅 2026-08-16 - Add interactive vector tile maps to your Compose app
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,296 | 🐛 319 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,395 | 🐛 73 | 🌐 Python | 📅 2026-08-16 - Python Data. Leaflet.js Maps.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,142 | 🐛 112 | 🌐 Java | 📅 2026-08-13 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [eodag](https://github.com/CS-SI/eodag) ⭐ 425 | 🐛 176 | 🌐 Python | 📅 2026-08-16 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 274 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 314,299 | 🐛 16 | 🌐 Python | 📅 2026-08-16
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,499 | 🐛 91 | 📅 2024-05-17
* [Awesome Deep Vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,182 | 🐛 47 | 📅 2023-08-15
* [Awesome Semantic Segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,851 | 🐛 17 | 📅 2021-05-08
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,231 | 🐛 0 | 📅 2026-08-02
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,502 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,477 | 🐛 55 | 📅 2026-07-21
...
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,526 | 🐛 1 | 📅 2026-07-23
