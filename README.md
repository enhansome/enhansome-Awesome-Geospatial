...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,714 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,977 | 🐛 356 | 🌐 Java | 📅 2026-08-11 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,070 | 🐛 116 | 🌐 C++ | 📅 2026-07-01 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 826 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 621 | 🐛 11 | 🌐 C | 📅 2026-08-13 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [H2GIS](https://github.com/orbisgis/h2gis) ⭐ 220 | 🐛 33 | 🌐 PLpgSQL | 📅 2026-06-24 - A spatial extension of the H2 database.
* [GeoDesk](https://github.com/clarisma/geodesk) ⭐ 191 | 🐛 43 | 🌐 Java | 📅 2026-07-17 - Fast and storage-efficient spatial database engine for OpenStreetMap data
* [duckdb-raster](https://github.com/ahuarte47/duckdb-raster) ⭐ 52 | 🐛 0 | 🌐 C++ | 📅 2026-08-05 - DuckDB Extension for reading and writing raster files using SQL.
...
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,527 | 🐛 117 | 🌐 HTML | 📅 2026-08-10 - An open-source JavaScript library for integrated 2D/3D maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,048 | 🐛 214 | 🌐 TypeScript | 📅 2026-07-30 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,309 | 🐛 190 | 🌐 JavaScript | 📅 2024-08-08 - An SVG mapping component library for React, built on top of d3-geo.
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,135 | 🐛 131 | 🌐 HTML | 📅 2026-05-16 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,354 | 🐛 889 | 🌐 TypeScript | 📅 2026-08-13 - A library for building rich, web-based geospatial data explorers.
...
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,145 | 🐛 24 | 🌐 Python | 📅 2026-08-11 - A dynamic Web Map tile server.
...
* [ArcGIS REST JS](https://github.com/Esri/arcgis-rest-js) ⭐ 390 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-12 - Compact, modular JavaScript wrappers for the ArcGIS REST API that run in Node.js and modern browsers.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 30 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-10 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-13 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [Nanocubes](https://github.com/laurolins/nanocube) ⭐ 731 | 🐛 42 | 🌐 C | 📅 2023-05-04 - An in-memory data structure for spatiotemporal data cubes.
* [PGRestAPI](https://github.com/spatialdev/PGRestAPI) ⭐ 434 | 🐛 88 | 🌐 JavaScript | 📅 2018-04-28 - Node.js REST API for PostGres Spatial Entities. AKA: SpatialServer.
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 179 | 🐛 10 | 🌐 Python | 📅 2026-08-13 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [PySAR](https://github.com/insarlab/PySAR) ⭐ 824 | 🐛 68 | 🌐 Python | 📅 2026-08-11 - InSAR time series analysis in Python.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 610 | 🐛 46 | 🌐 Python | 📅 2026-08-11 - A Python Framework for Large-Scale SAR Satellite Data Processing.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 159 | 🐛 2 | 🌐 Python | 📅 2026-07-24 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,574 | 🐛 821 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 703 | 🐛 16 | 🌐 R | 📅 2026-07-18 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [plas.io](https://github.com/verma/plasio) ⭐ 537 | 🐛 36 | 🌐 JavaScript | 📅 2020-03-26 - WebGL point cloud rendering.
* [Entwine](https://github.com/connormanning/entwine) ⭐ 526 | 🐛 3 | 🌐 C++ | 📅 2026-06-02 - Point cloud indexing for massive datasets.
...
* [3dfier](https://github.com/tudelft3d/3dfier) ⭐ 629 | 🐛 30 | 🌐 C++ | 📅 2026-05-06 - The open-source tool for creation of 3D models.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,108 | 🐛 454 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,791 | 🐛 102 | 🌐 Python | 📅 2026-08-13 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
* [nlrx](https://github.com/ropensci/nlrx) ⭐ 80 | 🐛 21 | 🌐 R | 📅 2025-11-25 - Provides tools to setup and execute NetLogo simulations from R.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 261 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [PyLandStats](https://github.com/martibosch/pylandstats) ⭐ 111 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - An open-source Pythonic library to compute landscape metrics.
...
* [H3](https://github.com/uber/h3) ⭐ 6,460 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [OpenSky API](https://github.com/openskynetwork/opensky-api) ⭐ 460 | 🐛 14 | 🌐 Python | 📅 2026-07-20 - Retrieve live airspace information.
* [movebank-api](https://github.com/movebank/movebank-api-doc) ⭐ 189 | 🐛 14 | 🌐 Python | 📅 2026-01-02 - Platform for animal tracking data.
* [Phantom Tide](https://github.com/tg12/phantomtide) ⭐ 122 | 🐛 3 | 📅 2026-06-14 - Real-time geospatial intelligence platform for maritime and airspace monitoring, combining vessel tracking, ADS-B flight activity, official notices, environmental context, and satellite detections in a single live map workflow.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 776 | 🐛 63 | 🌐 R | 📅 2026-08-10 - Google Earth Engine for R.
* [eemont](https://github.com/davemlz/eemont) ⭐ 450 | 🐛 9 | 🌐 Python | 📅 2026-08-05 - A python package that extends Google Earth Engine.
...
* [wxee](https://github.com/aazuspan/wxee) ⭐ 215 | 🐛 1 | 🌐 Python | 📅 2025-08-23 - A Python interface between Earth Engine and xarray for processing weather and climate data.
* [spectral](https://github.com/awesome-spectral-indices/spectral) ⭐ 205 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-11 - Awesome Spectral Indices for the Google Earth Engine JavaScript API (Code Editor).
* [GEET](https://github.com/sacridini/GEET) ⭐ 175 | 🐛 2 | 🌐 JavaScript | 📅 2024-08-16 - Google Earth Engine Toolbox - Library to write small EE apps or big/complex apps with a lot less code.
* [gee-atmcorr-S2](https://github.com/samsammurphy/gee-atmcorr-S2) ⭐ 161 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2020-10-16 - Atmospheric correction of Sentinel 2 imagery in Google Earth Engine using Py6S.
* [OpenEarthEngineLibrary](https://github.com/open-geocomputing/OpenEarthEngineLibrary) ⭐ 149 | 🐛 2 | 🌐 JavaScript | 📅 2026-06-28 - Collection of code goodies for Google Earth Engine(GEE).
* [geeup](https://github.com/samapriya/geeup) ⭐ 138 | 🐛 0 | 🌐 Python | 📅 2025-12-31 - Simple CLI for Earth Engine Uploads.
* [sankee](https://github.com/aazuspan/sankee) ⭐ 107 | 🐛 2 | 🌐 Python | 📅 2025-06-25 - Visualize classified time series data with interactive Sankey plots in Google Earth Engine.
...
* [OEEex](https://github.com/open-geocomputing/OEEex) ⭐ 43 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-23 - A chrome extension to enhance Google Earth Engine code editor.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,914 | 🐛 867 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,142 | 🐛 186 | 🌐 Python | 📅 2026-08-13 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,108 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [Raster Vision](https://github.com/azavea/raster-vision) ⭐ 2,238 | 🐛 46 | 🌐 Python | 📅 2026-06-04 - An open source framework for deep learning on satellite and aerial imagery.
...
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 766 | 🐛 108 | 🌐 Python | 📅 2026-08-11 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [Deep Learning ArcGIS](https://github.com/Esri/deep-learning-frameworks) ⭐ 643 | 🐛 9 | 📅 2026-07-21 - Deep Learning Libraries Installers for ArcGIS.
* [TernausNetV2](https://github.com/ternaus/TernausNetV2) ⭐ 544 | 🐛 14 | 🌐 Jupyter Notebook | 📅 2020-05-23 - TernausNetV2: Fully Convolutional Network for Instance Segmentation.
...
* [TorchSat](https://github.com/sshuair/torchsat) ⭐ 396 | 🐛 6 | 🌐 Python | 📅 2020-08-30 - TorchSat is an open-source PyTorch framework for satellite imagery analysis.
* [tsl](https://github.com/TorchSpatiotemporal/tsl) ⭐ 385 | 🐛 22 | 🌐 Python | 📅 2026-07-27 - PyTorch library for processing spatiotemporal data.
...
* [Temporal Convolutional Neural Network](https://github.com/charlotte-pel/temporalCNN) ⭐ 173 | 🐛 1 | 🌐 Python | 📅 2020-05-07 - Temporal Convolutional Neural Network for the Classification of Satellite Image Time Series.
...
* [aviary](https://github.com/geospaitial-lab/aviary) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - Pythonic Framework for AI Inference on Geospatial Data.
* [SamGIS](https://github.com/trincadev/samgis-be) ⚠️ Archived – Image Segmentation machine learning based (Segment Anything by Meta - Facebook) applied to GIS and geo data also with GPU requirements. A Segment Anything HuggingFace demo [here](https://huggingface.co/spaces/aletrn/samgis) and an HuggingFace [demo](https://huggingface.co/spaces/aletrn/samgis-lisa-on-cuda) with natural language-based image segmentation capabilities via [LISA](https://github.com/dvlab-research/LISA) ⭐ 2,671 | 🐛 115 | 🌐 Python | 📅 2025-02-16.

## MCP Servers

* [emem](https://github.com/Vortx-AI/emem) ⭐ 52 | 🐛 0 | 🌐 Rust | 📅 2026-08-13 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,571 | 🐛 83 | 🌐 C | 📅 2026-08-13 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,460 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,869 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [FORCE](https://github.com/davidfrantz/force) ⭐ 198 | 🐛 22 | 🌐 C | 📅 2026-06-12 - Framework for Operational Radiometric Correction for Environmental monitoring.
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 68 | 🐛 57 | 🌐 C | 📅 2026-08-07 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,582 | 🐛 767 | 🌐 C++ | 📅 2026-08-13 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,373 | 🐛 115 | 🌐 Python | 📅 2026-08-13 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,066 | 🐛 931 | 🌐 C++ | 📅 2026-08-13 - Open Source Routing Engine for OpenStreetMap.
...
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,107 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,708 | 🐛 75 | 🌐 C++ | 📅 2026-08-11 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,831 | 🐛 50 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,794 | 🐛 58 | 🌐 C | 📅 2026-08-10 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 870 | 🐛 39 | 🌐 C++ | 📅 2026-08-13 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [hmm](https://github.com/fogleman/hmm) ⭐ 615 | 🐛 13 | 🌐 C | 📅 2023-12-19 - Heightmap meshing utility
...
* [entwine](https://github.com/connormanning/entwine) ⭐ 526 | 🐛 3 | 🌐 C++ | 📅 2026-06-02 - Entwine is a data organization library for massive point clouds, designed to conquer datasets of hundreds of billions of points as well as desktop-scale point clouds.
* [OpenOrienteering Mapper](https://github.com/OpenOrienteering/mapper) ⭐ 491 | 🐛 553 | 🌐 C++ | 📅 2026-07-21 - OpenOrienteering Mapper is a software for creating maps for the orienteering sport.
* [cpd](https://github.com/gadomski/cpd) ⭐ 440 | 🐛 17 | 🌐 C++ | 📅 2026-06-22 - Coherent Point Drift (CPD) is a point-set registration algorithm.
* [RoutingKit](https://github.com/RoutingKit/RoutingKit) ⭐ 437 | 🐛 43 | 🌐 C++ | 📅 2026-04-13 - RoutingKit is a C++ library that provides advanced route planning functionality.
...
* [LASzip](https://github.com/LASzip/LASzip) ⭐ 232 | 🐛 26 | 🌐 C++ | 📅 2026-08-10 - Quickly turns bulky LAS files into compact LAZ files without information loss.
...
* [prepair](https://github.com/tudelft3d/prepair) ⭐ 114 | 🐛 12 | 🌐 C++ | 📅 2026-04-29 - Automatic repair of single polygons (according to the OGC Simple Features / ISO19107 rules) using a constrained triangulation.
...
* [geo-utils-cpp](https://github.com/gistrec/geo-utils-cpp) ⭐ 60 | 🐛 2 | 🌐 C++ | 📅 2026-08-10 - Header-only C++17 library for spherical (lat/lng) geometry: distance, bearing, area, point-in-polygon.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,710 | 🐛 83 | 🌐 C# | 📅 2026-08-11 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [MaxRev.Gdal.Core](https://github.com/MaxRev-Dev/gdal.netcore) ⭐ 210 | 🐛 3 | 🌐 C# | 📅 2026-08-05 - Bindings for GDAL and OGR (both win-x64 and linux-x64).
* [Geo](https://github.com/sibartlett/Geo) ⭐ 192 | 🐛 7 | 🌐 C# | 📅 2026-08-09 - A geospatial library for .NET
...
* [geo](https://github.com/bryanjos/geo) ⭐ 678 | 🐛 9 | 🌐 Elixir | 📅 2026-08-13 - A collection of GIS functions for Elixir.
* [GeoPostGIS](https://github.com/bryanjos/geo_postgis) ⭐ 329 | 🐛 10 | 🌐 Elixir | 📅 2026-08-13 - Postgrex extension for the PostGIS data types.
...
* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 111 | 🐛 35 | 🌐 Fortran | 📅 2026-07-23 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [S2](https://github.com/golang/geo) ⭐ 1,847 | 🐛 37 | 🌐 Go | 📅 2026-08-10 - S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the best planar geometry libraries.
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,498 | 🐛 182 | 🌐 Go | 📅 2026-08-10 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
* [Draw2D](https://github.com/llgcode/draw2d) ⭐ 1,164 | 🐛 45 | 🌐 Go | 📅 2026-04-22 - 2D rendering for different output (raster, pdf).
* [orb](https://github.com/paulmach/orb) ⭐ 1,125 | 🐛 18 | 🌐 Go | 📅 2026-03-30 - A set of types for working with 2d geo and planar/projected geometric data in Golang
...
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 971 | 🐛 9 | 🌐 Go | 📅 2026-05-14 - Go library for handling geometries.
...
* [BoxTree](https://github.com/tidwall/boxtree) ⭐ 346 | 🐛 2 | 🌐 Go | 📅 2026-08-11 - An R-tree implementation for Go.
* [Go GDAL](https://github.com/lukeroth/gdal) ⭐ 318 | 🐛 27 | 🌐 Go | 📅 2026-05-31 - Go (golang) wrapper for GDAL, the Geospatial Data Abstraction Library.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,629 | 🐛 242 | 🌐 Java | 📅 2026-08-13 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 2,987 | 🐛 44 | 🌐 Java | 📅 2026-08-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,226 | 🐛 223 | 🌐 Java | 📅 2026-08-12 - JTS Topology Suite is an API of 2D spatial predicates and functions.
* [Spatial4j](https://github.com/locationtech/spatial4j) ⭐ 962 | 🐛 76 | 🌐 Java | 📅 2026-06-30 - Spatial4j is a general purpose geospatial ASL licensed open-source Java library.
...
* [Openmap](https://github.com/openmap-java/openmap) ⭐ 82 | 🐛 33 | 🌐 Java | 📅 2026-05-21 - Open Source JavaBeans-based programmer's toolkit.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,561 | 🐛 1,641 | 🌐 JavaScript | 📅 2026-08-13 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,373 | 🐛 476 | 🌐 TypeScript | 📅 2026-08-13 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,483 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-06 - React friendly API wrapper around MapboxGL JS.
* [gmaps.js](https://github.com/hpneo/gmaps) ⚠️ Archived - gmaps.js allows you to use the potential of Google Maps in a simple way.
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,912 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [geolib](https://github.com/manuelbieh/geolib) ⭐ 4,275 | 🐛 70 | 🌐 JavaScript | 📅 2026-04-03 - Library to provide basic geospatial operations like distance calculation and rotation.
* [rbush](https://github.com/mourner/rbush) ⭐ 2,767 | 🐛 12 | 🌐 JavaScript | 📅 2026-07-21 - A high-performance JavaScript library for 2D spatial indexing.
* [leaflet-providers](https://github.com/leaflet-extras/leaflet-providers) ⭐ 2,375 | 🐛 19 | 🌐 JavaScript | 📅 2026-06-11 - An extension to Leaflet that contains configurations for various free tile providers.
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,345 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-10 - A crazy fast geospatial point clustering library for browsers and Node.
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,236 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
...
* [JSTS](https://github.com/bjornharrtell/jsts) ⭐ 1,561 | 🐛 9 | 🌐 JavaScript | 📅 2025-01-02 - Port of the Java JTS library.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,354 | 🐛 889 | 🌐 TypeScript | 📅 2026-08-13 - A library for building rich, web-based geospatial data explorers.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,231 | 🐛 255 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,084 | 🐛 243 | 🌐 JavaScript | 📅 2026-08-13 - Draw tools for mapbox-gl-js.
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,081 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-08 - A cross provider JavaScript library for drawing on maps
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,041 | 🐛 93 | 🌐 JavaScript | 📅 2026-05-26 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
* [geobuf](https://github.com/mapbox/geobuf) ⭐ 1,030 | 🐛 34 | 🌐 JavaScript | 📅 2026-06-29 - A compact binary encoding for geographic data.
* [NASA WebWorldWind](https://github.com/NASAWorldWind/WebWorldWind) ⭐ 998 | 🐛 271 | 🌐 JavaScript | 📅 2025-09-20 - The NASA WorldWind Javascript SDK (WebWW) includes the library and examples for creating geo-browser web applications and for embedding a 3D globe in HTML5 web pages.
* [Geo-Three](https://github.com/tentone/geo-three) ⭐ 943 | 🐛 41 | 🌐 TypeScript | 📅 2026-04-05 - Tile based geographic world map visualization library for threejs.
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 816 | 🐛 36 | 🌐 Rust | 📅 2026-08-10 - A performant binary encoding for geographic data based on flatbuffers.
* [flatten-js](https://github.com/alexbol99/flatten-js) ⭐ 651 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-04 - For manipulating geometrical shapes, finding intersections, checking inclusion, calculating distance, transformations, and more.
...
* [PGRestAPI](https://github.com/spatialdev/PGRestAPI) ⭐ 434 | 🐛 88 | 🌐 JavaScript | 📅 2018-04-28 - Node.js REST API for PostGres Spatial Entities.
* [gdal3.js](https://github.com/bugra9/gdal3.js) ⭐ 427 | 🐛 29 | 🌐 JavaScript | 📅 2026-05-13 - Convert raster and vector geospatial data to various formats using GDAL in the browser.
* [TileStrata](https://github.com/naturalatlas/tilestrata) ⭐ 426 | 🐛 8 | 🌐 JavaScript | 📅 2021-07-21 - A pluggable Node.js map tile server.
* [math.gl](https://github.com/uber-web/math.gl) ⭐ 420 | 🐛 8 | 🌐 TypeScript | 📅 2024-05-02 - JavaScript math library focused on Geospatial and 3D use cases.
...
* [GeoPackage.js](https://github.com/ngageoint/geopackage-js) ⭐ 332 | 🐛 24 | 🌐 TypeScript | 📅 2026-06-26 - GeoPackage JS is an implementation of the OGC GeoPackage spec. This library works in both the browser and Node 4+.
* [Bertin.js](https://github.com/neocarto/bertin) ⭐ 316 | 🐛 9 | 🌐 JavaScript | 📅 2023-10-23 - A JavaScript library for visualizing geospatial data and make thematic maps for the web.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 101 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-13 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [landsat8.earth](https://github.com/kylebarron/landsat8.earth) ⭐ 39 | 🐛 16 | 🌐 JavaScript | 📅 2023-06-10 - 2D/3D WebGL-powered Landsat 8 satellite imagery analysis.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 9 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-11 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [DataFrames.jl](https://github.com/JuliaStats/DataFrames.jl) ⭐ 1,830 | 🐛 160 | 🌐 Julia | 📅 2026-08-12 - Tools for working with tabular data in Julia.
* [GeoStats.jl](https://github.com/JuliaEarth/GeoStats.jl) ⭐ 590 | 🐛 6 | 🌐 Julia | 📅 2026-08-07 - An extensible framework for high-performance geostatistics in Julia.
* [Images.jl](https://github.com/JuliaImages/Images.jl) ⭐ 551 | 🐛 44 | 🌐 Julia | 📅 2026-05-01 - An image processing library for Julia.
* [NearestNeighbors.jl](https://github.com/KristofferC/NearestNeighbors.jl) ⭐ 468 | 🐛 31 | 🌐 Julia | 📅 2026-07-13 - High performance nearest neighbor data structures and algorithms for Julia.
* [GeoData.jl](https://github.com/rafaqz/Rasters.jl) ⭐ 264 | 🐛 167 | 🌐 Julia | 📅 2026-08-04 - Standardising geospatial raster data in the Julia language.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 220 | 🐛 27 | 🌐 Julia | 📅 2026-08-10 - Generic Mapping Tools Library Wrapper for Julia.
* [GeoMakie.jl](https://github.com/JuliaPlots/GeoMakie.jl) ⭐ 218 | 🐛 100 | 🌐 Julia | 📅 2026-08-10 - Geographical plotting utilities for Makie.jl
...
* [ArchGDAL](https://github.com/yeesian/ArchGDAL.jl) ⭐ 150 | 🐛 96 | 🌐 Julia | 📅 2026-08-13 - Vector and Raster interfaces.
...
* [EarthEngine.jl](https://github.com/KMarkert/EarthEngine.jl) ⭐ 50 | 🐛 4 | 🌐 Julia | 📅 2023-09-02 - Google Earth Engine in Julia.
* [ImageFeatures.jl](https://github.com/JuliaImages/ImageFeatures.jl) ⭐ 48 | 🐛 22 | 🌐 Julia | 📅 2026-07-01 - Image feature detection for the Julia language.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-13 - Interface for Reading from the Earth System Datacube.
* [STAC.jl](https://github.com/JuliaClimate/STAC.jl) ⭐ 32 | 🐛 7 | 🌐 Julia | 📅 2026-07-24 - SpatioTemporal Asset Catalog (STAC) julia client.
...
* [SpectralIndices.jl](https://github.com/awesome-spectral-indices/SpectralIndices.jl) ⭐ 22 | 🐛 12 | 🌐 Julia | 📅 2026-08-13 - Julia package for working with spectral indices commonly used in remote sensing and earth observation applications.
...
* [Lets-Plot](https://github.com/JetBrains/lets-plot-kotlin/blob/master/docs/geotools.md) ⭐ 484 | 🐛 10 | 🌐 Kotlin | 📅 2026-07-02 - An open-source plotting library. Together with GeoTools it allows you to visualize geospatial data in Jupyter notebooks or a JVM application.
...
* [Spatial K](https://github.com/maplibre/spatial-k) ⭐ 138 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-10 - Spatial K - A set of Kotlin Multiplatform Libraries for working with geospatial data
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,809 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,222 | 🐛 430 | 🌐 Python | 📅 2026-08-12 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,837 | 🐛 53 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,011 | 🐛 51 | 🌐 Python | 📅 2026-08-12 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,757 | 🐛 1 | 🌐 Python | 📅 2026-08-10 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,270 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,558 | 🐛 156 | 🌐 Python | 📅 2026-08-13 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
* [Python Geocoder](https://github.com/DenisCarriere/geocoder) ⭐ 1,655 | 🐛 123 | 🌐 Python | 📅 2024-04-20 - Simple and consistent geocoding library written in Python.
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,407 | 🐛 32 | 🌐 Python | 📅 2026-08-09 - Implementation of Trajectory classes and functions built on top of GeoPandas.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,399 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,222 | 🐛 57 | 🌐 Python | 📅 2026-08-11 - For conversions between projections.
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 961 | 🐛 62 | 🌐 Python | 📅 2026-08-08 - xarray-spatial implements common raster analysis functions using Numba and provides an easy-to-install, easy-to-extend codebase for raster analysis.
...
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 887 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
* [PyPostal](https://github.com/openvenues/pypostal) ⭐ 881 | 🐛 44 | 🌐 C | 📅 2025-11-01 - Python bindings to libpostal for fast international address parsing/normalization.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 872 | 🐛 179 | 🌐 Python | 📅 2026-08-13 - Pythonic interface for the Generic Mapping Tools (GMT).
* [networkit](https://github.com/networkit/networkit) ⭐ 870 | 🐛 39 | 🌐 C++ | 📅 2026-08-13 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [PyKrige](https://github.com/GeoStat-Framework/PyKrige) ⭐ 858 | 🐛 41 | 🌐 Python | 📅 2025-10-16 - Kriging Toolkit for Python.
...
* [Spectral Python](https://github.com/spectralpython/spectral) ⭐ 675 | 🐛 21 | 🌐 Python | 📅 2026-08-04 - Python module for hyperspectral image processing.
...
* [GSTools](https://github.com/GeoStat-Framework/GSTools) ⭐ 649 | 🐛 35 | 🌐 Python | 📅 2026-08-11 - A geostatistical toolbox: random fields, variogram estimation, covariance models, kriging and much more.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 591 | 🐛 0 | 🌐 Python | 📅 2026-07-27 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 591 | 🐛 18 | 🌐 Python | 📅 2026-08-12 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
...
* [urbansim](https://github.com/UDST/urbansim) ⭐ 543 | 🐛 26 | 🌐 Python | 📅 2023-12-06 - New version of UrbanSim, a platform for modeling metropolitan real estate markets.
* [EarthPy](https://github.com/earthlab/earthpy) ⭐ 535 | 🐛 45 | 🌐 Python | 📅 2026-04-13 - A package built to support working with spatial data using open source python.
* [openrouteservice-py](https://github.com/GIScience/openrouteservice-py) ⭐ 454 | 🐛 16 | 🌐 Python | 📅 2025-02-05 - The Python API to consume openrouteservice(s) painlessly!
...
* [pymap3d](https://github.com/scivision/pymap3d) ⭐ 441 | 🐛 6 | 🌐 Python | 📅 2026-06-22 - Python 3D coordinate conversions for geospace ecef enu eci.
* [pyrosm](https://github.com/HTenkanen/pyrosm) ⭐ 435 | 🐛 22 | 🌐 Python | 📅 2026-08-01 - Read OpenStreetMap data from Protobuf files into GeoDataFrame with Python, faster.
* [geospatial](https://github.com/giswqs/geospatial) ⭐ 430 | 🐛 10 | 🌐 Dockerfile | 📅 2026-08-10 - A collection of Python packages for geospatial analysis and data visualization.
* [pandana](https://github.com/UDST/pandana) ⭐ 423 | 🐛 45 | 🌐 C++ | 📅 2023-11-25 - Pandas Network Analysis - dataframes of network queries, quickly.
* [whitebox](https://github.com/giswqs/whitebox) ⭐ 419 | 🐛 1 | 🌐 Python | 📅 2026-01-31 - Python frontend for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,188 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
* [Open Topo Data](https://github.com/ajnisbet/opentopodata) ⭐ 415 | 🐛 2 | 🌐 Python | 📅 2026-02-16 - Open Topo Data is a REST API server for your elevation data.
...
* [pyGEOS](https://github.com/pygeos/pygeos) ⭐ 389 | 🐛 27 | 🌐 Python | 📅 2024-09-03 - Exposes geospatial operations from GEOS into Python.
* [srai](https://github.com/kraina-ai/srai) ⭐ 385 | 🐛 104 | 🌐 Python | 📅 2026-08-03 - Spatial Representations for Artificial Intelligence. Set of tools for geospatial machine learning, data acquisition and wrangling.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 376 | 🐛 23 | 🌐 Python | 📅 2026-08-03 - Library and a CLI tool for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
* [Xee](https://github.com/google/Xee) ⭐ 370 | 🐛 31 | 🌐 Python | 📅 2026-08-05 - An Xarray extension for Google Earth Engine.
* [EOmaps](https://github.com/raphaelquast/EOmaps) ⭐ 361 | 🐛 20 | 🌐 Python | 📅 2026-04-23 - Create interactive maps to visualize, analyze and compare geographical datasets (based on matplotlib/cartopy).
* [localtileserver](https://github.com/banesullivan/localtileserver) ⭐ 348 | 🐛 0 | 🌐 Python | 📅 2026-08-10 - A Python package for serving tiles from large raster files in the Slippy Maps standard (i.e., `/zoom/x/y.png`) for visualization in Jupyter with `ipyleaflet` or `folium`.
* [routing-py](https://github.com/gis-ops/routing-py) ⭐ 347 | 🐛 12 | 🌐 Python | 📅 2026-07-21 - Python library to access all public routing, isochrones and matrix APIs in a consistent manner.
* [EOReader](https://github.com/sertit/eoreader) ⭐ 345 | 🐛 58 | 🌐 Python | 📅 2026-08-03 - EOReader is a multi-satellite reader allowing you to open optical and SAR data.
...
* [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 321 | 🐛 43 | 🌐 Python | 📅 2026-08-13 - STAC API implementation with FastAPI.
* [Alpha Shape Toolbox](https://github.com/bellockk/alphashape) ⭐ 312 | 🐛 30 | 🌐 Python | 📅 2026-07-23 - Toolbox for constructing alpha shapes.
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 310 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,188 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [HyperCoast](https://github.com/opengeos/HyperCoast) ⭐ 284 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - A Python package for visualizing and analyzing hyperspectral data in coastal regions.
* [Detectree](https://github.com/martibosch/detectree) ⭐ 278 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - DetecTree is a Pythonic library to classify tree/non-tree pixels from aerial imagery.
...
* [urbanaccess](https://github.com/UDST/urbanaccess) ⭐ 264 | 🐛 19 | 🌐 Python | 📅 2023-05-11 - A tool for computing GTFS transit and OSM pedestrian networks for accessibility analysis.
* [fastkml](https://github.com/cleder/fastkml) ⭐ 256 | 🐛 15 | 🌐 Python | 📅 2026-08-10 - Fastkml is a library to read, write and manipulate KML files. It aims to keep it simple and fast (using lxml if available).
...
* [Siphon](https://github.com/unidata/siphon) ⭐ 245 | 🐛 81 | 🌐 Python | 📅 2026-08-03 - A collection of Python utilities for retrieving atmospheric and oceanic data from remote sources, focusing on being able to retrieve data from Unidata data technologies, such as the THREDDS data server.
* [landsatxplore](https://github.com/yannforget/landsatxplore) ⭐ 239 | 🐛 65 | 🌐 Python | 📅 2024-11-30 - Search and download Landsat scenes from EarthExplorer.
...
* [xyzservices](https://github.com/geopandas/xyzservices) ⭐ 229 | 🐛 13 | 🌐 Python | 📅 2026-08-02 - A unified source of XYZ tile providers in Python.
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 210 | 🐛 52 | 🌐 Python | 📅 2026-08-13 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
* [cubo](https://github.com/davemlz/cubo) ⭐ 209 | 🐛 2 | 🌐 Python | 📅 2026-02-12 - Easily create EO mini cubes from STAC in Python.
...
* [geofileops](https://github.com/geofileops/geofileops) ⭐ 175 | 🐛 35 | 🌐 Python | 📅 2026-08-06 - Python toolbox to process large vector files faster.
...
* [Tobler](https://github.com/pysal/tobler) ⭐ 169 | 🐛 21 | 🌐 Python | 📅 2026-07-30 - Tobler is a python package for areal interpolation, dasymetric mapping, and change of support.
...
* [sentle](https://github.com/cmosig/sentle) ⭐ 148 | 🐛 4 | 🌐 Python | 📅 2026-08-07 - Sentinel-1 & Sentinel-2 data cubes at large scale (bigger-than-memory) on any machine with integrated cloud detection, snow masking, harmonization, merging, and temporal composites. CDSE or PlanetaryComputer.
...
* [geeup](https://github.com/samapriya/geeup) ⭐ 138 | 🐛 0 | 🌐 Python | 📅 2025-12-31 - Simple CLI for Earth Engine Uploads.
* [LARD](https://github.com/deel-ai/LARD) ⭐ 135 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-08-11 - A runway dataset and a generator of synthetic aerial images with automatic labeling.
...
* [scikit-eo](https://github.com/ytarazona/scikit-eo) ⭐ 125 | 🐛 0 | 📅 2024-10-16 - A Python package for Remote Sensing Tools.
...
* [Intake-stac](https://github.com/intake/intake-stac) ⭐ 113 | 🐛 27 | 🌐 Python | 📅 2026-08-10 - This is an intake data source for SpatioTemporal Asset Catalogs (STAC).
...
* [geojson-area](https://github.com/scisco/area) ⭐ 98 | 🐛 5 | 🌐 Python | 📅 2018-10-31 - Calculate the area inside of any GeoJSON geometry.
* [geojson-area](https://github.com/scisco/area) ⭐ 98 | 🐛 5 | 🌐 Python | 📅 2018-10-31 - Calculate the area inside of any GeoJSON geometry. This is a port of Mapbox's geojson-area for Python.
...
* [python-opencage-geocoder](https://github.com/OpenCageData/python-opencage-geocoder) ⭐ 87 | 🐛 2 | 🌐 Python | 📅 2026-06-08 - A Python module that uses the OpenCage Geocoding API.
...
* [pygeoif](https://github.com/cleder/pygeoif) ⭐ 72 | 🐛 12 | 🌐 Python | 📅 2026-08-10 - PyGeoIf provides a GeoJSON-like protocol for geo-spatial (GIS) vector data. A simple, pure Python implementation of geometric objects and operations, useful for basic GIS tasks.
...
* [Urban Mapper](https://github.com/VIDA-NYU/UrbanMapper) ⭐ 67 | 🐛 4 | 🌐 Python | 📅 2025-12-20 – 🗺️ Spatial Join & Enrich any `urban layer` (Roads, Intersections, Sidewalks, Crosswalks, Neighborhoods, Cities, States, Countries) given any `external urban dataset` of interest, and streamline your urban analysis with Scikit-Learn-Like pipelines!
* [OSMnet](https://github.com/UDST/osmnet) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2023-08-08 - Tools for the extraction of OpenStreetMap street network data.
...
* [geoconformal](https://github.com/pengtum/geoconformal) ⭐ 21 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-06-20 - Model-agnostic uncertainty quantification for geospatial prediction using conformal prediction.
...
* [xeo](https://github.com/awesome-spectral-indices/xeo) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-06 - Awesome Earth Observation Instruments in Python.
...
* [shapefile](https://github.com/phpmyadmin/shapefile) ⭐ 28 | 🐛 4 | 🌐 PHP | 📅 2026-08-13 - ESRI ShapeFile library for PHP.
...
* [rayshader](https://github.com/tylermorganwall/rayshader) ⭐ 2,174 | 🐛 48 | 🌐 R | 📅 2026-08-12 - rayshader is an open source R package for producing 2D and 3D hillshaded maps of elevation matrices using a combination of raytracing, spherical texture mapping, and ambient occlusion.
* [sf](https://github.com/r-spatial/sf) ⭐ 1,442 | 🐛 64 | 🌐 R | 📅 2026-07-22 - Simple Features for R.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 936 | 🐛 19 | 🌐 R | 📅 2026-07-07 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 814 | 🐛 107 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 776 | 🐛 63 | 🌐 R | 📅 2026-08-10 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 703 | 🐛 16 | 🌐 R | 📅 2026-07-18 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 615 | 🐛 18 | 🌐 C++ | 📅 2026-08-10 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 611 | 🐛 26 | 🌐 R | 📅 2026-07-20 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 545 | 🐛 25 | 🌐 R | 📅 2026-08-13 - Satellite image time series package for R.
...
* [cartography](https://github.com/riatelab/cartography) ⭐ 402 | 🐛 0 | 🌐 R | 📅 2025-07-23 - Thematic Cartography with R.
...
* [osmdata](https://github.com/ropensci/osmdata) ⭐ 342 | 🐛 24 | 🌐 R | 📅 2026-07-18 - R package for downloading OpenStreetMap data.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 261 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [osrm R](https://github.com/rCarto/osrm) ⭐ 255 | 🐛 0 | 🌐 R | 📅 2026-03-12 - Interface Between R and the OpenStreetMap-Based Routing Service OSRM.
...
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 239 | 🐛 34 | 🌐 R | 📅 2026-07-21 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [osmextract](https://github.com/ropensci/osmextract) ⭐ 193 | 🐛 28 | 🌐 R | 📅 2026-08-11 - Download and import OpenStreetMap data from Geofabrik and other providers.
...
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 185 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,188 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [biomod2](https://github.com/biomodhub/biomod2) ⭐ 128 | 🐛 23 | 🌐 R | 📅 2026-07-17 - Computer platform for ensemble forecasting of species distributions, enabling the treatment of a range of methodological uncertainties in models and the examination of species-environment relationships.
...
* [geotargets](https://github.com/njtierney/geotargets) ⭐ 97 | 🐛 27 | 🌐 R | 📅 2026-06-11 - Targets extensions for geospatial data.
...
* [maxnet](https://github.com/mrmaxent/maxnet) ⭐ 85 | 🐛 10 | 🌐 R | 📅 2023-07-05 - R package for modelling species geographic distributions. It implements much of the functionality of the Maxent Java application.
...
* [gtfs2gps](https://github.com/ipeaGIT/gtfs2gps) ⭐ 82 | 🐛 11 | 🌐 R | 📅 2026-06-30 - Convert GTFS data into a data.table with GPS-like records in R.
* [rstac](https://github.com/brazil-data-cube/rstac) ⭐ 81 | 🐛 5 | 🌐 R | 📅 2026-05-07 - R Client Library for SpatioTemporal Asset Catalog.
* [giscoR](https://github.com/rOpenGov/giscoR) ⭐ 80 | 🐛 0 | 🌐 R | 📅 2026-08-07 - An API package that helps to retrieve data from Eurostat - GISCO (the Geographic Information System of the COmmission).
...
* [biodivMapR](https://github.com/jbferet/biodivMapR) ⭐ 63 | 🐛 3 | 🌐 R | 📅 2026-04-03 - R package for α- and β-diversity mapping using remotely-sensed images.
...
* [gdalraster](https://github.com/USDAForestService/gdalraster) ⭐ 59 | 🐛 12 | 🌐 C++ | 📅 2026-08-01 - R Bindings to the GDAL Raster API.
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
...
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 53 | 🐛 16 | 🌐 R | 📅 2026-07-29 - R package to download data from Brazil's Population Census.
...
* [rasterDT](https://github.com/JoshOBrien/rasterDT) ⭐ 27 | 🐛 1 | 🌐 R | 📅 2023-08-24 - rasterDT uses the fast indexing, aggregation, and assignment operations provided by data.table to power speedy alternatives to several raster package functions.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,455 | 🐛 146 | 🌐 Rust | 📅 2026-08-10 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,152 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,825 | 🐛 77 | 🌐 Rust | 📅 2026-08-11 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,911 | 🐛 117 | 🌐 Rust | 📅 2026-08-13 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,738 | 🐛 134 | 🌐 Rust | 📅 2026-08-07 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,565 | 🐛 68 | 🌐 Rust | 📅 2026-08-09 - About Native Maps for Web, Mobile and Desktop.
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,188 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 908 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 816 | 🐛 36 | 🌐 Rust | 📅 2026-08-10 - A performant binary encoding for geographic data based on flatbuffers.
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 634 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23 - 3D Gaussian Splatting renderer for WebAssembly with lock-free multithreading.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 633 | 🐛 39 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
...
* [rstar](https://github.com/georust/rstar) ⭐ 550 | 🐛 42 | 🌐 Rust | 📅 2026-08-13 - R\*-tree library for the rust ecosystem.
* [h3o](https://github.com/HydroniumLabs/h3o) ⭐ 539 | 🐛 0 | 🌐 Rust | 📅 2026-06-08 - Rust implementation of the H3 geospatial indexing system.
* [sguaba](https://github.com/helsing-ai/sguaba) ⭐ 507 | 🐛 2 | 🌐 Rust | 📅 2026-07-08 - Types for points and vectors in coordinate spaces and transformations based on rigid body transforms.
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 487 | 🐛 127 | 🌐 Rust | 📅 2026-08-13 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 469 | 🐛 45 | 🌐 Rust | 📅 2026-08-10 - Zero-Copy reading and writing of geospatial data.
* [gdal](https://github.com/georust/rust-gdal) ⭐ 447 | 🐛 62 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 420 | 🐛 82 | 🌐 Rust | 📅 2026-08-11 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
* [Ferrostar](https://github.com/stadiamaps/ferrostar) ⭐ 407 | 🐛 156 | 🌐 Kotlin | 📅 2026-08-01 - A FOSS navigation SDK built from the ground up for the future.
* [Airmail](https://github.com/ellenhp/airmail) ⭐ 382 | 🐛 17 | 🌐 Rust | 📅 2025-08-08 - Lightweight geocoder in pure Rust.
* [hdf5-rust](https://github.com/aldanor/hdf5-rust) ⭐ 348 | 🐛 57 | 🌐 Rust | 📅 2024-08-08 - Thread-safe Rust bindings and high-level wrappers for the HDF5 library API.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 265 | 🐛 21 | 🌐 Rust | 📅 2026-08-10 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [Cavalier Contours](https://github.com/jbuckmccready/cavalier_contours) ⭐ 225 | 🐛 16 | 🌐 Rust | 📅 2026-08-10 - 2D polyline/shape library for offsetting, combining, etc.
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 204 | 🐛 2 | 🌐 Rust | 📅 2026-08-02 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
* [geo-index](https://github.com/kylebarron/geo-index) ⭐ 197 | 🐛 31 | 🌐 Rust | 📅 2026-04-17 - Fast, immutable, ABI-stable spatial indexes.
* [Polars ST](https://github.com/Oreilles/polars-st) ⭐ 190 | 🐛 9 | 🌐 Python | 📅 2026-08-06 - Spatial extension for Polars DataFrames.
* [proj](https://github.com/georust/rust-proj) ⭐ 182 | 🐛 38 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 180 | 🐛 11 | 🌐 Rust | 📅 2026-08-01 - Computational Geometry library written in Rust.
* [image-tiff](https://github.com/image-rs/image-tiff) ⭐ 166 | 🐛 31 | 🌐 Rust | 📅 2026-08-10 - TIFF decoding and encoding library in pure Rust.
* [BBOX services](https://github.com/bbox-services/bbox) ⭐ 165 | 🐛 21 | 🌐 Rust | 📅 2025-10-11 - Composable spatial services.
* [osmpbf](https://github.com/b-r-u/osmpbf) ⭐ 163 | 🐛 18 | 🌐 Rust | 📅 2025-10-24 - Library for reading the OpenStreetMap PBF file format.
* [osm-renderer](https://github.com/dfyz/osm-renderer) ⭐ 160 | 🐛 0 | 🌐 Rust | 📅 2025-02-10 - OpenStreetMap raster tile renderer.
* [iTriangle](https://github.com/iShape-Rust/iTriangle) ⭐ 155 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - A fast, stable, and robust 2d triangulation library.
* [Solari](https://github.com/ellenhp/solari) ⭐ 147 | 🐛 0 | 🌐 Rust | 📅 2025-06-24 - Multimodal routing in Rust.
* [geos](https://github.com/georust/geos) ⭐ 146 | 🐛 16 | 🌐 Rust | 📅 2026-03-03 - Rust bindings for GEOS C API.
* [stac-rs](https://github.com/gadomski/stac-rs) ⭐ 145 | 🐛 30 | 🌐 Rust | 📅 2026-08-11 - Rust implementation of the SpatioTemporal Asset Catalog (STAC) specification.
* [osmpbfreader-rs](https://github.com/TeXitoi/osmpbfreader-rs) ⭐ 133 | 🐛 7 | 🌐 Rust | 📅 2026-04-07 - Read OpenStreetMap PBF files.
* [GeoTIFF](https://github.com/georust/geotiff) ⭐ 131 | 🐛 10 | 🌐 Rust | 📅 2026-07-31 - Work with GeoTIFF raster files.
* [RINEX](https://github.com/georust/rinex) ⭐ 124 | 🐛 27 | 🌐 Rust | 📅 2026-07-21 - RINEX analysis & and processing.
* [gpx](https://github.com/georust/rust-gpx) ⭐ 122 | 🐛 5 | 🌐 Rust | 📅 2025-08-19 - Rust read/write support for GPS Exchange Format (GPX).
* [geohash](https://github.com/georust/rust-geohash) ⭐ 120 | 🐛 4 | 🌐 Rust | 📅 2026-06-14 - Geohash for Rust.
...
* [PMTiles (for Rust)](https://github.com/stadiamaps/pmtiles-rs) ⭐ 107 | 🐛 10 | 🌐 Rust | 📅 2026-08-11 - Rust implementation of PMTiles
* [Robust](https://github.com/georust/robust) ⭐ 106 | 🐛 8 | 🌐 Rust | 📅 2025-05-10 - Robust primitives for computational geometry.
...
* [las-rs](https://github.com/gadomski/las-rs) ⭐ 103 | 🐛 5 | 🌐 Rust | 📅 2026-08-11 - Read and write ASPRS las files.
* [plateau-gis-converter](https://github.com/MIERUNE/plateau-gis-converter) ⭐ 101 | 🐛 53 | 🌐 Rust | 📅 2026-08-07 - A GUI and CLI tool for converting PLATEAU's 3D city models (CityGML) of Japan into various geospatial formats, including 3D Tiles, MVT, and GeoPackage.
* [pasture](https://github.com/Mortano/pasture) ⭐ 93 | 🐛 4 | 🌐 Rust | 📅 2025-09-30 - A Rust library for working with point cloud data.
* [Karttapullautin](https://github.com/karttapullautin/karttapullautin) ⭐ 88 | 🐛 9 | 🌐 Rust | 📅 2026-08-13 - A fast and accurate map generator from classified LiDAR data.
* [density mesh](https://github.com/PsichiX/density-mesh) ⭐ 83 | 🐛 6 | 🌐 Rust | 📅 2023-09-15 - Image density/height map to mesh generator.
...
* [gtfs-structures](https://github.com/rust-transit/gtfs-structure) ⭐ 77 | 🐛 24 | 🌐 Rust | 📅 2026-07-01 - Read GTFS files into structs, with smart references.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 72 | 🐛 12 | 🌐 Rust | 📅 2026-07-24 - Manage, convert and enrich transit data.
* [Bevy Point Cloud](https://github.com/rlamarche/bevy_pointcloud) ⭐ 67 | 🐛 1 | 🌐 Rust | 📅 2026-08-02 - A Bevy plugin to render point clouds.
* [Polylabel-rs](https://github.com/urschrei/polylabel-rs) ⭐ 60 | 🐛 3 | 🌐 Rust | 📅 2026-06-28 - A Rust implementation of the Polylabel algorithm, with FFI.
* [wkt](https://github.com/georust/rust-wkt) ⭐ 56 | 🐛 16 | 🌐 Rust | 📅 2026-01-01 - Rust read/write support for well-known text (WKT).
* [earcut-rs](https://github.com/ciscorn/earcut-rs) ⭐ 55 | 🐛 3 | 🌐 Rust | 📅 2026-07-26 - Port of the Earcut polygon triangulation library with performance in mind.
* [geographiclib-rs](https://github.com/georust/geographiclib-rs) ⭐ 52 | 🐛 12 | 🌐 Rust | 📅 2026-02-19 - A subset of geographiclib implemented in Rust.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 48 | 🐛 52 | 🌐 Jupyter Notebook | 📅 2026-08-13 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
* [rusterize](https://github.com/ttrotto/rusterize) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-07-30 - High performance rasterization tool for python built in Rust.
...
* [geom3d](https://github.com/J-F-Liu/geom3d) ⭐ 46 | 🐛 1 | 🌐 Rust | 📅 2024-01-02 - Data structures and algorithms for 3D geometric modeling.
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-09 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [OGC API](https://github.com/georust/ogcapi) ⭐ 42 | 🐛 3 | 🌐 Rust | 📅 2026-07-23 - OGC API building blocks.
...
* [osm-lump-ways](https://github.com/amandasaurus/osm-lump-ways) ⭐ 40 | 🐛 1 | 🌐 Rust | 📅 2026-08-13 - Group OSM ways based on topology & shared tags
* [coord\_transforms](https://github.com/DaveKram/coord_transforms) ⚠️ Archived - Rust crate for performing coordinate transforms.
* [kml](https://github.com/georust/kml) ⭐ 34 | 🐛 5 | 🌐 Rust | 📅 2026-07-08 - Rust support for reading and writing KML with a focus on conversion to geo-types primitives.
* [polyline](https://github.com/georust/rust-polyline) ⭐ 33 | 🐛 6 | 🌐 Rust | 📅 2025-07-26 - Google Encoded Polyline encoding & decoding in Rust.
...
* [osm-pbf-parquet](https://github.com/OvertureMaps/osm-pbf-parquet) ⭐ 30 | 🐛 0 | 🌐 Rust | 📅 2026-08-13 - Transcode OSM PBF file to parquet files.
* [RouteE Compass](https://github.com/NREL/routee-compass) ⭐ 28 | 🐛 85 | 🌐 Rust | 📅 2026-08-12 - An energy-aware vehicle routing engine.
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 28 | 🐛 3 | 🌐 Rust | 📅 2026-08-11 - utils & tiles w/ (rs & pyo3).
* [geojson-vt-rs](https://github.com/maxammann/geojson-vt-rs) ⭐ 27 | 🐛 2 | 🌐 Rust | 📅 2025-09-12 - Crate for slicing GeoJSON into vector tiles on the fly.
...
* [cql2-rs](https://github.com/developmentseed/cql2-rs) ⭐ 23 | 🐛 9 | 🌐 Rust | 📅 2026-08-13 - Library for parsing the OGC CQL2 filter language.
* [osm\_ch](https://github.com/Stunkymonkey/osm_ch) ⭐ 22 | 🐛 1 | 🌐 Rust | 📅 2026-04-22 - OSM-Contraction-Hierarchies.
* [flat-projection](https://github.com/Turbo87/flat-projection-rs) ⭐ 20 | 🐛 9 | 🌐 Rust | 📅 2026-08-06 - Fast geodesic distance approximations via flat surface projection.
...
* [osmx](https://github.com/jake-low/osmx-rs) ⭐ 19 | 🐛 2 | 🌐 Rust | 📅 2026-05-12 - Rust port of OSMExpress, a fast database file format for OpenStreetMap.
...
* [tilejson](https://github.com/georust/tilejson) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-08-10 - tilejson is a crate for serializing/deserializing the TileJSON format.
* [maplibre-legend](https://github.com/mvt-proj/maplibre-legend) ⭐ 15 | 🐛 1 | 🌐 Rust | 📅 2026-08-08 - Maplibre legend generator crate.
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 14 | 🐛 0 | 🌐 Rust | 📅 2026-04-02 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [cheap-ruler-rs](https://github.com/vipera/cheap-ruler-rs) ⭐ 10 | 🐛 0 | 🌐 Rust | 📅 2025-02-06 - Collection of very fast approximations to common geodesic measurements.
* [Quadbin](https://github.com/atsyplenkov/qbin) ⭐ 10 | 🐛 2 | 🌐 Rust | 📅 2026-03-03 - Hierarchical geospatial index tiling, similar to Quadkey.
* [pgstac-rs](https://github.com/gadomski/pgstac-rs) ⚠️ Archived - Rust interface for [pgstac](https://github.com/stac-utils/pgstac) ⭐ 220 | 🐛 69 | 🌐 PLpgSQL | 📅 2026-08-10.
...
* [pbfhogg](https://github.com/folknor/pbfhogg) ⭐ 3 | 🐛 2 | 🌐 Rust | 📅 2026-08-10 - Fast library and CLI to read, write, and transform OSM PBF files; parallel and pipelined decoding, planet-scale on modest hardware.
...
* [Routers](https://github.com/routers-org/routers) ⭐ 2 | 🐛 12 | 🌐 Rust | 📅 2026-08-13 - Set of routing tools designed for system-agnostic maps.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,371 | 🐛 250 | 🌐 Scala | 📅 2026-08-11 - GeoTrellis is a Scala library and framework that uses Spark to work with raster data.
* [RTree2D](https://github.com/plokhotnyuk/rtree2d) ⭐ 145 | 🐛 11 | 🌐 Scala | 📅 2026-08-08 - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 917 | 🐛 213 | 🌐 Swift | 📅 2026-08-13 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
* [turf-swift](https://github.com/mapbox/turf-swift) ⭐ 270 | 🐛 29 | 🌐 Swift | 📅 2026-06-29 - A Swift language port of Turf.js.
* [MapboxDirections.swift](https://github.com/mapbox/MapboxDirections.swift) ⭐ 205 | 🐛 32 | 🌐 Swift | 📅 2026-06-29 - Traffic-aware directions in Swift or Objective-C on iOS, macOS, tvOS, and watchOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,079 | 🐛 3,461 | 🌐 C++ | 📅 2026-08-13 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,602 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,009 | 🐛 50 | 🌐 Dart | 📅 2026-08-03 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,136 | 🐛 558 | 🌐 C++ | 📅 2026-08-13 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-08-13 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 532 | 🐛 65 | 🌐 Kotlin | 📅 2026-08-13 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,490 | 🐛 201 | 🌐 Scala | 📅 2026-08-13 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,371 | 🐛 250 | 🌐 Scala | 📅 2026-08-11 - GeoTrellis is a geographic data processing engine for high performance applications.
* [GeoWave](https://github.com/locationtech/geowave) ⭐ 527 | 🐛 90 | 🌐 Java | 📅 2025-09-29 - GeoWave provides geospatial and temporal indexing on top of Accumulo and HBase.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,282 | 🐛 319 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,395 | 🐛 73 | 🌐 Python | 📅 2026-08-13 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,111 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,107 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,342 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
* [geoplot](https://github.com/ResidentMario/geoplot) ⭐ 1,209 | 🐛 33 | 🌐 Python | 📅 2024-06-08 -  High-level Python geospatial plotting library. It's an extension to cartopy and matplotlib which makes mapping easy.
...
* [lonboard](https://github.com/developmentseed/lonboard) ⭐ 959 | 🐛 121 | 🌐 Python | 📅 2026-08-10 - Fast, interactive geospatial data visualization in Jupyter.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 633 | 🐛 116 | 🌐 Python | 📅 2026-07-20 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
* [Strava](https://github.com/marcusvolz/strava) ⭐ 585 | 🐛 10 | 🌐 R | 📅 2024-01-01 - Create artistic visualisations with your exercise data.
* [mplleaflet](https://github.com/jwass/mplleaflet) ⭐ 520 | 🐛 48 | 🌐 Python | 📅 2022-03-20 - Easily convert matplotlib plots from Python into interactive Leaflet web maps.
* [GeoJs](https://github.com/OpenGeoscience/geojs) ⭐ 468 | 🐛 46 | 🌐 JavaScript | 📅 2026-08-10 - High-performance visualization and interactive data exploration of scientific and geospatial location aware datasets.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 382 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
...
* [deck.gl-raster](https://github.com/developmentseed/deck.gl-raster) ⭐ 222 | 🐛 94 | 🌐 TypeScript | 📅 2026-08-03 - Client-side, GPU-accelerated Cloud-Optimized GeoTIFF visualization in deck.gl.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,343 | 🐛 60 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
* [Mapus](https://github.com/alyssaxuu/mapus) ⭐ 3,529 | 🐛 9 | 🌐 JavaScript | 📅 2022-07-02 - Mapus is a tool to explore and annotate collaboratively on a map.
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,136 | 🐛 112 | 🌐 Java | 📅 2026-08-13 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [Osm2pgsql](https://github.com/openstreetmap/osm2pgsql) ⭐ 1,677 | 🐛 36 | 🌐 C++ | 📅 2026-07-24 - osm2pgsql is a tool for loading OpenStreetMap data into a PostgreSQL.
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 973 | 🐛 230 | 🌐 C | 📅 2026-08-13 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 424 | 🐛 178 | 🌐 Python | 📅 2026-08-13 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 278 | 🐛 22 | 🌐 C++ | 📅 2026-08-01 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 272 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - Server based application/server-side framework for geodata storage, management and visualization.
* [fresco](https://github.com/go-spatial/fresco) ⭐ 257 | 🐛 61 | 🌐 JavaScript | 📅 2023-03-01 - Fresco is an open source Mapbox Vector Tile Style editor that allows cartographers to craft stylesheets for use with Mapbox GL maps.
...
* [Magrit](https://github.com/riatelab/magrit) ⭐ 160 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-11 - Magrit is an online application for thematic mapping.
...
* [DataPillager](https://github.com/gdherbert/DataPillager) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-06-30 - Download data from Esri service.
...
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 311 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics.
* [Callisto Generated Datasets](https://github.com/Agri-Hub/Callisto-Dataset-Collection) ⭐ 186 | 🐛 1 | 📅 2023-11-21 - A list of datasets aiming to enable Artificial Intelligence applications that use Copernicus data.
...
* [ZipCheckup](https://github.com/artakulov/us-water-quality-data) ⭐ 4 | 🐛 0 | 📅 2026-07-26 - Free ZIP-level environmental safety data platform covering water quality, air quality, PFAS, radon, lead, flood risk and 11 more verticals across 42K US ZIP codes. Public API, CC BY 4.0.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,078 | 🐛 47 | 🌐 Python | 📅 2026-07-19 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
* [Geopython](https://github.com/urschrei/Geopython) ⭐ 381 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-03 - Notebooks and libraries for spatial/geo Python explorations.
* [Cloud Optimized Point Cloud Specification](https://github.com/copcio/copcio.github.io) ⭐ 139 | 🐛 3 | 🌐 Shell | 📅 2026-05-27 - Geospatial, compressed, range-readable, LAZ-compatible point cloud format.
...
* [font-GIS](https://github.com/Viglino/font-gis) ⭐ 322 | 🐛 2 | 🌐 CSS | 📅 2025-07-16 - A very very cool icon font set for use with GIS and spatial analysis tools.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 313,783 | 🐛 26 | 🌐 Python | 📅 2026-08-05
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,492 | 🐛 91 | 📅 2024-05-17
* [Awesome Deep Vision](https://github.com/kjw0612/awesome-deep-vision) ⭐ 11,178 | 🐛 47 | 📅 2023-08-15
* [Awesome Semantic Segmentation](https://github.com/mrgloom/awesome-semantic-segmentation) ⭐ 10,850 | 🐛 17 | 📅 2021-05-08
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,233 | 🐛 0 | 📅 2026-08-02
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,500 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,473 | 🐛 55 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,620 | 🐛 2 | 📅 2026-08-10
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,525 | 🐛 0 | 📅 2026-07-23
* [Awesome-EarthObservation-Code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,377 | 🐛 5 | 🌐 HTML | 📅 2026-05-13
* [Awesome SAR](https://github.com/RadarCODE/awesome-sar) ⭐ 1,197 | 🐛 8 | 📅 2025-07-22
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,159 | 🐛 23 | 🌐 Python | 📅 2026-08-12
* [Awesome Frontend GIS](https://github.com/joewdavies/awesome-frontend-gis) ⭐ 844 | 🐛 10 | 📅 2026-07-24 - Geographic Information Systems (GIS) for web browsers. For managing, analyzing, editing, and visualizing geographic data.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 582 | 🐛 3 | 📅 2025-02-20
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 532 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-07-17
* [Awesome DEM](https://github.com/DahnJ/Awesome-DEM) ⭐ 452 | 🐛 6 | 📅 2024-05-25 - Overview of Digital Elevation Model (DEM) datasets.
* [Awesome Geo Rust](https://github.com/pka/awesome-georust) ⭐ 412 | 🐛 1 | 📅 2026-03-01
* [Awesome SQLite](https://github.com/planetopendata/awesome-sqlite) ⭐ 404 | 🐛 5 | 📅 2026-08-09
...
* [Awesome Earth Engine Apps](https://github.com/philippgaertner/awesome-earth-engine-apps) ⭐ 188 | 🐛 2 | 📅 2024-01-03
* [Cartography / Mapping / Web design resources](https://github.com/tolomaps/resources) ⭐ 129 | 🐛 2 | 📅 2020-11-24
* [Awesome Earth Observation Instruments](https://github.com/awesome-spectral-indices/awesome-earth-observation-instruments) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - A machine-readable catalogue of Earth observation instruments with spectral, spatial, temporal, and operational characteristics.
