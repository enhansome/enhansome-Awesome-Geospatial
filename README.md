...
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,071 | 🐛 116 | 🌐 C++ | 📅 2026-07-01 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 826 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 621 | 🐛 10 | 🌐 C | 📅 2026-08-14 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [duckdb-raster](https://github.com/ahuarte47/duckdb-raster) ⭐ 52 | 🐛 0 | 🌐 C++ | 📅 2026-08-14 - DuckDB Extension for reading and writing raster files using SQL.
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,137 | 🐛 131 | 🌐 HTML | 📅 2026-05-16 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-14 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 181 | 🐛 12 | 🌐 Python | 📅 2026-08-14 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,575 | 🐛 821 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 703 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,109 | 🐛 454 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,794 | 🐛 105 | 🌐 Python | 📅 2026-08-13 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,463 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [OpenSky API](https://github.com/openskynetwork/opensky-api) ⭐ 462 | 🐛 14 | 🌐 Python | 📅 2026-07-20 - Retrieve live airspace information.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,915 | 🐛 868 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,143 | 🐛 188 | 🌐 Python | 📅 2026-08-14 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
...
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 766 | 🐛 109 | 🌐 Python | 📅 2026-08-11 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 53 | 🐛 0 | 🌐 Rust | 📅 2026-08-13 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,571 | 🐛 81 | 🌐 C | 📅 2026-08-14 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,463 | 🐛 165 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,584 | 🐛 765 | 🌐 C++ | 📅 2026-08-14 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,376 | 🐛 116 | 🌐 Python | 📅 2026-08-13 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,071 | 🐛 932 | 🌐 C++ | 📅 2026-08-14 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,709 | 🐛 75 | 🌐 C++ | 📅 2026-08-11 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,832 | 🐛 50 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 870 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [geo](https://github.com/bryanjos/geo) ⭐ 678 | 🐛 11 | 🌐 Elixir | 📅 2026-08-14 - A collection of GIS functions for Elixir.
...
* [S2](https://github.com/golang/geo) ⭐ 1,848 | 🐛 37 | 🌐 Go | 📅 2026-08-10 - S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the best planar geometry libraries.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,632 | 🐛 242 | 🌐 Java | 📅 2026-08-14 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 2,988 | 🐛 45 | 🌐 Java | 📅 2026-08-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,568 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-14 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,375 | 🐛 483 | 🌐 TypeScript | 📅 2026-08-14 - WebGL2 powered geospatial visualization layers.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,231 | 🐛 256 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,082 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-08 - A cross provider JavaScript library for drawing on maps
...
* [Geo-Three](https://github.com/tentone/geo-three) ⭐ 944 | 🐛 41 | 🌐 TypeScript | 📅 2026-04-05 - Tile based geographic world map visualization library for threejs.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 101 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-14 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [DataFrames.jl](https://github.com/JuliaStats/DataFrames.jl) ⭐ 1,831 | 🐛 160 | 🌐 Julia | 📅 2026-08-12 - Tools for working with tabular data in Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-14 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,811 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,224 | 🐛 431 | 🌐 Python | 📅 2026-08-12 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,841 | 🐛 53 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,013 | 🐛 51 | 🌐 Python | 📅 2026-08-12 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,274 | 🐛 3 | 🌐 Python | 📅 2026-08-10 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,560 | 🐛 159 | 🌐 Python | 📅 2026-08-14 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,430 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 872 | 🐛 180 | 🌐 Python | 📅 2026-08-14 - Pythonic interface for the Generic Mapping Tools (GMT).
* [networkit](https://github.com/networkit/networkit) ⭐ 870 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [GSTools](https://github.com/GeoStat-Framework/GSTools) ⭐ 649 | 🐛 35 | 🌐 Python | 📅 2026-08-14 - A geostatistical toolbox: random fields, variogram estimation, covariance models, kriging and much more.
* [rioxarray](https://github.com/corteva/rioxarray) ⭐ 621 | 🐛 80 | 🌐 Python | 📅 2026-07-27 - rasterio xarray extension.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 611 | 🐛 46 | 🌐 Python | 📅 2026-08-11 - A Python Framework for Large-Scale SAR Satellite Data Processing.
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 595 | 🐛 0 | 🌐 Python | 📅 2026-07-27 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [urbansim](https://github.com/UDST/urbansim) ⭐ 543 | 🐛 28 | 🌐 Python | 📅 2026-08-14 - New version of UrbanSim, a platform for modeling metropolitan real estate markets.
* [EarthPy](https://github.com/earthlab/earthpy) ⭐ 536 | 🐛 45 | 🌐 Python | 📅 2026-04-13 - A package built to support working with spatial data using open source python.
...
* [urbanaccess](https://github.com/UDST/urbanaccess) ⭐ 264 | 🐛 19 | 🌐 Python | 📅 2026-08-13 - A tool for computing GTFS transit and OSM pedestrian networks for accessibility analysis.
* [fastkml](https://github.com/cleder/fastkml) ⭐ 256 | 🐛 14 | 🌐 Python | 📅 2026-08-14 - Fastkml is a library to read, write and manipulate KML files. It aims to keep it simple and fast (using lxml if available).
...
* [sentle](https://github.com/cmosig/sentle) ⭐ 148 | 🐛 4 | 🌐 Python | 📅 2026-08-14 - Sentinel-1 & Sentinel-2 data cubes at large scale (bigger-than-memory) on any machine with integrated cloud detection, snow masking, harmonization, merging, and temporal composites. CDSE or PlanetaryComputer.
...
* [pygeoif](https://github.com/cleder/pygeoif) ⭐ 72 | 🐛 11 | 🌐 Python | 📅 2026-08-14 - PyGeoIf provides a GeoJSON-like protocol for geo-spatial (GIS) vector data. A simple, pure Python implementation of geometric objects and operations, useful for basic GIS tasks.
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 936 | 🐛 19 | 🌐 R | 📅 2026-08-14 - Package to download official spatial data sets of Brazil.
...
* [sits](https://github.com/e-sensing/sits) ⭐ 545 | 🐛 23 | 🌐 R | 📅 2026-08-13 - Satellite image time series package for R.
...
* [giscoR](https://github.com/rOpenGov/giscoR) ⭐ 80 | 🐛 0 | 🌐 R | 📅 2026-08-14 - An API package that helps to retrieve data from Eurostat - GISCO (the Geographic Information System of the COmmission).
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,466 | 🐛 148 | 🌐 Rust | 📅 2026-08-14 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,828 | 🐛 77 | 🌐 Rust | 📅 2026-08-11 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
...
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,565 | 🐛 68 | 🌐 Rust | 📅 2026-08-14 - About Native Maps for Web, Mobile and Desktop.
...
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 633 | 🐛 40 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 487 | 🐛 129 | 🌐 Rust | 📅 2026-08-14 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 266 | 🐛 22 | 🌐 Rust | 📅 2026-08-14 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 203 | 🐛 2 | 🌐 Rust | 📅 2026-08-02 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
* [geo-index](https://github.com/kylebarron/geo-index) ⭐ 197 | 🐛 31 | 🌐 Rust | 📅 2026-04-17 - Fast, immutable, ABI-stable spatial indexes.
* [Polars ST](https://github.com/Oreilles/polars-st) ⭐ 191 | 🐛 9 | 🌐 Python | 📅 2026-08-06 - Spatial extension for Polars DataFrames.
...
* [iTriangle](https://github.com/iShape-Rust/iTriangle) ⭐ 156 | 🐛 4 | 🌐 Rust | 📅 2026-08-12 - A fast, stable, and robust 2d triangulation library.
...
* [Karttapullautin](https://github.com/karttapullautin/karttapullautin) ⭐ 88 | 🐛 8 | 🌐 Rust | 📅 2026-08-14 - A fast and accurate map generator from classified LiDAR data.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 72 | 🐛 13 | 🌐 Rust | 📅 2026-08-14 - Manage, convert and enrich transit data.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 48 | 🐛 53 | 🌐 Jupyter Notebook | 📅 2026-08-14 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 916 | 🐛 213 | 🌐 Swift | 📅 2026-08-13 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,091 | 🐛 3,455 | 🌐 C++ | 📅 2026-08-14 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,141 | 🐛 559 | 🌐 C++ | 📅 2026-08-14 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-08-14 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 535 | 🐛 70 | 🌐 Kotlin | 📅 2026-08-14 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,492 | 🐛 199 | 🌐 Scala | 📅 2026-08-14 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,287 | 🐛 319 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,396 | 🐛 73 | 🌐 Python | 📅 2026-08-14 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,113 | 🐛 158 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,107 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,342 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,345 | 🐛 60 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 973 | 🐛 230 | 🌐 C | 📅 2026-08-14 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 424 | 🐛 175 | 🌐 Python | 📅 2026-08-14 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 278 | 🐛 23 | 🌐 C++ | 📅 2026-08-14 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 273 | 🐛 0 | 🌐 Python | 📅 2026-08-14 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 313,975 | 🐛 26 | 🌐 Python | 📅 2026-08-05
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,232 | 🐛 0 | 📅 2026-08-02
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,162 | 🐛 23 | 🌐 Python | 📅 2026-08-14
