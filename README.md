...
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,985 | 🐛 356 | 🌐 Java | 📅 2026-09-13 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 626 | 🐛 11 | 🌐 C | 📅 2026-09-13 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,298 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,631 | 🐛 298 | 🌐 TypeScript | 📅 2026-09-12 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,169 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,069 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data into vector tiles on the fly.
...
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,183 | 🐛 25 | 🌐 Python | 📅 2026-09-12 - A dynamic Web Map tile server.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 36 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 106 | 🌐 TypeScript | 📅 2026-09-13 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 246 | 🐛 9 | 🌐 Python | 📅 2026-09-13 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 614 | 🐛 47 | 🌐 Python | 📅 2026-09-03 - A Python Framework for Large-Scale SAR Satellite Data Processing.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 191 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,839 | 🐛 108 | 🌐 Python | 📅 2026-09-08 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 20 | 🌐 R | 📅 2026-09-07 - R package that uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
...
* [H3](https://github.com/uber/h3) ⭐ 6,535 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [ee-fastapi](https://github.com/csaybar/ee-fastapi) ⭐ 89 | 🐛 1 | 🌐 Python | 📅 2021-04-25 - Flood Detection with Google Earth Engine.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,947 | 🐛 870 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,178 | 🐛 221 | 🌐 Python | 📅 2026-09-09 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,145 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [Deep Learning ArcGIS](https://github.com/Esri/deep-learning-frameworks) ⭐ 649 | 🐛 9 | 📅 2026-07-21 - Deep Learning Libraries Installers for ArcGIS.
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,636 | 🐛 80 | 🌐 C | 📅 2026-09-13 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,535 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,886 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 70 | 🐛 57 | 🌐 C | 📅 2026-08-31 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,605 | 🐛 783 | 🌐 C++ | 📅 2026-09-13 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,470 | 🐛 112 | 🌐 Python | 📅 2026-09-10 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,200 | 🐛 940 | 🌐 C++ | 📅 2026-09-13 - Open Source Routing Engine for OpenStreetMap.
...
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,117 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 81 | 🌐 C++ | 📅 2026-09-11 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [LASzip](https://github.com/LASzip/LASzip) ⭐ 236 | 🐛 26 | 🌐 C++ | 📅 2026-08-21 - Quickly turns bulky LAS files into compact LAZ files without information loss.
...
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,504 | 🐛 184 | 🌐 Go | 📅 2026-09-09 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 974 | 🐛 9 | 🌐 Go | 📅 2026-08-19 - Go library for handling geometries.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,689 | 🐛 242 | 🌐 Java | 📅 2026-09-13 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,051 | 🐛 45 | 🌐 Java | 📅 2026-09-13 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,721 | 🐛 1,667 | 🌐 JavaScript | 📅 2026-09-13 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,586 | 🐛 532 | 🌐 TypeScript | 📅 2026-09-13 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,499 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-03 - React friendly API wrapper around MapboxGL JS.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,371 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,240 | 🐛 103 | 🌐 JavaScript | 📅 2026-09-13 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,102 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-13 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,085 | 🐛 246 | 🌐 JavaScript | 📅 2026-09-07 - Draw tools for mapbox-gl-js.
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,050 | 🐛 89 | 🌐 JavaScript | 📅 2026-09-13 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
...
* [arc.js](https://github.com/springmeyer/arc.js) ⭐ 384 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-13 - Calculate great circles routes as lines in GeoJSON or WKT format.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 12 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-13 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [DataFrames.jl](https://github.com/JuliaStats/DataFrames.jl) ⭐ 1,832 | 🐛 161 | 🌐 Julia | 📅 2026-09-12 - Tools for working with tabular data in Julia.
...
* [ArchGDAL](https://github.com/yeesian/ArchGDAL.jl) ⭐ 151 | 🐛 96 | 🌐 Julia | 📅 2026-09-13 - Vector and Raster interfaces.
...
* [GeoJSON.jl](https://github.com/JuliaGeo/GeoJSON.jl) ⭐ 70 | 🐛 27 | 🌐 Julia | 📅 2026-09-13 - This library is developed independently of, but is heavily influenced in design by the python-geojson package.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-13 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,842 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,247 | 🐛 421 | 🌐 Python | 📅 2026-09-12 - Python tools for geographic data.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,367 | 🐛 9 | 🌐 Python | 📅 2026-09-07 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,575 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,914 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,411 | 🐛 36 | 🌐 Python | 📅 2026-09-13 - Implementation of Trajectory classes and functions built on top of GeoPandas.
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,225 | 🐛 50 | 🌐 Python | 📅 2026-09-09 - For conversions between projections.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 81 | 🌐 C++ | 📅 2026-09-11 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 874 | 🐛 186 | 🌐 Python | 📅 2026-09-13 - Pythonic interface for the Generic Mapping Tools (GMT).
* [PyKrige](https://github.com/GeoStat-Framework/PyKrige) ⭐ 861 | 🐛 41 | 🌐 Python | 📅 2025-10-16 - Kriging Toolkit for Python.
...
* [Open-Elevation](https://github.com/Jorl17/open-elevation) ⭐ 802 | 🐛 48 | 🌐 Python | 📅 2024-04-17 - A free and open-source alternative to Google Elevation API.
...
* [Verde](https://github.com/fatiando/verde) ⭐ 669 | 🐛 47 | 🌐 Python | 📅 2026-08-04 - Verde is a Python library for processing spatial data (bathymetry, geophysics surveys, etc) and interpolating it on regular grids (i.e., gridding).
* [GSTools](https://github.com/GeoStat-Framework/GSTools) ⭐ 653 | 🐛 36 | 🌐 Python | 📅 2026-08-24 - A geostatistical toolbox: random fields, variogram estimation, covariance models, kriging and much more.
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 650 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [Prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 20 | 🌐 R | 📅 2026-09-07 - The prioritizr R package uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
...
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 56 | 🐛 17 | 🌐 R | 📅 2026-09-13 - R package to download data from Brazil's Population Census.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,854 | 🐛 125 | 🌐 Rust | 📅 2026-09-09 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,912 | 🐛 48 | 🌐 Rust | 📅 2026-09-13 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,932 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
...
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 823 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 643 | 🐛 43 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 640 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23 - 3D Gaussian Splatting renderer for WebAssembly with lock-free multithreading.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 502 | 🐛 146 | 🌐 Rust | 📅 2026-09-13 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 473 | 🐛 45 | 🌐 Rust | 📅 2026-09-04 - Zero-Copy reading and writing of geospatial data.
...
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 209 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
* [geo-index](https://github.com/kylebarron/geo-index) ⭐ 199 | 🐛 31 | 🌐 Rust | 📅 2026-09-09 - Fast, immutable, ABI-stable spatial indexes.
...
* [geos](https://github.com/georust/geos) ⭐ 147 | 🐛 16 | 🌐 Rust | 📅 2026-09-13 - Rust bindings for GEOS C API.
...
* [tzf-rs](https://github.com/ringsaturn/tzf-rs) ⭐ 108 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Get timezone via longitude\&latitude in Rust in a fast way
...
* [Bevy Point Cloud](https://github.com/rlamarche/bevy_pointcloud) ⭐ 67 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - A Bevy plugin to render point clouds.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-13 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-13 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [Louvre](https://github.com/acheul/louvre) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2026-08-03 - Computational Geometry Library with Rust
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,373 | 🐛 245 | 🌐 Scala | 📅 2026-09-13 - GeoTrellis is a Scala library and framework that uses Spark to work with raster data.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,404 | 🐛 3,519 | 🌐 C++ | 📅 2026-09-13 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,601 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,014 | 🐛 52 | 🌐 Dart | 📅 2026-09-13 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,203 | 🐛 610 | 🌐 C++ | 📅 2026-09-13 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
...
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 572 | 🐛 30 | 🌐 Kotlin | 📅 2026-09-13 - Add interactive vector tile maps to your Compose app
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,373 | 🐛 245 | 🌐 Scala | 📅 2026-09-13 - GeoTrellis is a geographic data processing engine for high performance applications.
...
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,400 | 🐛 70 | 🌐 Python | 📅 2026-09-13 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,175 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,117 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,345 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [Strava](https://github.com/marcusvolz/strava) ⭐ 587 | 🐛 10 | 🌐 R | 📅 2024-01-01 - Create artistic visualisations with your exercise data.
...
* [Osm2pgsql](https://github.com/openstreetmap/osm2pgsql) ⭐ 1,685 | 🐛 36 | 🌐 C++ | 📅 2026-09-10 - osm2pgsql is a tool for loading OpenStreetMap data into a PostgreSQL.
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 979 | 🐛 223 | 🌐 C | 📅 2026-09-13 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 432 | 🐛 179 | 🌐 Python | 📅 2026-09-13 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 283 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 320,429 | 🐛 18 | 🌐 Python | 📅 2026-09-13
...
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,520 | 🐛 68 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,627 | 🐛 3 | 📅 2026-08-10
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,177 | 🐛 23 | 🌐 Python | 📅 2026-09-13
...
* [Awesome SQLite](https://github.com/planetopendata/awesome-sqlite) ⭐ 404 | 🐛 10 | 📅 2026-08-22
