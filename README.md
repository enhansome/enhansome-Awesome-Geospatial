...
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,985 | 🐛 356 | 🌐 Java | 📅 2026-09-11 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,077 | 🐛 117 | 🌐 C++ | 📅 2026-09-07 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 825 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 626 | 🐛 8 | 🌐 C | 📅 2026-09-12 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,291 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-12 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,536 | 🐛 119 | 🌐 HTML | 📅 2026-08-25 - An open-source JavaScript library for integrated 2D/3D maps.
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,311 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-12 - An SVG mapping component library for React, built on top of d3-geo.
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,167 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,183 | 🐛 24 | 🌐 Python | 📅 2026-09-11 - A dynamic Web Map tile server.
...
* [d3-geo](https://github.com/d3/d3-geo) ⭐ 1,102 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 - A library for creating maps based on D3.js.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-12 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 245 | 🐛 15 | 🌐 Python | 📅 2026-09-12 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 191 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,837 | 🐛 104 | 🌐 Python | 📅 2026-09-08 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,534 | 🐛 169 | 🌐 C | 📅 2026-09-10 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [Phantom Tide](https://github.com/tg12/phantomtide) ⭐ 124 | 🐛 4 | 📅 2026-08-18 - Real-time geospatial intelligence platform for maritime and airspace monitoring, combining vessel tracking, ADS-B flight activity, official notices, environmental context, and satellite detections in a single live map workflow.
...
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,178 | 🐛 219 | 🌐 Python | 📅 2026-09-09 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,144 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
* [OSM Edit MCP](https://github.com/skywinder/osm-edit-mcp) ⭐ 4 | 🐛 5 | 🌐 Python | 📅 2026-09-11 - Python MCP server for inspecting OpenStreetMap data and previewing version-checked road-edit proposals from selected local GPX survey segments. Applying changes requires explicit user confirmation of the proposal digest. Alpha.
...
* [geoai-skills](https://github.com/muend/geoai-skills) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Vendor-neutral Agent Skills (SKILL.md) that make an AI coding agent check coordinate reference systems, spatial validation, comparability and uncertainty before a result becomes a claim. Works with Claude Code, Codex, Cursor and GitHub Copilot; ships a paired evaluation against a skills-disabled control arm, including the quality gate it fails.

## C

* [libvips](https://github.com/libvips/libvips) ⭐ 11,635 | 🐛 83 | 🌐 C | 📅 2026-09-12 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,534 | 🐛 169 | 🌐 C | 📅 2026-09-10 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,602 | 🐛 786 | 🌐 C++ | 📅 2026-09-12 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,198 | 🐛 943 | 🌐 C++ | 📅 2026-09-11 - Open Source Routing Engine for OpenStreetMap.
...
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,858 | 🐛 50 | 🌐 C++ | 📅 2026-09-08 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
...
* [OpenOrienteering Mapper](https://github.com/OpenOrienteering/mapper) ⭐ 495 | 🐛 559 | 🌐 C++ | 📅 2026-07-21 - OpenOrienteering Mapper is a software for creating maps for the orienteering sport.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,717 | 🐛 56 | 🌐 C# | 📅 2026-09-01 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 20 | 🌐 Go | 📅 2026-03-30 - A set of types for working with 2d geo and planar/projected geometric data in Golang
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,686 | 🐛 242 | 🌐 Java | 📅 2026-09-12 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,049 | 🐛 46 | 🌐 Java | 📅 2026-09-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,720 | 🐛 1,666 | 🌐 JavaScript | 📅 2026-09-12 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,584 | 🐛 528 | 🌐 TypeScript | 📅 2026-09-11 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,498 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-03 - React friendly API wrapper around MapboxGL JS.
...
* [geolib](https://github.com/manuelbieh/geolib) ⭐ 4,276 | 🐛 70 | 🌐 JavaScript | 📅 2026-04-03 - Library to provide basic geospatial operations like distance calculation and rotation.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,369 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,101 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-12 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,085 | 🐛 246 | 🌐 JavaScript | 📅 2026-09-07 - Draw tools for mapbox-gl-js.
...
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 823 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
...
* [GeoPackage.js](https://github.com/ngageoint/geopackage-js) ⭐ 333 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-11 - GeoPackage JS is an implementation of the OGC GeoPackage spec. This library works in both the browser and Node 4+.
* [Bertin.js](https://github.com/neocarto/bertin) ⭐ 316 | 🐛 9 | 🌐 JavaScript | 📅 2023-10-23 - A JavaScript library for visualizing geospatial data and make thematic maps for the web.
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 59 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-12 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
* [landspeed.js](https://github.com/springmeyer/landspeed.js) ⭐ 54 | 🐛 1 | 🌐 JavaScript | 📅 2017-01-07 - WMS server using node-mapnik.
* [tilelive-postgis](https://github.com/stepankuzmin/tilelive-postgis) ⭐ 52 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-12 - Implements the tilelive API for generating mapnik vector tiles from PostGIS.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 11 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-12 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [DataFrames.jl](https://github.com/JuliaStats/DataFrames.jl) ⭐ 1,831 | 🐛 161 | 🌐 Julia | 📅 2026-09-12 - Tools for working with tabular data in Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-12 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,841 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,247 | 🐛 420 | 🌐 Python | 📅 2026-09-12 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,863 | 🐛 54 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,026 | 🐛 52 | 🌐 Python | 📅 2026-09-11 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,775 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,364 | 🐛 8 | 🌐 Python | 📅 2026-09-07 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,574 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,911 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,224 | 🐛 50 | 🌐 Python | 📅 2026-09-09 - For conversions between projections.
...
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 893 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [Verde](https://github.com/fatiando/verde) ⭐ 668 | 🐛 47 | 🌐 Python | 📅 2026-08-04 - Verde is a Python library for processing spatial data (bathymetry, geophysics surveys, etc) and interpolating it on regular grids (i.e., gridding).
...
* [rioxarray](https://github.com/corteva/rioxarray) ⭐ 624 | 🐛 81 | 🌐 Python | 📅 2026-07-27 - rasterio xarray extension.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 614 | 🐛 46 | 🌐 Python | 📅 2026-09-03 - A Python Framework for Large-Scale SAR Satellite Data Processing.
...
* [pymap3d](https://github.com/scivision/pymap3d) ⭐ 444 | 🐛 6 | 🌐 Python | 📅 2026-06-22 - Python 3D coordinate conversions for geospace ecef enu eci.
...
* [whitebox](https://github.com/giswqs/whitebox) ⭐ 422 | 🐛 1 | 🌐 Python | 📅 2026-01-31 - Python frontend for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,204 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 310 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,204 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 948 | 🐛 18 | 🌐 R | 📅 2026-09-12 - Package to download official spatial data sets of Brazil.
...
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 188 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,204 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 56 | 🐛 16 | 🌐 R | 📅 2026-09-12 - R package to download data from Brazil's Population Census.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,827 | 🐛 124 | 🌐 Rust | 📅 2026-09-09 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,172 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,911 | 🐛 49 | 🌐 Rust | 📅 2026-09-11 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,931 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,754 | 🐛 136 | 🌐 Rust | 📅 2026-09-11 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,573 | 🐛 70 | 🌐 Rust | 📅 2026-09-11 - About Native Maps for Web, Mobile and Desktop.
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,204 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 271 | 🐛 24 | 🌐 Rust | 📅 2026-09-12 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [Polars ST](https://github.com/Oreilles/polars-st) ⭐ 195 | 🐛 9 | 🌐 Python | 📅 2026-08-06 - Spatial extension for Polars DataFrames.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-12 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [RTree2D](https://github.com/plokhotnyuk/rtree2d) ⭐ 145 | 🐛 12 | 🌐 Scala | 📅 2026-09-12 - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,397 | 🐛 3,516 | 🌐 C++ | 📅 2026-09-12 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,600 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,014 | 🐛 48 | 🌐 Dart | 📅 2026-09-04 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,202 | 🐛 607 | 🌐 C++ | 📅 2026-09-12 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
...
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 572 | 🐛 36 | 🌐 Kotlin | 📅 2026-09-12 - Add interactive vector tile maps to your Compose app
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,372 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,400 | 🐛 70 | 🌐 Python | 📅 2026-09-12 - Python Data. Leaflet.js Maps.
...
* [circlize](https://github.com/jokergoo/circlize) ⭐ 1,021 | 🐛 67 | 🌐 R | 📅 2023-11-11 - Circular visualization in R. Circular layout is an efficient way for the visualization of huge amounts of information.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 118 | 🌐 Python | 📅 2026-09-12 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,175 | 🐛 112 | 🌐 Java | 📅 2026-09-11 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 977 | 🐛 222 | 🌐 C | 📅 2026-09-12 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 432 | 🐛 179 | 🌐 Python | 📅 2026-09-12 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 282 | 🐛 2 | 🌐 Python | 📅 2026-09-12 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,088 | 🐛 49 | 🌐 Python | 📅 2026-09-07 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 320,252 | 🐛 24 | 🌐 Python | 📅 2026-09-01
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,255 | 🐛 0 | 📅 2026-09-12
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,177 | 🐛 23 | 🌐 Python | 📅 2026-09-10
