...
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,978 | 🐛 356 | 🌐 Java | 📅 2026-08-11 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 621 | 🐛 7 | 🌐 C | 📅 2026-08-15 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [L7](https://github.com/antvis/L7) ⭐ 4,048 | 🐛 215 | 🌐 TypeScript | 📅 2026-07-30 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,139 | 🐛 131 | 🌐 HTML | 📅 2026-05-16 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-15 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 183 | 🐛 11 | 🌐 Python | 📅 2026-08-15 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [PySAR](https://github.com/insarlab/PySAR) ⭐ 825 | 🐛 68 | 🌐 Python | 📅 2026-08-11 - InSAR time series analysis in Python.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,110 | 🐛 454 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,796 | 🐛 108 | 🌐 Python | 📅 2026-08-13 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,464 | 🐛 166 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,917 | 🐛 868 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,146 | 🐛 188 | 🌐 Python | 📅 2026-08-15 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,109 | 🐛 6 | 🌐 Python | 📅 2026-08-10 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 767 | 🐛 109 | 🌐 Python | 📅 2026-08-11 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [H3](https://github.com/uber/h3) ⭐ 6,464 | 🐛 166 | 🌐 C | 📅 2026-08-11 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,870 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,584 | 🐛 763 | 🌐 C++ | 📅 2026-08-15 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,378 | 🐛 116 | 🌐 Python | 📅 2026-08-13 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,072 | 🐛 932 | 🌐 C++ | 📅 2026-08-15 - Open Source Routing Engine for OpenStreetMap.
...
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,499 | 🐛 182 | 🌐 Go | 📅 2026-08-10 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
* [Draw2D](https://github.com/llgcode/draw2d) ⭐ 1,165 | 🐛 45 | 🌐 Go | 📅 2026-04-22 - 2D rendering for different output (raster, pdf).
* [orb](https://github.com/paulmach/orb) ⭐ 1,126 | 🐛 18 | 🌐 Go | 📅 2026-03-30 - A set of types for working with 2d geo and planar/projected geometric data in Golang
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,633 | 🐛 242 | 🌐 Java | 📅 2026-08-15 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 2,990 | 🐛 44 | 🌐 Java | 📅 2026-08-15 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,572 | 🐛 1,639 | 🌐 JavaScript | 📅 2026-08-15 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,380 | 🐛 483 | 🌐 TypeScript | 📅 2026-08-15 - WebGL2 powered geospatial visualization layers.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,346 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-10 - A crazy fast geospatial point clustering library for browsers and Node.
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,237 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
...
* [Geo-Three](https://github.com/tentone/geo-three) ⭐ 945 | 🐛 41 | 🌐 TypeScript | 📅 2026-04-05 - Tile based geographic world map visualization library for threejs.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-15 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,812 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,224 | 🐛 431 | 🌐 Python | 📅 2026-08-12 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,845 | 🐛 53 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,013 | 🐛 52 | 🌐 Python | 📅 2026-08-15 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,560 | 🐛 158 | 🌐 Python | 📅 2026-08-14 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,434 | 🐛 3 | 🌐 Python | 📅 2026-08-11 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 180 | 🌐 Python | 📅 2026-08-14 - Pythonic interface for the Generic Mapping Tools (GMT).
* [networkit](https://github.com/networkit/networkit) ⭐ 870 | 🐛 37 | 🌐 C++ | 📅 2026-08-14 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [PyKrige](https://github.com/GeoStat-Framework/PyKrige) ⭐ 858 | 🐛 41 | 🌐 Python | 📅 2025-10-16 - Kriging Toolkit for Python.
* [thunder](https://github.com/thunder-project/thunder) ⭐ 823 | 🐛 89 | 🌐 Python | 📅 2017-01-06 - Thunder is an ecosystem of tools for the analysis of image and time series data in Python.
...
* [urbanaccess](https://github.com/UDST/urbanaccess) ⭐ 264 | 🐛 21 | 🌐 Python | 📅 2026-08-13 - A tool for computing GTFS transit and OSM pedestrian networks for accessibility analysis.
...
* [rayshader](https://github.com/tylermorganwall/rayshader) ⭐ 2,174 | 🐛 48 | 🌐 R | 📅 2026-08-15 - rayshader is an open source R package for producing 2D and 3D hillshaded maps of elevation matrices using a combination of raytracing, spherical texture mapping, and ambient occlusion.
* [sf](https://github.com/r-spatial/sf) ⭐ 1,442 | 🐛 64 | 🌐 R | 📅 2026-07-22 - Simple Features for R.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 937 | 🐛 19 | 🌐 R | 📅 2026-08-14 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 813 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 776 | 🐛 63 | 🌐 R | 📅 2026-08-10 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 703 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 615 | 🐛 14 | 🌐 C++ | 📅 2026-08-15 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
...
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 240 | 🐛 34 | 🌐 R | 📅 2026-07-21 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [gdalraster](https://github.com/USDAForestService/gdalraster) ⭐ 59 | 🐛 12 | 🌐 C++ | 📅 2026-08-15 - R Bindings to the GDAL Raster API.
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,474 | 🐛 146 | 🌐 Rust | 📅 2026-08-14 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,830 | 🐛 79 | 🌐 Rust | 📅 2026-08-15 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,912 | 🐛 117 | 🌐 Rust | 📅 2026-08-13 - Geospatial primitives and algorithms for Rust.
...
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,566 | 🐛 68 | 🌐 Rust | 📅 2026-08-14 - About Native Maps for Web, Mobile and Desktop.
...
* [rstar](https://github.com/georust/rstar) ⭐ 551 | 🐛 42 | 🌐 Rust | 📅 2026-08-13 - R\*-tree library for the rust ecosystem.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 488 | 🐛 133 | 🌐 Rust | 📅 2026-08-14 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 266 | 🐛 17 | 🌐 Rust | 📅 2026-08-15 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [Cavalier Contours](https://github.com/jbuckmccready/cavalier_contours) ⭐ 225 | 🐛 12 | 🌐 Rust | 📅 2026-08-15 - 2D polyline/shape library for offsetting, combining, etc.
...
* [proj](https://github.com/georust/rust-proj) ⭐ 183 | 🐛 38 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 180 | 🐛 11 | 🌐 Rust | 📅 2026-08-15 - Computational Geometry library written in Rust.
...
* [iTriangle](https://github.com/iShape-Rust/iTriangle) ⭐ 156 | 🐛 4 | 🌐 Rust | 📅 2026-08-15 - A fast, stable, and robust 2d triangulation library.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 916 | 🐛 214 | 🌐 Swift | 📅 2026-08-13 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,101 | 🐛 3,447 | 🌐 C++ | 📅 2026-08-15 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,602 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,010 | 🐛 50 | 🌐 Dart | 📅 2026-08-03 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,142 | 🐛 558 | 🌐 C++ | 📅 2026-08-15 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
...
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 536 | 🐛 70 | 🌐 Kotlin | 📅 2026-08-15 - Add interactive vector tile maps to your Compose app
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,293 | 🐛 319 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,396 | 🐛 73 | 🌐 Python | 📅 2026-08-15 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,116 | 🐛 157 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,108 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,342 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,137 | 🐛 112 | 🌐 Java | 📅 2026-08-13 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [Osm2pgsql](https://github.com/openstreetmap/osm2pgsql) ⭐ 1,678 | 🐛 36 | 🌐 C++ | 📅 2026-07-24 - osm2pgsql is a tool for loading OpenStreetMap data into a PostgreSQL.
...
* [eodag](https://github.com/CS-SI/eodag) ⭐ 425 | 🐛 176 | 🌐 Python | 📅 2026-08-15 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 279 | 🐛 22 | 🌐 C++ | 📅 2026-08-15 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 274 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-15 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 314,134 | 🐛 27 | 🌐 Python | 📅 2026-08-05
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,230 | 🐛 0 | 📅 2026-08-02
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,502 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,475 | 🐛 55 | 📅 2026-07-21
...
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,526 | 🐛 0 | 📅 2026-07-23
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,162 | 🐛 23 | 🌐 Python | 📅 2026-08-15
