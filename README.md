...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 623 | 🐛 9 | 🌐 C | 📅 2026-08-21 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,398 | 🐛 388 | 🌐 TypeScript | 📅 2026-08-21 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,532 | 🐛 118 | 🌐 HTML | 📅 2026-08-18 - An open-source JavaScript library for integrated 2D/3D maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,054 | 🐛 214 | 🌐 TypeScript | 📅 2026-07-30 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,143 | 🐛 132 | 🌐 HTML | 📅 2026-05-16 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,356 | 🐛 891 | 🌐 TypeScript | 📅 2026-08-21 - A library for building rich, web-based geospatial data explorers.
...
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,148 | 🐛 24 | 🌐 Python | 📅 2026-08-20 - A dynamic Web Map tile server.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 61 | 🌐 TypeScript | 📅 2026-08-21 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 199 | 🐛 12 | 🌐 Python | 📅 2026-08-21 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 158 | 🐛 2 | 🌐 Python | 📅 2026-08-13 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,582 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,110 | 🐛 455 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,801 | 🐛 102 | 🌐 Python | 📅 2026-08-20 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,482 | 🐛 165 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,153 | 🐛 197 | 🌐 Python | 📅 2026-08-21 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,118 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 53 | 🐛 0 | 🌐 Rust | 📅 2026-08-21 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [H3](https://github.com/uber/h3) ⭐ 6,482 | 🐛 165 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,876 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,584 | 🐛 769 | 🌐 C++ | 📅 2026-08-21 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,099 | 🐛 928 | 🌐 C++ | 📅 2026-08-21 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,711 | 🐛 76 | 🌐 C++ | 📅 2026-08-18 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,837 | 🐛 50 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,796 | 🐛 57 | 🌐 C | 📅 2026-08-20 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 871 | 🐛 38 | 🌐 C++ | 📅 2026-08-17 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [MaxRev.Gdal.Core](https://github.com/MaxRev-Dev/gdal.netcore) ⭐ 210 | 🐛 3 | 🌐 C# | 📅 2026-08-21 - Bindings for GDAL and OGR (both win-x64 and linux-x64).
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,638 | 🐛 244 | 🌐 Java | 📅 2026-08-21 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,589 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-21 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,505 | 🐛 470 | 🌐 TypeScript | 📅 2026-08-21 - WebGL2 powered geospatial visualization layers.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,921 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,086 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-20 - A cross provider JavaScript library for drawing on maps
...
* [GeoStats.jl](https://github.com/JuliaEarth/GeoStats.jl) ⭐ 590 | 🐛 6 | 🌐 Julia | 📅 2026-08-21 - An extensible framework for high-performance geostatistics in Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-21 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,822 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,227 | 🐛 431 | 🌐 Python | 📅 2026-08-12 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,850 | 🐛 53 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,016 | 🐛 52 | 🌐 Python | 📅 2026-08-21 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,760 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,313 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,563 | 🐛 156 | 🌐 Python | 📅 2026-08-20 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,777 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 179 | 🌐 Python | 📅 2026-08-21 - Pythonic interface for the Generic Mapping Tools (GMT).
* [networkit](https://github.com/networkit/networkit) ⭐ 871 | 🐛 38 | 🌐 C++ | 📅 2026-08-17 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 612 | 🐛 47 | 🌐 Python | 📅 2026-08-20 - A Python Framework for Large-Scale SAR Satellite Data Processing.
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 606 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [urbansim](https://github.com/UDST/urbansim) ⭐ 543 | 🐛 26 | 🌐 Python | 📅 2026-08-21 - New version of UrbanSim, a platform for modeling metropolitan real estate markets.
...
* [geofileops](https://github.com/geofileops/geofileops) ⭐ 176 | 🐛 36 | 🌐 Python | 📅 2026-08-20 - Python toolbox to process large vector files faster.
...
* [xeo](https://github.com/awesome-spectral-indices/xeo) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - Awesome Earth Observation Instruments in Python.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 776 | 🐛 63 | 🌐 R | 📅 2026-08-17 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 704 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 616 | 🐛 13 | 🌐 C++ | 📅 2026-08-20 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 612 | 🐛 26 | 🌐 R | 📅 2026-08-20 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 546 | 🐛 26 | 🌐 R | 📅 2026-08-21 - Satellite image time series package for R.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,556 | 🐛 134 | 🌐 Rust | 📅 2026-08-18 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,840 | 🐛 75 | 🌐 Rust | 📅 2026-08-21 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,915 | 🐛 120 | 🌐 Rust | 📅 2026-08-20 - Geospatial primitives and algorithms for Rust.
...
* [rstar](https://github.com/georust/rstar) ⭐ 555 | 🐛 42 | 🌐 Rust | 📅 2026-08-13 - R\*-tree library for the rust ecosystem.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 494 | 🐛 129 | 🌐 Rust | 📅 2026-08-19 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 421 | 🐛 84 | 🌐 Rust | 📅 2026-08-11 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 267 | 🐛 17 | 🌐 Rust | 📅 2026-08-21 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [Karttapullautin](https://github.com/karttapullautin/karttapullautin) ⭐ 88 | 🐛 9 | 🌐 Rust | 📅 2026-08-20 - A fast and accurate map generator from classified LiDAR data.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 53 | 🌐 Jupyter Notebook | 📅 2026-08-21 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [OGC API](https://github.com/georust/ogcapi) ⭐ 42 | 🐛 5 | 🌐 Rust | 📅 2026-08-21 - OGC API building blocks.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 6 | 🌐 Rust | 📅 2026-08-21 - utils & tiles w/ (rs & pyo3).
* [RouteE Compass](https://github.com/NREL/routee-compass) ⭐ 28 | 🐛 89 | 🌐 Rust | 📅 2026-08-20 - An energy-aware vehicle routing engine.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,168 | 🐛 3,468 | 🌐 C++ | 📅 2026-08-21 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,155 | 🐛 568 | 🌐 C++ | 📅 2026-08-21 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
...
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 542 | 🐛 47 | 🌐 Kotlin | 📅 2026-08-21 - Add interactive vector tile maps to your Compose app
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,308 | 🐛 320 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,393 | 🐛 71 | 🌐 Python | 📅 2026-08-21 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,124 | 🐛 159 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,110 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,342 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,148 | 🐛 113 | 🌐 Java | 📅 2026-08-18 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 975 | 🐛 231 | 🌐 C | 📅 2026-08-21 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 426 | 🐛 179 | 🌐 Python | 📅 2026-08-21 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 279 | 🐛 23 | 🌐 C++ | 📅 2026-08-21 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 276 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,079 | 🐛 49 | 🌐 Python | 📅 2026-08-21 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 315,316 | 🐛 21 | 🌐 Python | 📅 2026-08-21
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,234 | 🐛 0 | 📅 2026-08-02
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,503 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,493 | 🐛 59 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,621 | 🐛 3 | 📅 2026-08-10
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,168 | 🐛 22 | 🌐 Python | 📅 2026-08-21
...
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 534 | 🐛 47 | 🌐 Jupyter Notebook | 📅 2026-08-21
...
* [Awesome SQLite](https://github.com/planetopendata/awesome-sqlite) ⭐ 404 | 🐛 5 | 📅 2026-08-21
