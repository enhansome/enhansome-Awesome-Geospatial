...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,732 | 🐛 163 | 🌐 Go | 📅 2026-09-02 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 360 | 🌐 Java | 📅 2026-09-14 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,077 | 🐛 116 | 🌐 C++ | 📅 2026-09-15 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 825 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 627 | 🐛 12 | 🌐 C | 📅 2026-09-14 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [H2GIS](https://github.com/orbisgis/h2gis) ⭐ 224 | 🐛 38 | 🌐 PLpgSQL | 📅 2026-06-24 - A spatial extension of the H2 database.
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,396 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-15 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,654 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-15 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,312 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-12 - An SVG mapping component library for React, built on top of d3-geo.
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,172 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,365 | 🐛 888 | 🌐 TypeScript | 📅 2026-09-15 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,184 | 🐛 25 | 🌐 Python | 📅 2026-09-15 - A dynamic Web Map tile server.
...
* [d3-geo](https://github.com/d3/d3-geo) ⭐ 1,103 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 - A library for creating maps based on D3.js.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 37 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-14 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 2 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-15 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 191 | 🐛 0 | 🌐 Python | 📅 2026-09-15 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,609 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,129 | 🐛 456 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,841 | 🐛 97 | 🌐 Python | 📅 2026-09-15 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,537 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,950 | 🐛 870 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,180 | 🐛 226 | 🌐 Python | 📅 2026-09-09 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,646 | 🐛 79 | 🌐 C | 📅 2026-09-15 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,537 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,888 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 71 | 🐛 56 | 🌐 C | 📅 2026-09-14 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,605 | 🐛 778 | 🌐 C++ | 📅 2026-09-15 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,475 | 🐛 111 | 🌐 Python | 📅 2026-09-15 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,211 | 🐛 942 | 🌐 C++ | 📅 2026-09-15 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,724 | 🐛 86 | 🌐 C++ | 📅 2026-09-15 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,859 | 🐛 49 | 🌐 C++ | 📅 2026-09-08 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,800 | 🐛 62 | 🌐 C | 📅 2026-09-15 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 77 | 🌐 C++ | 📅 2026-09-15 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [libspatialindex](https://github.com/libspatialindex/libspatialindex) ⭐ 798 | 🐛 25 | 🌐 C++ | 📅 2026-09-09 - C++ implementation of R\*-tree, an MVR-tree and a TPR-tree with C API.
...
* [RoutingKit](https://github.com/RoutingKit/RoutingKit) ⭐ 441 | 🐛 43 | 🌐 C++ | 📅 2026-04-13 - RoutingKit is a C++ library that provides advanced route planning functionality.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,716 | 🐛 54 | 🌐 C# | 📅 2026-09-15 - A .NET GIS solution that is fast and reliable for the .NET platform.
* [DotSpatial](https://github.com/DotSpatial/DotSpatial) ⭐ 921 | 🐛 256 | 🌐 C# | 📅 2025-10-22 - DotSpatial is a geographic information system library written for .NET 4.
...
* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 114 | 🐛 36 | 🌐 Fortran | 📅 2026-09-11 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [orb](https://github.com/paulmach/orb) ⭐ 1,131 | 🐛 20 | 🌐 Go | 📅 2026-03-30 - A set of types for working with 2d geo and planar/projected geometric data in Golang
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,693 | 🐛 242 | 🌐 Java | 📅 2026-09-14 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,055 | 🐛 45 | 🌐 Java | 📅 2026-09-14 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,235 | 🐛 223 | 🌐 Java | 📅 2026-09-15 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,734 | 🐛 1,658 | 🌐 JavaScript | 📅 2026-09-15 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,593 | 🐛 533 | 🌐 TypeScript | 📅 2026-09-15 - WebGL2 powered geospatial visualization layers.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,947 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-15 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,241 | 🐛 103 | 🌐 JavaScript | 📅 2026-09-13 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,240 | 🐛 258 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
* [Geodesy](https://github.com/chrisveness/geodesy) ⭐ 1,228 | 🐛 19 | 🌐 JavaScript | 📅 2024-07-10 - Libraries of geodesy functions implemented in JavaScript.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,103 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-15 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,086 | 🐛 242 | 🌐 JavaScript | 📅 2026-09-14 - Draw tools for mapbox-gl-js.
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,051 | 🐛 89 | 🌐 JavaScript | 📅 2026-09-13 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-15 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 12 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-15 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-15 - Interface for Reading from the Earth System Datacube.
...
* [address formatting](https://github.com/OpenCageData/address-formatting) ⭐ 448 | 🐛 5 | 🌐 Perl | 📅 2026-09-03 - Templates to format geographic addresses.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,248 | 🐛 422 | 🌐 Python | 📅 2026-09-14 - Python tools for geographic data.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,774 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,375 | 🐛 12 | 🌐 Python | 📅 2026-09-14 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,916 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,412 | 🐛 37 | 🌐 Python | 📅 2026-09-13 - Implementation of Trajectory classes and functions built on top of GeoPandas.
...
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 895 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 77 | 🌐 C++ | 📅 2026-09-15 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 874 | 🐛 185 | 🌐 Python | 📅 2026-09-15 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 653 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 614 | 🐛 47 | 🌐 Python | 📅 2026-09-03 - A Python Framework for Large-Scale SAR Satellite Data Processing.
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 594 | 🐛 22 | 🌐 Python | 📅 2026-09-15 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
...
* [urbansim](https://github.com/UDST/urbansim) ⭐ 547 | 🐛 25 | 🌐 Python | 📅 2026-09-15 - New version of UrbanSim, a platform for modeling metropolitan real estate markets.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-09-15 - Library and a CLI tool for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 311 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,205 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 48 | 🌐 Python | 📅 2026-09-15 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,445 | 🐛 65 | 🌐 R | 📅 2026-09-15 - Simple Features for R.
...
* [sits](https://github.com/e-sensing/sits) ⭐ 548 | 🐛 19 | 🌐 R | 📅 2026-09-15 - Satellite image time series package for R.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 264 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [osrm R](https://github.com/rCarto/osrm) ⭐ 254 | 🐛 0 | 🌐 R | 📅 2026-09-15 - Interface Between R and the OpenStreetMap-Based Routing Service OSRM.
* [mapsf](https://github.com/riatelab/mapsf) ⭐ 248 | 🐛 2 | 🌐 R | 📅 2026-09-03 - Thematic cartography with R.
...
* [biomod2](https://github.com/biomodhub/biomod2) ⭐ 127 | 🐛 22 | 🌐 R | 📅 2026-09-14 - Computer platform for ensemble forecasting of species distributions, enabling the treatment of a range of methodological uncertainties in models and the examination of species-environment relationships.
...
* [gdalraster](https://github.com/USDAForestService/gdalraster) ⭐ 60 | 🐛 11 | 🌐 C++ | 📅 2026-09-15 - R Bindings to the GDAL Raster API.
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 56 | 🐛 18 | 🌐 R | 📅 2026-09-14 - R package to download data from Brazil's Population Census.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,906 | 🐛 126 | 🌐 Rust | 📅 2026-09-14 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,176 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,916 | 🐛 51 | 🌐 Rust | 📅 2026-09-15 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,936 | 🐛 137 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,755 | 🐛 136 | 🌐 Rust | 📅 2026-09-15 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,574 | 🐛 70 | 🌐 Rust | 📅 2026-09-11 - About Native Maps for Web, Mobile and Desktop.
...
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 823 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 644 | 🐛 43 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
...
* [rstar](https://github.com/georust/rstar) ⭐ 559 | 🐛 48 | 🌐 Rust | 📅 2026-09-11 - R\*-tree library for the rust ecosystem.
* [h3o](https://github.com/HydroniumLabs/h3o) ⭐ 543 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 - Rust implementation of the H3 geospatial indexing system.
* [sguaba](https://github.com/helsing-ai/sguaba) ⭐ 513 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - Types for points and vectors in coordinate spaces and transformations based on rigid body transforms.
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 504 | 🐛 113 | 🌐 Rust | 📅 2026-09-15 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 474 | 🐛 45 | 🌐 Rust | 📅 2026-09-04 - Zero-Copy reading and writing of geospatial data.
* [gdal](https://github.com/georust/rust-gdal) ⭐ 450 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
...
* [Ferrostar](https://github.com/stadiamaps/ferrostar) ⭐ 419 | 🐛 141 | 🌐 Kotlin | 📅 2026-09-15 - A FOSS navigation SDK built from the ground up for the future.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 271 | 🐛 20 | 🌐 Rust | 📅 2026-09-15 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 209 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
...
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 180 | 🐛 8 | 🌐 Rust | 📅 2026-09-15 - Computational Geometry library written in Rust.
...
* [stac-rs](https://github.com/gadomski/stac-rs) ⭐ 145 | 🐛 33 | 🌐 Rust | 📅 2026-09-15 - Rust implementation of the SpatioTemporal Asset Catalog (STAC) specification.
* [GeoTIFF](https://github.com/georust/geotiff) ⭐ 134 | 🐛 10 | 🌐 Rust | 📅 2026-07-31 - Work with GeoTIFF raster files.
...
* [gtfs-structures](https://github.com/rust-transit/gtfs-structure) ⭐ 78 | 🐛 21 | 🌐 Rust | 📅 2026-09-15 - Read GTFS files into structs, with smart references.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 62 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [osm-lump-ways](https://github.com/amandasaurus/osm-lump-ways) ⭐ 40 | 🐛 0 | 🌐 Rust | 📅 2026-09-15 - Group OSM ways based on topology & shared tags
* [coord\_transforms](https://github.com/DaveKram/coord_transforms) ⚠️ Archived - Rust crate for performing coordinate transforms.
* [kml](https://github.com/georust/kml) ⭐ 34 | 🐛 6 | 🌐 Rust | 📅 2026-07-08 - Rust support for reading and writing KML with a focus on conversion to geo-types primitives.
* [polyline](https://github.com/georust/rust-polyline) ⭐ 33 | 🐛 7 | 🌐 Rust | 📅 2025-07-26 - Google Encoded Polyline encoding & decoding in Rust.
* [osm-pbf-parquet](https://github.com/OvertureMaps/osm-pbf-parquet) ⭐ 31 | 🐛 4 | 🌐 Rust | 📅 2026-09-15 - Transcode OSM PBF file to parquet files.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 4 | 🌐 Rust | 📅 2026-09-15 - utils & tiles w/ (rs & pyo3).
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-15 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [pgstac-rs](https://github.com/gadomski/pgstac-rs) ⚠️ Archived - Rust interface for [pgstac](https://github.com/stac-utils/pgstac) ⭐ 223 | 🐛 75 | 🌐 PLpgSQL | 📅 2026-09-14.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 216 | 🌐 Swift | 📅 2026-09-15 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,428 | 🐛 3,521 | 🌐 C++ | 📅 2026-09-15 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,600 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,015 | 🐛 53 | 🌐 Dart | 📅 2026-09-13 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,208 | 🐛 610 | 🌐 C++ | 📅 2026-09-15 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-15 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 573 | 🐛 25 | 🌐 Kotlin | 📅 2026-09-15 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,497 | 🐛 199 | 🌐 Scala | 📅 2026-09-15 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,382 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,400 | 🐛 70 | 🌐 Python | 📅 2026-09-15 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,182 | 🐛 164 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,117 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,345 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 118 | 🌐 Python | 📅 2026-09-15 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [GeoJs](https://github.com/OpenGeoscience/geojs) ⭐ 471 | 🐛 46 | 🌐 JavaScript | 📅 2026-09-15 - High-performance visualization and interactive data exploration of scientific and geospatial location aware datasets.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
...
* [deck.gl-raster](https://github.com/developmentseed/deck.gl-raster) ⭐ 228 | 🐛 103 | 🌐 TypeScript | 📅 2026-09-04 - Client-side, GPU-accelerated Cloud-Optimized GeoTIFF visualization in deck.gl.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,358 | 🐛 61 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,176 | 🐛 112 | 🌐 Java | 📅 2026-09-15 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 979 | 🐛 219 | 🌐 C | 📅 2026-09-15 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 433 | 🐛 176 | 🌐 Python | 📅 2026-09-15 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 283 | 🐛 2 | 🌐 Python | 📅 2026-09-15 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Magrit](https://github.com/riatelab/magrit) ⭐ 162 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-14 - Magrit is an online application for thematic mapping.
...
* [ZipCheckup](https://github.com/artakulov/us-water-quality-data) ⭐ 4 | 🐛 0 | 📅 2026-09-15 - Free ZIP-level environmental safety data platform covering water quality, air quality, PFAS, radon, lead, flood risk and 11 more verticals across 42K US ZIP codes. Public API, CC BY 4.0.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,089 | 🐛 49 | 🌐 Python | 📅 2026-09-07 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 320,859 | 🐛 18 | 🌐 Python | 📅 2026-09-15
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,259 | 🐛 0 | 📅 2026-09-12
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,503 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,525 | 🐛 69 | 📅 2026-07-21
...
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 538 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-09-15
