...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 625 | 🐛 10 | 🌐 C | 📅 2026-09-08 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [duckdb-raster](https://github.com/ahuarte47/duckdb-raster) ⭐ 54 | 🐛 0 | 🌐 C | 📅 2026-09-08 - DuckDB Extension for reading and writing raster files using SQL.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,574 | 🐛 278 | 🌐 TypeScript | 📅 2026-09-08 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,308 | 🐛 190 | 🌐 TypeScript | 📅 2026-09-08 - An SVG mapping component library for React, built on top of d3-geo.
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,044 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data into vector tiles on the fly.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,363 | 🐛 889 | 🌐 TypeScript | 📅 2026-09-08 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,181 | 🐛 24 | 🌐 Python | 📅 2026-09-08 - A dynamic Web Map tile server.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 91 | 🌐 TypeScript | 📅 2026-09-08 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 241 | 🐛 35 | 🌐 Python | 📅 2026-09-08 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,598 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,831 | 🐛 97 | 🌐 Python | 📅 2026-09-08 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [PyLandStats](https://github.com/martibosch/pylandstats) ⭐ 111 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - An open-source Pythonic library to compute landscape metrics.
...
* [gee\_s1\_ard](https://github.com/adugnag/gee_s1_ard) ⭐ 301 | 🐛 1 | 🌐 Python | 📅 2024-12-17 - Creates an analysis ready sentinel-1 SAR image collection in Google Earth Engine by applying additional border noise correction, speckle filtering and radiometric terrain normalization.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,944 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,175 | 🐛 216 | 🌐 Python | 📅 2026-09-08 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
...
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,884 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,597 | 🐛 779 | 🌐 C++ | 📅 2026-09-08 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,459 | 🐛 113 | 🌐 Python | 📅 2026-09-01 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,177 | 🐛 944 | 🌐 C++ | 📅 2026-09-08 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,722 | 🐛 79 | 🌐 C++ | 📅 2026-09-08 - Computational geometry and spatial indexing on the sphere.
...
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,799 | 🐛 60 | 🌐 C | 📅 2026-09-08 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 54 | 🌐 C++ | 📅 2026-09-08 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,666 | 🐛 244 | 🌐 Java | 📅 2026-09-08 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,038 | 🐛 46 | 🌐 Java | 📅 2026-09-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,231 | 🐛 225 | 🌐 Java | 📅 2026-09-05 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,689 | 🐛 1,661 | 🌐 JavaScript | 📅 2026-09-08 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,564 | 🐛 510 | 🌐 TypeScript | 📅 2026-09-08 - WebGL2 powered geospatial visualization layers.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,945 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-08 - Interface for Reading from the Earth System Datacube.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,772 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,355 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,223 | 🐛 50 | 🌐 Python | 📅 2026-09-07 - For conversions between projections.
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 971 | 🐛 79 | 🌐 Python | 📅 2026-09-08 - xarray-spatial implements common raster analysis functions using Numba and provides an easy-to-install, easy-to-extend codebase for raster analysis.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 54 | 🌐 C++ | 📅 2026-09-08 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 185 | 🌐 Python | 📅 2026-09-08 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 631 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 592 | 🐛 22 | 🌐 Python | 📅 2026-09-08 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
...
* [EOReader](https://github.com/sertit/eoreader) ⭐ 347 | 🐛 61 | 🌐 Python | 📅 2026-09-08 - EOReader is a multi-satellite reader allowing you to open optical and SAR data.
...
* [RichDEM](https://github.com/r-barnes/richdem) ⭐ 324 | 🐛 64 | 🌐 C++ | 📅 2024-06-24 - High-performance Terrain and Hydrology Analysis.
* [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 324 | 🐛 42 | 🌐 Python | 📅 2026-09-08 - STAC API implementation with FastAPI.
...
* [Detectree](https://github.com/martibosch/detectree) ⭐ 279 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - DetecTree is a Pythonic library to classify tree/non-tree pixels from aerial imagery.
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,444 | 🐛 70 | 🌐 R | 📅 2026-09-04 - Simple Features for R.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 946 | 🐛 21 | 🌐 R | 📅 2026-09-04 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 813 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 778 | 🐛 63 | 🌐 R | 📅 2026-09-07 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 710 | 🐛 16 | 🌐 R | 📅 2026-09-04 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 618 | 🐛 13 | 🌐 C++ | 📅 2026-09-08 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
...
* [ncdfgeom](https://github.com/USGS-R/ncdfgeom) ⭐ 19 | 🐛 10 | 🌐 R | 📅 2026-09-08 - NetCDF-CF Geometry and Timeseries Tools for R.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,786 | 🐛 124 | 🌐 Rust | 📅 2026-09-08 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,168 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,898 | 🐛 52 | 🌐 Rust | 📅 2026-09-08 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,928 | 🐛 133 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,753 | 🐛 144 | 🌐 Rust | 📅 2026-09-08 - A high-performance, general-purpose graph library for Python, written in Rust.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 500 | 🐛 124 | 🌐 Rust | 📅 2026-09-08 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [Ferrostar](https://github.com/stadiamaps/ferrostar) ⭐ 419 | 🐛 150 | 🌐 Kotlin | 📅 2026-09-08 - A FOSS navigation SDK built from the ground up for the future.
...
* [RINEX](https://github.com/georust/rinex) ⭐ 126 | 🐛 33 | 🌐 Rust | 📅 2026-09-08 - RINEX analysis & and processing.
...
* [PMTiles (for Rust)](https://github.com/stadiamaps/pmtiles-rs) ⭐ 109 | 🐛 11 | 🌐 Rust | 📅 2026-09-08 - Rust implementation of PMTiles
...
* [Proj4rs](https://github.com/3liz/proj4rs) ⭐ 79 | 🐛 3 | 🌐 Rust | 📅 2026-07-16 - Rust adaptation of Proj4
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 74 | 🐛 13 | 🌐 Rust | 📅 2026-09-08 - Manage, convert and enrich transit data.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-08 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [RTree2D](https://github.com/plokhotnyuk/rtree2d) ⭐ 145 | 🐛 14 | 🌐 Scala | 📅 2026-08-21 - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 919 | 🐛 215 | 🌐 Swift | 📅 2026-09-08 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,350 | 🐛 3,507 | 🌐 C++ | 📅 2026-09-08 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,194 | 🐛 608 | 🌐 C++ | 📅 2026-09-08 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-08 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 568 | 🐛 17 | 🌐 Kotlin | 📅 2026-09-08 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,496 | 🐛 200 | 🌐 Scala | 📅 2026-09-08 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,359 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,398 | 🐛 69 | 🌐 Python | 📅 2026-09-08 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,167 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,115 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,343 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 120 | 🌐 Python | 📅 2026-09-08 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,351 | 🐛 61 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 976 | 🐛 224 | 🌐 C | 📅 2026-09-08 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 430 | 🐛 181 | 🌐 Python | 📅 2026-09-08 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 281 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 319,361 | 🐛 20 | 🌐 Python | 📅 2026-09-01
