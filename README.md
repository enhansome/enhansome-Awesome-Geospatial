...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,719 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 356 | 🌐 Java | 📅 2026-08-26 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-07-01 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 826 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 624 | 🐛 10 | 🌐 C | 📅 2026-08-30 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [GeoDesk](https://github.com/clarisma/geodesk) ⭐ 197 | 🐛 43 | 🌐 Java | 📅 2026-07-17 - Fast and storage-efficient spatial database engine for OpenStreetMap data
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,360 | 🐛 888 | 🌐 TypeScript | 📅 2026-08-27 - A library for building rich, web-based geospatial data explorers.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 33 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 73 | 🌐 TypeScript | 📅 2026-08-30 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 215 | 🐛 17 | 🌐 Python | 📅 2026-08-30 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [PySAR](https://github.com/insarlab/PySAR) ⭐ 830 | 🐛 67 | 🌐 Python | 📅 2026-08-24 - InSAR time series analysis in Python.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 175 | 🐛 3 | 🌐 Python | 📅 2026-08-28 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,588 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [plas.io](https://github.com/verma/plasio) ⭐ 538 | 🐛 36 | 🌐 JavaScript | 📅 2020-03-26 - WebGL point cloud rendering.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,118 | 🐛 455 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,815 | 🐛 84 | 🌐 Python | 📅 2026-08-30 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [PyLandStats](https://github.com/martibosch/pylandstats) ⭐ 111 | 🐛 6 | 🌐 Python | 📅 2026-08-28 - An open-source Pythonic library to compute landscape metrics.
...
* [H3](https://github.com/uber/h3) ⭐ 6,508 | 🐛 164 | 🌐 C | 📅 2026-08-27 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 777 | 🐛 63 | 🌐 R | 📅 2026-08-24 - Google Earth Engine for R.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,935 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,163 | 🐛 211 | 🌐 Python | 📅 2026-08-29 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,129 | 🐛 6 | 🌐 Python | 📅 2026-08-24 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 768 | 🐛 105 | 🌐 Python | 📅 2026-08-28 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [aviary](https://github.com/geospaitial-lab/aviary) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-08-24 - Pythonic Framework for AI Inference on Geospatial Data.
...
* [H3](https://github.com/uber/h3) ⭐ 6,508 | 🐛 164 | 🌐 C | 📅 2026-08-27 - Hexagonal hierarchical geospatial indexing system.
...
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 70 | 🐛 56 | 🌐 C | 📅 2026-08-19 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,594 | 🐛 777 | 🌐 C++ | 📅 2026-08-30 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,431 | 🐛 113 | 🌐 Python | 📅 2026-08-26 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,136 | 🐛 938 | 🌐 C++ | 📅 2026-08-26 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,719 | 🐛 77 | 🌐 C++ | 📅 2026-08-25 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,843 | 🐛 52 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,797 | 🐛 57 | 🌐 C | 📅 2026-08-28 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 41 | 🌐 C++ | 📅 2026-08-27 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,715 | 🐛 77 | 🌐 C# | 📅 2026-08-28 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [MaxRev.Gdal.Core](https://github.com/MaxRev-Dev/gdal.netcore) ⭐ 211 | 🐛 2 | 🌐 C# | 📅 2026-08-28 - Bindings for GDAL and OGR (both win-x64 and linux-x64).
...
* [S2](https://github.com/golang/geo) ⭐ 1,852 | 🐛 37 | 🌐 Go | 📅 2026-08-24 - S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the best planar geometry libraries.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,650 | 🐛 240 | 🌐 Java | 📅 2026-08-27 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,010 | 🐛 44 | 🌐 Java | 📅 2026-08-18 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,228 | 🐛 224 | 🌐 Java | 📅 2026-08-13 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,625 | 🐛 1,648 | 🌐 JavaScript | 📅 2026-08-30 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,537 | 🐛 484 | 🌐 TypeScript | 📅 2026-08-30 - WebGL2 powered geospatial visualization layers.
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,770 | 🐛 12 | 🌐 JavaScript | 📅 2026-07-21 - A high-performance JavaScript library for 2D spatial indexing.
...
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,239 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-12 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
* [Vue2Leaflet](https://github.com/KoRiGaN/Vue2Leaflet) ⭐ 1,955 | 🐛 42 | 🌐 JavaScript | 📅 2024-10-29 - Vue 2 components for Leaflet maps.
* [flatbush](https://github.com/mourner/flatbush) ⭐ 1,597 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-08 - A really fast static spatial index for 2D points and rectangles in JavaScript.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,091 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-30 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,083 | 🐛 245 | 🌐 JavaScript | 📅 2026-08-24 - Draw tools for mapbox-gl-js.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 102 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-25 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 60 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-30 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 221 | 🐛 27 | 🌐 Julia | 📅 2026-08-30 - Generic Mapping Tools Library Wrapper for Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-30 - Interface for Reading from the Earth System Datacube.
* [STAC.jl](https://github.com/JuliaClimate/STAC.jl) ⭐ 33 | 🐛 8 | 🌐 Julia | 📅 2026-07-24 - SpatioTemporal Asset Catalog (STAC) julia client.
...
* [Spatial K](https://github.com/maplibre/spatial-k) ⭐ 140 | 🐛 43 | 🌐 Kotlin | 📅 2026-08-30 - Spatial K - A set of Kotlin Multiplatform Libraries for working with geospatial data
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,831 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,233 | 🐛 421 | 🌐 Python | 📅 2026-08-30 - Python tools for geographic data.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,768 | 🐛 1 | 🌐 Python | 📅 2026-08-30 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,336 | 🐛 8 | 🌐 Python | 📅 2026-08-24 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,889 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 41 | 🌐 C++ | 📅 2026-08-27 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 187 | 🌐 Python | 📅 2026-08-30 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [Spectral Python](https://github.com/spectralpython/spectral) ⭐ 677 | 🐛 21 | 🌐 Python | 📅 2026-08-29 - Python module for hyperspectral image processing.
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 615 | 🐛 0 | 🌐 Python | 📅 2026-08-30 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 613 | 🐛 46 | 🌐 Python | 📅 2026-08-28 - A Python Framework for Large-Scale SAR Satellite Data Processing.
...
* [whitebox](https://github.com/giswqs/whitebox) ⭐ 422 | 🐛 1 | 🌐 Python | 📅 2026-01-31 - Python frontend for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,195 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [RichDEM](https://github.com/r-barnes/richdem) ⭐ 324 | 🐛 64 | 🌐 C++ | 📅 2024-06-24 - High-performance Terrain and Hydrology Analysis.
* [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 323 | 🐛 42 | 🌐 Python | 📅 2026-08-29 - STAC API implementation with FastAPI.
...
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 313 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,195 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [Detectree](https://github.com/martibosch/detectree) ⭐ 279 | 🐛 6 | 🌐 Python | 📅 2026-08-24 - DetecTree is a Pythonic library to classify tree/non-tree pixels from aerial imagery.
...
* [fastkml](https://github.com/cleder/fastkml) ⭐ 257 | 🐛 18 | 🌐 Python | 📅 2026-08-24 - Fastkml is a library to read, write and manipulate KML files. It aims to keep it simple and fast (using lxml if available).
...
* [Siphon](https://github.com/unidata/siphon) ⭐ 245 | 🐛 82 | 🌐 Python | 📅 2026-08-24 - A collection of Python utilities for retrieving atmospheric and oceanic data from remote sources, focusing on being able to retrieve data from Unidata data technologies, such as the THREDDS data server.
...
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 51 | 🌐 Python | 📅 2026-08-27 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
...
* [geeup](https://github.com/samapriya/geeup) ⭐ 140 | 🐛 0 | 🌐 Python | 📅 2025-12-31 - Simple CLI for Earth Engine Uploads.
* [LARD](https://github.com/deel-ai/LARD) ⭐ 136 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2026-08-11 - A runway dataset and a generator of synthetic aerial images with automatic labeling.
...
* [pygeoif](https://github.com/cleder/pygeoif) ⭐ 74 | 🐛 15 | 🌐 Python | 📅 2026-08-24 - PyGeoIf provides a GeoJSON-like protocol for geo-spatial (GIS) vector data. A simple, pure Python implementation of geometric objects and operations, useful for basic GIS tasks.
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,442 | 🐛 65 | 🌐 R | 📅 2026-08-21 - Simple Features for R.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 943 | 🐛 20 | 🌐 R | 📅 2026-08-21 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 813 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 777 | 🐛 63 | 🌐 R | 📅 2026-08-24 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 706 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 617 | 🐛 15 | 🌐 C++ | 📅 2026-08-29 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 611 | 🐛 26 | 🌐 R | 📅 2026-08-20 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 546 | 🐛 18 | 🌐 R | 📅 2026-08-27 - Satellite image time series package for R.
...
* [osmdata](https://github.com/ropensci/osmdata) ⭐ 342 | 🐛 23 | 🌐 R | 📅 2026-08-28 - R package for downloading OpenStreetMap data.
...
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 240 | 🐛 35 | 🌐 R | 📅 2026-07-21 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 186 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,195 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [giscoR](https://github.com/rOpenGov/giscoR) ⭐ 81 | 🐛 0 | 🌐 R | 📅 2026-08-28 - An API package that helps to retrieve data from Eurostat - GISCO (the Geographic Information System of the COmmission).
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,681 | 🐛 144 | 🌐 Rust | 📅 2026-08-23 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,883 | 🐛 72 | 🌐 Rust | 📅 2026-08-30 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,919 | 🐛 125 | 🌐 Rust | 📅 2026-08-30 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,752 | 🐛 135 | 🌐 Rust | 📅 2026-08-17 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,568 | 🐛 68 | 🌐 Rust | 📅 2026-08-28 - About Native Maps for Web, Mobile and Desktop.
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,195 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 498 | 🐛 131 | 🌐 Rust | 📅 2026-08-30 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 423 | 🐛 85 | 🌐 Rust | 📅 2026-08-11 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 268 | 🐛 23 | 🌐 Rust | 📅 2026-08-23 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 207 | 🐛 2 | 🌐 Rust | 📅 2026-08-16 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
...
* [plateau-gis-converter](https://github.com/MIERUNE/plateau-gis-converter) ⭐ 103 | 🐛 51 | 🌐 Rust | 📅 2026-08-27 - A GUI and CLI tool for converting PLATEAU's 3D city models (CityGML) of Japan into various geospatial formats, including 3D Tiles, MVT, and GeoPackage.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 72 | 🐛 14 | 🌐 Rust | 📅 2026-08-27 - Manage, convert and enrich transit data.
* [Bevy Point Cloud](https://github.com/rlamarche/bevy_pointcloud) ⭐ 67 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - A Bevy plugin to render point clouds.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2026-08-30 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [OGC API](https://github.com/georust/ogcapi) ⭐ 42 | 🐛 3 | 🌐 Rust | 📅 2026-08-28 - OGC API building blocks.
...
* [RouteE Compass](https://github.com/NREL/routee-compass) ⭐ 29 | 🐛 85 | 🌐 Rust | 📅 2026-08-28 - An energy-aware vehicle routing engine.
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 7 | 🌐 Rust | 📅 2026-08-26 - utils & tiles w/ (rs & pyo3).
...
* [cql2-rs](https://github.com/developmentseed/cql2-rs) ⭐ 23 | 🐛 11 | 🌐 Rust | 📅 2026-08-24 - Library for parsing the OGC CQL2 filter language.
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-08-30 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [pgstac-rs](https://github.com/gadomski/pgstac-rs) ⚠️ Archived - Rust interface for [pgstac](https://github.com/stac-utils/pgstac) ⭐ 222 | 🐛 70 | 🌐 PLpgSQL | 📅 2026-08-24.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 917 | 🐛 215 | 🌐 Swift | 📅 2026-08-28 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,256 | 🐛 3,477 | 🌐 C++ | 📅 2026-08-30 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,601 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,013 | 🐛 45 | 🌐 Dart | 📅 2026-08-30 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,172 | 🐛 576 | 🌐 C++ | 📅 2026-08-30 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 650 | 🐛 518 | 🌐 Kotlin | 📅 2026-08-28 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 556 | 🐛 44 | 🌐 Kotlin | 📅 2026-08-30 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,495 | 🐛 200 | 🌐 Scala | 📅 2026-08-28 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,395 | 🐛 70 | 🌐 Python | 📅 2026-08-29 - Python Data. Leaflet.js Maps.
...
* [lonboard](https://github.com/developmentseed/lonboard) ⭐ 963 | 🐛 124 | 🌐 Python | 📅 2026-08-24 - Fast, interactive geospatial data visualization in Jupyter.
...
* [GeoJs](https://github.com/OpenGeoscience/geojs) ⭐ 470 | 🐛 47 | 🌐 JavaScript | 📅 2026-08-27 - High-performance visualization and interactive data exploration of scientific and geospatial location aware datasets.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
...
* [deck.gl-raster](https://github.com/developmentseed/deck.gl-raster) ⭐ 225 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-03 - Client-side, GPU-accelerated Cloud-Optimized GeoTIFF visualization in deck.gl.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,159 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 975 | 🐛 224 | 🌐 C | 📅 2026-08-30 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 427 | 🐛 176 | 🌐 Python | 📅 2026-08-30 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,085 | 🐛 50 | 🌐 Python | 📅 2026-08-28 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
* [Geopython](https://github.com/urschrei/Geopython) ⭐ 381 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-24 - Notebooks and libraries for spatial/geo Python explorations.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 317,185 | 🐛 17 | 🌐 Python | 📅 2026-08-25
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,524 | 🐛 92 | 📅 2024-05-17
...
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,506 | 🐛 65 | 📅 2026-07-21
...
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,531 | 🐛 1 | 📅 2026-07-23
...
* [Awesome Frontend GIS](https://github.com/joewdavies/awesome-frontend-gis) ⭐ 853 | 🐛 8 | 📅 2026-08-18 - Geographic Information Systems (GIS) for web browsers. For managing, analyzing, editing, and visualizing geographic data.
