...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,728 | 🐛 163 | 🌐 Go | 📅 2026-09-02 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 356 | 🌐 Java | 📅 2026-09-10 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,076 | 🐛 117 | 🌐 C++ | 📅 2026-09-07 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 825 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 626 | 🐛 9 | 🌐 C | 📅 2026-09-10 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [H2GIS](https://github.com/orbisgis/h2gis) ⭐ 222 | 🐛 37 | 🌐 PLpgSQL | 📅 2026-06-24 - A spatial extension of the H2 database.
* [GeoDesk](https://github.com/clarisma/geodesk) ⭐ 201 | 🐛 47 | 🌐 Java | 📅 2026-07-17 - Fast and storage-efficient spatial database engine for OpenStreetMap data
* [duckdb-raster](https://github.com/ahuarte47/duckdb-raster) ⭐ 55 | 🐛 0 | 🌐 C | 📅 2026-09-08 - DuckDB Extension for reading and writing raster files using SQL.
...
* [Atlas4D](https://github.com/crisbez/atlas4d-base) ⭐ 16 | 🐛 9 | 🌐 HTML | 📅 2026-05-15 - Open-source 4D spatiotemporal platform with PostGIS, TimescaleDB, pgvector, and H3 hexagonal indexing.
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,269 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-10 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,605 | 🐛 284 | 🌐 TypeScript | 📅 2026-09-10 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,535 | 🐛 119 | 🌐 HTML | 📅 2026-08-25 - An open-source JavaScript library for integrated 2D/3D maps.
* [L7](https://github.com/antvis/L7) ⭐ 4,062 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-08 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,308 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-09 - An SVG mapping component library for React, built on top of d3-geo.
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,165 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,064 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data into vector tiles on the fly.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,363 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-10 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,181 | 🐛 23 | 🌐 Python | 📅 2026-09-09 - A dynamic Web Map tile server.
...
* [d3-geo](https://github.com/d3/d3-geo) ⭐ 1,101 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 - A library for creating maps based on D3.js.
...
* [ArcGIS REST JS](https://github.com/Esri/arcgis-rest-js) ⭐ 390 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-05 - Compact, modular JavaScript wrappers for the ArcGIS REST API that run in Node.js and modern browsers.
...
* [gridviz](https://github.com/eurostat/gridviz) ⭐ 244 | 🐛 20 | 🌐 JavaScript | 📅 2026-05-08 - A package for visualizing gridded data.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 34 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-10 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 244 | 🐛 12 | 🌐 Python | 📅 2026-09-10 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [PySAR](https://github.com/insarlab/PySAR) ⭐ 833 | 🐛 67 | 🌐 Python | 📅 2026-09-01 - InSAR time series analysis in Python.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 614 | 🐛 46 | 🌐 Python | 📅 2026-09-03 - A Python Framework for Large-Scale SAR Satellite Data Processing.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 189 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,604 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 710 | 🐛 16 | 🌐 R | 📅 2026-09-04 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [plas.io](https://github.com/verma/plasio) ⭐ 539 | 🐛 36 | 🌐 JavaScript | 📅 2020-03-26 - WebGL point cloud rendering.
* [Entwine](https://github.com/connormanning/entwine) ⭐ 528 | 🐛 3 | 🌐 C++ | 📅 2026-06-02 - Point cloud indexing for massive datasets.
* [displaz](https://github.com/c42f/displaz) ⭐ 247 | 🐛 59 | 🌐 C++ | 📅 2026-07-08 - A hackable lidar viewer.
* [rGEDI](https://github.com/carlos-alberto-silva/rGEDI) ⭐ 185 | 🐛 1 | 🌐 R | 📅 2026-03-27 - An R Package for NASA's Global Ecosystem Dynamics Investigation (GEDI) Data Visualization and Processing.
...
* [3dfier](https://github.com/tudelft3d/3dfier) ⭐ 634 | 🐛 30 | 🌐 C++ | 📅 2026-09-08 - The open-source tool for creation of 3D models.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,126 | 🐛 456 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [6S\_emulator](https://github.com/samsammurphy/6S_emulator) ⭐ 87 | 🐛 2 | 🌐 HTML | 📅 2020-08-07 - The 6S emulator is an open-source atmospheric correction tool. It is based on the 6S radiative transfer model but it runs 100x faster with minimal additional error (i.e. < 0.5 %).
* [SIAC](https://github.com/MarcYin/SIAC) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-09-03 - A sensor invariant Atmospheric Correction (SIAC).
* [SIAC\_GEE](https://github.com/MarcYin/SIAC_GEE) ⭐ 65 | 🐛 3 | 🌐 JavaScript | 📅 2020-10-23 - SIAC GEE version.
* [ARCSI](https://github.com/remotesensinginfo/arcsi) ⭐ 47 | 🐛 5 | 🌐 Python | 📅 2024-07-28 - The Atmospheric and Radiometric Correction of Satellite Imagery (ARCSI) software provides a command line tool for the generation of Analysis Ready Data (ARD) optical data including atmospheric correction, cloud masking, topographic correction etc.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,834 | 🐛 103 | 🌐 Python | 📅 2026-09-08 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 263 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [PyLandStats](https://github.com/martibosch/pylandstats) ⭐ 112 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - An open-source Pythonic library to compute landscape metrics.
* [NLMR](https://github.com/ropensci/NLMR) ⭐ 69 | 🐛 9 | 🌐 R | 📅 2026-09-10 - R package to simulate neutral landscape models.
...
* [prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 19 | 🌐 R | 📅 2026-09-07 - R package that uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
...
* [H3](https://github.com/uber/h3) ⭐ 6,533 | 🐛 169 | 🌐 C | 📅 2026-09-10 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
* [MDAL](https://github.com/lutraconsulting/MDAL) ⭐ 190 | 🐛 81 | 🌐 Roff | 📅 2026-07-31 - Mesh Data Abstraction Library.
...
* [OpenSky API](https://github.com/openskynetwork/opensky-api) ⭐ 466 | 🐛 14 | 🌐 Python | 📅 2026-09-05 - Retrieve live airspace information.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 778 | 🐛 63 | 🌐 R | 📅 2026-09-07 - Google Earth Engine for R.
* [eemont](https://github.com/davemlz/eemont) ⭐ 452 | 🐛 9 | 🌐 Python | 📅 2026-08-05 - A python package that extends Google Earth Engine.
...
* [geeo](https://github.com/leonsnill/geeo) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-06-09 - GEEO is a processing pipeline and collection of algorithms for obtaining Analysis-Ready-Data (ARD) from Landsat and Sentinel-2 using the Google Earth Engine Python API.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,946 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,176 | 🐛 217 | 🌐 Python | 📅 2026-09-09 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,142 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
* [SNIPER](https://github.com/mahyarnajibi/SNIPER) ⭐ 2,688 | 🐛 115 | 🌐 Python | 📅 2021-08-22 - SNIPER is an efficient multi-scale object detection algorithm.
...
* [PixelLib](https://github.com/ayoolaolafenwa/PixelLib) ⭐ 1,071 | 🐛 99 | 🌐 Python | 📅 2023-10-06 - Pixellib is a library for performing segmentation of images. It suports both Semantic Segmentation as Instance Segmentation.
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 772 | 🐛 102 | 🌐 Python | 📅 2026-08-30 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [Deep Learning ArcGIS](https://github.com/Esri/deep-learning-frameworks) ⭐ 650 | 🐛 9 | 📅 2026-07-21 - Deep Learning Libraries Installers for ArcGIS.
...
* [tsl](https://github.com/TorchSpatiotemporal/tsl) ⭐ 388 | 🐛 22 | 🌐 Python | 📅 2026-07-27 - PyTorch library for processing spatiotemporal data.
* [Hyperspectral](https://github.com/KGPML/Hyperspectral) ⭐ 308 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2019-01-14 - Deep Learning for Land-cover Classification in Hyperspectral Images.
...
* [AIDE](https://github.com/microsoft/aerial_wildlife_detection) ⭐ 246 | 🐛 29 | 🌐 Python | 📅 2026-06-10 - Annotation Interface for Data-driven Ecology: Tools for detecting wildlife in aerial images using active learning
...
* [aviary](https://github.com/geospaitial-lab/aviary) ⭐ 16 | 🐛 5 | 🌐 Python | 📅 2026-09-06 - Pythonic Framework for AI Inference on Geospatial Data.
* [SamGIS](https://github.com/trincadev/samgis-be) ⚠️ Archived – Image Segmentation machine learning based (Segment Anything by Meta - Facebook) applied to GIS and geo data also with GPU requirements. A Segment Anything HuggingFace demo [here](https://huggingface.co/spaces/aletrn/samgis) and an HuggingFace [demo](https://huggingface.co/spaces/aletrn/samgis-lisa-on-cuda) with natural language-based image segmentation capabilities via [LISA](https://github.com/dvlab-research/LISA) ⭐ 2,675 | 🐛 115 | 🌐 Python | 📅 2025-02-16.

## MCP Servers

* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
* [OSM Edit MCP](https://github.com/skywinder/osm-edit-mcp) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Python MCP server for inspecting OpenStreetMap data and previewing version-checked road-edit proposals from selected local GPX survey segments. Applying changes requires explicit user confirmation of the proposal digest. Alpha.
* [bhoonidhi-mcp](https://github.com/geovicco-dev/bhoonidhi-mcp) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - Model Context Protocol server for ISRO's Bhoonidhi Earth-observation portal, over the bhoonidhi-downloader SDK. Lets an AI agent search the archive in natural language, resolve place names and satellite tokens, report each scene's availability, and (with a login) save queries, download open-access scenes, and stage scenes to the cart.
...
* [geoai-skills](https://github.com/muend/geoai-skills) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Vendor-neutral Agent Skills (SKILL.md) that make an AI coding agent check coordinate reference systems, spatial validation, comparability and uncertainty before a result becomes a claim. Works with Claude Code, Codex, Cursor and GitHub Copilot; ships a paired evaluation against a skills-disabled control arm, including the quality gate it fails.

## C

* [libvips](https://github.com/libvips/libvips) ⭐ 11,632 | 🐛 82 | 🌐 C | 📅 2026-09-06 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,533 | 🐛 169 | 🌐 C | 📅 2026-09-10 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,885 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [FORCE](https://github.com/davidfrantz/force) ⭐ 200 | 🐛 18 | 🌐 C | 📅 2026-09-07 - Framework for Operational Radiometric Correction for Environmental monitoring.
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 70 | 🐛 56 | 🌐 C | 📅 2026-08-31 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,602 | 🐛 785 | 🌐 C++ | 📅 2026-09-10 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,461 | 🐛 113 | 🌐 Python | 📅 2026-09-10 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,189 | 🐛 942 | 🌐 C++ | 📅 2026-09-10 - Open Source Routing Engine for OpenStreetMap.
...
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,116 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,724 | 🐛 79 | 🌐 C++ | 📅 2026-09-08 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,857 | 🐛 50 | 🌐 C++ | 📅 2026-09-08 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,800 | 🐛 61 | 🌐 C | 📅 2026-09-10 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 61 | 🌐 C++ | 📅 2026-09-10 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [libspatialindex](https://github.com/libspatialindex/libspatialindex) ⭐ 797 | 🐛 25 | 🌐 C++ | 📅 2026-09-09 - C++ implementation of R\*-tree, an MVR-tree and a TPR-tree with C API.
* [hmm](https://github.com/fogleman/hmm) ⭐ 617 | 🐛 13 | 🌐 C | 📅 2023-12-19 - Heightmap meshing utility
...
* [entwine](https://github.com/connormanning/entwine) ⭐ 528 | 🐛 3 | 🌐 C++ | 📅 2026-06-02 - Entwine is a data organization library for massive point clouds, designed to conquer datasets of hundreds of billions of points as well as desktop-scale point clouds.
* [OpenOrienteering Mapper](https://github.com/OpenOrienteering/mapper) ⭐ 495 | 🐛 557 | 🌐 C++ | 📅 2026-07-21 - OpenOrienteering Mapper is a software for creating maps for the orienteering sport.
* [cpd](https://github.com/gadomski/cpd) ⭐ 442 | 🐛 17 | 🌐 C++ | 📅 2026-06-22 - Coherent Point Drift (CPD) is a point-set registration algorithm.
* [RoutingKit](https://github.com/RoutingKit/RoutingKit) ⭐ 440 | 🐛 43 | 🌐 C++ | 📅 2026-04-13 - RoutingKit is a C++ library that provides advanced route planning functionality.
* [gSLICr](https://github.com/carlren/gSLICr) ⭐ 349 | 🐛 14 | 🌐 C++ | 📅 2024-01-03 - Real-time super-pixel segmentation.
* [RichDEM](https://github.com/r-barnes/richdem) ⭐ 324 | 🐛 64 | 🌐 C++ | 📅 2024-06-24 - High-performance Terrain and Hydrology Analysis.
* [Selene](https://github.com/kmhofmann/selene) ⭐ 314 | 🐛 1 | 🌐 C++ | 📅 2022-08-04 - A C++14 image representation, processing and I/O library.
* [TauDEM](https://github.com/dtarb/TauDEM) ⭐ 275 | 🐛 94 | 🌐 C++ | 📅 2026-07-24 - Terrain Analysis Using Digital Elevation Models (TauDEM) software for hydrologic terrain analysis and channel network extraction.
* [OSMExpress](https://github.com/protomaps/OSMExpress) ⭐ 272 | 🐛 12 | 🌐 C++ | 📅 2025-12-04 - Fast database file format for OpenStreetMap.
* [LASzip](https://github.com/LASzip/LASzip) ⭐ 235 | 🐛 26 | 🌐 C++ | 📅 2026-08-21 - Quickly turns bulky LAS files into compact LAZ files without information loss.
...
* [gdalcubes](https://github.com/appelmar/gdalcubes) ⭐ 132 | 🐛 37 | 🌐 C++ | 📅 2026-05-29 - gdalcubes is a library to represent collections of Earth Observation (EO) images as on demand data cubes (or multidimensional arrays).
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,715 | 🐛 56 | 🌐 C# | 📅 2026-09-01 - A .NET GIS solution that is fast and reliable for the .NET platform.
* [DotSpatial](https://github.com/DotSpatial/DotSpatial) ⭐ 922 | 🐛 256 | 🌐 C# | 📅 2025-10-22 - DotSpatial is a geographic information system library written for .NET 4.
* [SharpMap](https://github.com/SharpMap/SharpMap) ⭐ 860 | 🐛 48 | 🌐 C# | 📅 2025-01-06 - SharpMap is an easy-to-use mapping library for use in web and desktop applications.
...
* [MaxRev.Gdal.Core](https://github.com/MaxRev-Dev/gdal.netcore) ⭐ 211 | 🐛 3 | 🌐 C# | 📅 2026-08-31 - Bindings for GDAL and OGR (both win-x64 and linux-x64).
* [Geo](https://github.com/sibartlett/Geo) ⭐ 192 | 🐛 5 | 🌐 C# | 📅 2026-08-31 - A geospatial library for .NET
...
* [turf\_dart](https://github.com/dartclub/turf_dart) ⭐ 83 | 🐛 32 | 🌐 Dart | 📅 2026-09-10 - A turf.js-like geospatial analysis library working with GeoJSON, written in pure Dart.
...
* [geo](https://github.com/bryanjos/geo) ⭐ 679 | 🐛 11 | 🌐 Elixir | 📅 2026-09-07 - A collection of GIS functions for Elixir.
...
* [Proj](https://github.com/CandyGumdrop/proj) ⭐ 10 | 🐛 2 | 🌐 C | 📅 2021-01-13 - Elixir coordinate conversion library using OSGeo's PROJ.4.
* [SRTM](https://github.com/adriankumpf/srtm) ⭐ 7 | 🐛 0 | 🌐 Elixir | 📅 2026-09-10 - Query locations for elevation data from the NASA Shuttle Radar Topography Mission.

## Fortran

* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 114 | 🐛 35 | 🌐 Fortran | 📅 2026-09-10 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [S2](https://github.com/golang/geo) ⭐ 1,853 | 🐛 37 | 🌐 Go | 📅 2026-08-31 - S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the best planar geometry libraries.
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,503 | 🐛 182 | 🌐 Go | 📅 2026-09-09 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
* [Draw2D](https://github.com/llgcode/draw2d) ⭐ 1,163 | 🐛 45 | 🌐 Go | 📅 2026-04-22 - 2D rendering for different output (raster, pdf).
* [orb](https://github.com/paulmach/orb) ⭐ 1,130 | 🐛 19 | 🌐 Go | 📅 2026-03-30 - A set of types for working with 2d geo and planar/projected geometric data in Golang
...
* [go-geom](https://github.com/twpayne/go-geom) ⭐ 973 | 🐛 9 | 🌐 Go | 📅 2026-08-19 - Go library for handling geometries.
...
* [godal](https://github.com/airbusgeo/godal) ⭐ 182 | 🐛 8 | 🌐 Go | 📅 2026-09-04 - Godal aims at providing an idiomatic go wrapper around the GDAL library.
...
* [GeoScript Groovy](https://github.com/geoscript/geoscript-groovy) ⭐ 49 | 🐛 14 | 🌐 Groovy | 📅 2024-04-19 - GeoScript Groovy is the Groovy implementation of GeoScript.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,685 | 🐛 242 | 🌐 Java | 📅 2026-09-10 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,043 | 🐛 47 | 🌐 Java | 📅 2026-09-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,233 | 🐛 225 | 🌐 Java | 📅 2026-09-05 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [Proj4j](https://github.com/locationtech/proj4j) ⭐ 231 | 🐛 31 | 🌐 Java | 📅 2026-08-03 - Java port of the Proj.4 library for coordinate reprojection.
...
* [PDAL-Java](https://github.com/PDAL/java) ⭐ 12 | 🐛 10 | 🌐 Scala | 📅 2025-12-27 - Java extension and bindings for PDAL.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,703 | 🐛 1,662 | 🌐 JavaScript | 📅 2026-09-10 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,575 | 🐛 525 | 🌐 TypeScript | 📅 2026-09-10 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,496 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-03 - React friendly API wrapper around MapboxGL JS.
* [gmaps.js](https://github.com/hpneo/gmaps) ⚠️ Archived - gmaps.js allows you to use the potential of Google Maps in a simple way.
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,945 | 🐛 14 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [geolib](https://github.com/manuelbieh/geolib) ⭐ 4,277 | 🐛 70 | 🌐 JavaScript | 📅 2026-04-03 - Library to provide basic geospatial operations like distance calculation and rotation.
* [rbush](https://github.com/mourner/rbush) ⭐ 2,774 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing.
* [leaflet-providers](https://github.com/leaflet-extras/leaflet-providers) ⭐ 2,379 | 🐛 21 | 🌐 JavaScript | 📅 2026-09-08 - An extension to Leaflet that contains configurations for various free tile providers.
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,362 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,240 | 🐛 101 | 🌐 JavaScript | 📅 2026-08-31 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
* [Vue2Leaflet](https://github.com/KoRiGaN/Vue2Leaflet) ⭐ 1,955 | 🐛 42 | 🌐 JavaScript | 📅 2024-10-29 - Vue 2 components for Leaflet maps.
* [flatbush](https://github.com/mourner/flatbush) ⭐ 1,600 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-08 - A really fast static spatial index for 2D points and rectangles in JavaScript.
* [JSTS](https://github.com/bjornharrtell/jsts) ⭐ 1,562 | 🐛 9 | 🌐 JavaScript | 📅 2025-01-02 - Port of the Java JTS library.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,363 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-10 - A library for building rich, web-based geospatial data explorers.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,344 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,240 | 🐛 256 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [Geometric.js](https://github.com/HarryStevens/geometric) ⭐ 1,104 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-19 - A JavaScript library for doing geometry.
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,101 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-08 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,083 | 🐛 246 | 🌐 JavaScript | 📅 2026-09-07 - Draw tools for mapbox-gl-js.
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,047 | 🐛 94 | 🌐 JavaScript | 📅 2026-05-26 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
...
* [Geo-Three](https://github.com/tentone/geo-three) ⭐ 949 | 🐛 41 | 🌐 TypeScript | 📅 2026-04-05 - Tile based geographic world map visualization library for threejs.
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 821 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [flatten-js](https://github.com/alexbol99/flatten-js) ⭐ 651 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-18 - For manipulating geometrical shapes, finding intersections, checking inclusion, calculating distance, transformations, and more.
...
* [gdal3.js](https://github.com/bugra9/gdal3.js) ⭐ 432 | 🐛 29 | 🌐 JavaScript | 📅 2026-05-13 - Convert raster and vector geospatial data to various formats using GDAL in the browser.
...
* [Heatcanvas.js](https://github.com/sunng87/heatcanvas) ⭐ 403 | 🐛 11 | 🌐 JavaScript | 📅 2022-02-14 - Yet another heatmap implementation for Javascript.
* [arc.js](https://github.com/springmeyer/arc.js) ⭐ 384 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-28 - Calculate great circles routes as lines in GeoJSON or WKT format.
* [GeoPackage.js](https://github.com/ngageoint/geopackage-js) ⭐ 333 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-20 - GeoPackage JS is an implementation of the OGC GeoPackage spec. This library works in both the browser and Node 4+.
* [Bertin.js](https://github.com/neocarto/bertin) ⭐ 316 | 🐛 9 | 🌐 JavaScript | 📅 2023-10-23 - A JavaScript library for visualizing geospatial data and make thematic maps for the web.
...
* [openrouteservice-js](https://github.com/GIScience/openrouteservice-js) ⭐ 249 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-08 - The JavaScript API to consume openrouteservice(s) painlessly!
...
* [geoblaze](https://github.com/GeoTIFF/geoblaze) ⭐ 191 | 🐛 53 | 🌐 JavaScript | 📅 2024-08-05 - Geoblaze is a geospatial raster processing engine written purely in javascript.
...
* [Euclid.ts](https://github.com/mathigon/euclid.js) ⭐ 136 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-12 - 2D Euclidean geometry classes, utilities, and drawing tools.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-10 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 59 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-10 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
* [landspeed.js](https://github.com/springmeyer/landspeed.js) ⭐ 54 | 🐛 1 | 🌐 JavaScript | 📅 2017-01-07 - WMS server using node-mapnik.
* [tilelive-postgis](https://github.com/stepankuzmin/tilelive-postgis) ⭐ 52 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-03 - Implements the tilelive API for generating mapnik vector tiles from PostGIS.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 10 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-07 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [ViziCities](https://github.com/UDST/vizicities#getting-started) ⭐ 2,710 | 🐛 105 | 🌐 JavaScript | 📅 2019-02-02 - A framework for 3D geospatial visualization in the browser.
* [DataFrames.jl](https://github.com/JuliaStats/DataFrames.jl) ⭐ 1,831 | 🐛 162 | 🌐 Julia | 📅 2026-09-05 - Tools for working with tabular data in Julia.
* [GeoStats.jl](https://github.com/JuliaEarth/GeoStats.jl) ⭐ 591 | 🐛 5 | 🌐 Julia | 📅 2026-09-10 - An extensible framework for high-performance geostatistics in Julia.
...
* [GeoData.jl](https://github.com/rafaqz/Rasters.jl) ⭐ 264 | 🐛 171 | 🌐 Julia | 📅 2026-08-26 - Standardising geospatial raster data in the Julia language.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 221 | 🐛 28 | 🌐 Julia | 📅 2026-09-10 - Generic Mapping Tools Library Wrapper for Julia.
* [GeoMakie.jl](https://github.com/JuliaPlots/GeoMakie.jl) ⭐ 219 | 🐛 103 | 🌐 Julia | 📅 2026-09-05 - Geographical plotting utilities for Makie.jl
...
* [ArchGDAL](https://github.com/yeesian/ArchGDAL.jl) ⭐ 151 | 🐛 97 | 🌐 Julia | 📅 2026-09-06 - Vector and Raster interfaces.
* [GeoInterface.jl](https://github.com/JuliaGeo/GeoInterface.jl) ⭐ 140 | 🐛 32 | 🌐 Julia | 📅 2026-08-01 - A Julia Protocol for Geospatial Data.
...
* [RegionTrees.jl](https://github.com/rdeits/RegionTrees.jl) ⭐ 114 | 🐛 6 | 🌐 Julia | 📅 2026-07-16 - Quadtrees, Octrees, and more in Julia.
...
* [Shapefile.jl](https://github.com/JuliaGeo/Shapefile.jl) ⭐ 86 | 🐛 20 | 🌐 Julia | 📅 2026-09-06 - Parsing .shp files in Julia.
* [GeoDataFrames.jl](https://github.com/evetion/GeoDataFrames.jl) ⭐ 70 | 🐛 24 | 🌐 Julia | 📅 2026-08-13 - Simple geographical vector interaction built on top of ArchGDAL.
* [GeoJSON.jl](https://github.com/JuliaGeo/GeoJSON.jl) ⭐ 70 | 🐛 26 | 🌐 Julia | 📅 2026-06-29 - This library is developed independently of, but is heavily influenced in design by the python-geojson package.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-10 - Interface for Reading from the Earth System Datacube.
* [STAC.jl](https://github.com/JuliaClimate/STAC.jl) ⭐ 33 | 🐛 7 | 🌐 Julia | 📅 2026-08-31 - SpatioTemporal Asset Catalog (STAC) julia client.
...
* [RasterDataSources.jl](https://github.com/EcoJulia/RasterDataSources.jl) ⭐ 25 | 🐛 21 | 🌐 Julia | 📅 2026-08-08 - Downloads raster data for local use or for integration into other spatial data packages, like GeoData.jl.
* [SpectralIndices.jl](https://github.com/awesome-spectral-indices/SpectralIndices.jl) ⭐ 22 | 🐛 12 | 🌐 Julia | 📅 2026-08-15 - Julia package for working with spectral indices commonly used in remote sensing and earth observation applications.
...
* [Spatial K](https://github.com/maplibre/spatial-k) ⭐ 140 | 🐛 47 | 🌐 Kotlin | 📅 2026-09-07 - Spatial K - A set of Kotlin Multiplatform Libraries for working with geospatial data
...
* [ChangeDetectionToolbox](https://github.com/Bobholamovic/ChangeDetectionToolbox) ⭐ 186 | 🐛 1 | 🌐 MATLAB | 📅 2021-02-24 - MATLAB Toolbox for Remote Sensing Change Detection.
* [CCDC](https://github.com/GERSL/CCDC) ⭐ 107 | 🐛 2 | 🌐 MATLAB | 📅 2024-10-30 - Algorithm developed for Continuous Change Detection and Classification (CCDC) of land cover using all available Landsat data.
...
* [address formatting](https://github.com/OpenCageData/address-formatting) ⭐ 449 | 🐛 5 | 🌐 Perl | 📅 2026-09-03 - Templates to format geographic addresses.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,837 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,244 | 🐛 420 | 🌐 Python | 📅 2026-09-07 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,862 | 🐛 54 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,023 | 🐛 53 | 🌐 Python | 📅 2026-09-10 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,773 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,361 | 🐛 8 | 🌐 Python | 📅 2026-09-07 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,571 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,910 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
* [Python Geocoder](https://github.com/DenisCarriere/geocoder) ⭐ 1,658 | 🐛 123 | 🌐 Python | 📅 2024-04-20 - Simple and consistent geocoding library written in Python.
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,411 | 🐛 36 | 🌐 Python | 📅 2026-08-28 - Implementation of Trajectory classes and functions built on top of GeoPandas.
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,223 | 🐛 50 | 🌐 Python | 📅 2026-09-09 - For conversions between projections.
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 971 | 🐛 80 | 🌐 Python | 📅 2026-09-09 - xarray-spatial implements common raster analysis functions using Numba and provides an easy-to-install, easy-to-extend codebase for raster analysis.
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 890 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
* [Mahotas](https://github.com/luispedro/mahotas) ⭐ 890 | 🐛 24 | 🌐 Python | 📅 2026-06-12 - Mahotas is a library of fast computer vision algorithms (all implemented in C++ for speed) operating over numpy arrays.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 61 | 🌐 C++ | 📅 2026-09-10 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 187 | 🌐 Python | 📅 2026-09-10 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [Open-Elevation](https://github.com/Jorl17/open-elevation) ⭐ 800 | 🐛 48 | 🌐 Python | 📅 2024-04-17 - A free and open-source alternative to Google Elevation API.
...
* [Spectral Python](https://github.com/spectralpython/spectral) ⭐ 682 | 🐛 21 | 🌐 Python | 📅 2026-09-04 - Python module for hyperspectral image processing.
* [mapboxgl-jupyter](https://github.com/mapbox/mapboxgl-jupyter) ⭐ 680 | 🐛 43 | 🌐 Python | 📅 2025-02-06 - Use Mapbox GL JS to visualize data in a Python Jupyter notebook.
* [Verde](https://github.com/fatiando/verde) ⭐ 667 | 🐛 46 | 🌐 Python | 📅 2026-08-04 - Verde is a Python library for processing spatial data (bathymetry, geophysics surveys, etc) and interpolating it on regular grids (i.e., gridding).
* [GSTools](https://github.com/GeoStat-Framework/GSTools) ⭐ 652 | 🐛 36 | 🌐 Python | 📅 2026-08-24 - A geostatistical toolbox: random fields, variogram estimation, covariance models, kriging and much more.
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 646 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
* [rioxarray](https://github.com/corteva/rioxarray) ⭐ 623 | 🐛 82 | 🌐 Python | 📅 2026-07-27 - rasterio xarray extension.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 614 | 🐛 46 | 🌐 Python | 📅 2026-09-03 - A Python Framework for Large-Scale SAR Satellite Data Processing.
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 594 | 🐛 19 | 🌐 Python | 📅 2026-09-09 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
* [dask-geopandas](https://github.com/geopandas/dask-geopandas) ⭐ 592 | 🐛 77 | 🌐 Python | 📅 2026-07-21 - Parallelized GeoPandas with Dask.
* [GeostatsPy](https://github.com/GeostatsGuy/GeostatsPy) ⭐ 580 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2025-09-30 - GSLIB reimplimented in Python
...
* [urbansim](https://github.com/UDST/urbansim) ⭐ 545 | 🐛 28 | 🌐 Python | 📅 2026-09-03 - New version of UrbanSim, a platform for modeling metropolitan real estate markets.
...
* [pymap3d](https://github.com/scivision/pymap3d) ⭐ 443 | 🐛 6 | 🌐 Python | 📅 2026-06-22 - Python 3D coordinate conversions for geospace ecef enu eci.
...
* [geospatial](https://github.com/giswqs/geospatial) ⭐ 435 | 🐛 16 | 🌐 Dockerfile | 📅 2026-09-09 - A collection of Python packages for geospatial analysis and data visualization.
* [pandana](https://github.com/UDST/pandana) ⭐ 428 | 🐛 46 | 🌐 C++ | 📅 2026-09-10 - Pandas Network Analysis - dataframes of network queries, quickly.
* [whitebox](https://github.com/giswqs/whitebox) ⭐ 422 | 🐛 1 | 🌐 Python | 📅 2026-01-31 - Python frontend for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,202 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [srai](https://github.com/kraina-ai/srai) ⭐ 390 | 🐛 104 | 🌐 Python | 📅 2026-09-07 - Spatial Representations for Artificial Intelligence. Set of tools for geospatial machine learning, data acquisition and wrangling.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 25 | 🌐 Python | 📅 2026-09-07 - Library and a CLI tool for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
* [Xee](https://github.com/google/Xee) ⭐ 371 | 🐛 32 | 🌐 Python | 📅 2026-08-19 - An Xarray extension for Google Earth Engine.
...
* [localtileserver](https://github.com/banesullivan/localtileserver) ⭐ 350 | 🐛 1 | 🌐 Python | 📅 2026-09-07 - A Python package for serving tiles from large raster files in the Slippy Maps standard (i.e., `/zoom/x/y.png`) for visualization in Jupyter with `ipyleaflet` or `folium`.
* [EOReader](https://github.com/sertit/eoreader) ⭐ 348 | 🐛 61 | 🌐 Python | 📅 2026-09-09 - EOReader is a multi-satellite reader allowing you to open optical and SAR data.
* [routing-py](https://github.com/gis-ops/routing-py) ⭐ 348 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - Python library to access all public routing, isochrones and matrix APIs in a consistent manner.
* [elevation](https://github.com/bopen/elevation) ⭐ 329 | 🐛 36 | 🌐 Python | 📅 2024-02-02 - Python script to download global terrain digital elevation models, SRTM 30m DEM and SRTM 90m DEM.
* [RichDEM](https://github.com/r-barnes/richdem) ⭐ 324 | 🐛 64 | 🌐 C++ | 📅 2024-06-24 - High-performance Terrain and Hydrology Analysis.
* [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 324 | 🐛 39 | 🌐 Python | 📅 2026-09-09 - STAC API implementation with FastAPI.
* [cdsapi](https://github.com/ecmwf/cdsapi) ⭐ 320 | 🐛 42 | 🌐 Python | 📅 2026-03-12 - Python API to access the Copernicus Climate Data Store (CDS).
* [Alpha Shape Toolbox](https://github.com/bellockk/alphashape) ⭐ 315 | 🐛 30 | 🌐 Python | 📅 2026-07-23 - Toolbox for constructing alpha shapes.
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 310 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,202 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [lidar](https://github.com/giswqs/lidar) ⭐ 301 | 🐛 9 | 🌐 Python | 📅 2026-05-25 - Terrain and hydrological analysis using digital elevation models (DEMs).
...
* [HyperCoast](https://github.com/opengeos/HyperCoast) ⭐ 288 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - A Python package for visualizing and analyzing hyperspectral data in coastal regions.
* [Detectree](https://github.com/martibosch/detectree) ⭐ 280 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - DetecTree is a Pythonic library to classify tree/non-tree pixels from aerial imagery.
* [geosnap](https://github.com/spatialucr/geosnap) ⭐ 275 | 🐛 18 | 🌐 Python | 📅 2026-03-09 - geosnap makes it easier to explore, model, analyze, and visualize the social and spatial dynamics of neighborhoods.
* [stackstac](https://github.com/gjoseph92/stackstac) ⭐ 272 | 🐛 60 | 🌐 Python | 📅 2024-08-10 - Turn a STAC catalog into a dask-based xarray.
* [autoRIFT](https://github.com/leiyangleon/autoRIFT) ⭐ 271 | 🐛 21 | 🌐 Python | 📅 2026-06-22 - Python module of a fast and intelligent algorithm for finding the pixel displacement between two images.
* [trackintel](https://github.com/mie-lab/trackintel) ⭐ 267 | 🐛 25 | 🌐 Python | 📅 2026-05-25 - A GeoPandas extension for tracking data
...
* [fastkml](https://github.com/cleder/fastkml) ⭐ 256 | 🐛 20 | 🌐 Python | 📅 2026-09-07 - Fastkml is a library to read, write and manipulate KML files. It aims to keep it simple and fast (using lxml if available).
...
* [Siphon](https://github.com/unidata/siphon) ⭐ 246 | 🐛 82 | 🌐 Python | 📅 2026-09-07 - A collection of Python utilities for retrieving atmospheric and oceanic data from remote sources, focusing on being able to retrieve data from Unidata data technologies, such as the THREDDS data server.
...
* [xyzservices](https://github.com/geopandas/xyzservices) ⭐ 229 | 🐛 13 | 🌐 Python | 📅 2026-09-04 - A unified source of XYZ tile providers in Python.
* [cubo](https://github.com/davemlz/cubo) ⭐ 211 | 🐛 2 | 🌐 Python | 📅 2026-02-12 - Easily create EO mini cubes from STAC in Python.
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 50 | 🌐 Python | 📅 2026-09-10 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
...
* [geofileops](https://github.com/geofileops/geofileops) ⭐ 179 | 🐛 34 | 🌐 Python | 📅 2026-08-29 - Python toolbox to process large vector files faster.
...
* [Tobler](https://github.com/pysal/tobler) ⭐ 169 | 🐛 23 | 🌐 Python | 📅 2026-07-30 - Tobler is a python package for areal interpolation, dasymetric mapping, and change of support.
...
* [rio-color](https://github.com/mapbox/rio-color) ⭐ 148 | 🐛 4 | 🌐 Python | 📅 2026-06-29 - Color correction plugin for rasterio.
* [Ogcserver](https://github.com/mapnik/OGCServer) ⭐ 141 | 🐛 8 | 🌐 Python | 📅 2020-04-26 - Python WMS implementation using Mapnik.
* [geeup](https://github.com/samapriya/geeup) ⭐ 140 | 🐛 0 | 🌐 Python | 📅 2025-12-31 - Simple CLI for Earth Engine Uploads.
* [LARD](https://github.com/deel-ai/LARD) ⭐ 138 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-09-03 - A runway dataset and a generator of synthetic aerial images with automatic labeling.
...
* [Intake-stac](https://github.com/intake/intake-stac) ⭐ 113 | 🐛 27 | 🌐 Python | 📅 2026-08-31 - This is an intake data source for SpatioTemporal Asset Catalogs (STAC).
* [osm2geojson](https://github.com/aspectumapp/osm2geojson) ⭐ 113 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Parse OpenStreetMap (OSM) XML and Overpass JSON/XML.
...
* [geojson-shave](https://github.com/ben-nour/geojson-shave) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - A Python command-line tool to reduce the size of GeoJSON files.
* [pygeoif](https://github.com/cleder/pygeoif) ⭐ 74 | 🐛 17 | 🌐 Python | 📅 2026-09-07 - PyGeoIf provides a GeoJSON-like protocol for geo-spatial (GIS) vector data. A simple, pure Python implementation of geometric objects and operations, useful for basic GIS tasks.
...
* [dsm2dtm](https://github.com/seedlit/dsm2dtm) ⭐ 65 | 🐛 0 | 🌐 Python | 📅 2026-05-10 - A Python library to convert Digital Surface Models (DSMs) to Digital Terrain Models (DTMs).
...
* [gpdvega](https://github.com/iliatimofeev/gpdvega) ⭐ 52 | 🐛 5 | 🌐 Python | 📅 2020-06-24 - gpdvega is a bridge between GeoPandas and Altair that allows to seamlessly chart geospatial data.
...
* [MuseoToolBox](https://github.com/nkarasiak/MuseoToolBox) ⭐ 37 | 🐛 1 | 🌐 Python | 📅 2020-08-03 - Museo ToolBox is a python library to simplify the use of raster/vector, especially for machine learning and remote sensing.
...
* [momepy](https://github.com/martinfleis/momepy) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Momepy is a library for quantitative analysis of urban form - urban morphometrics.
...
* [xeo](https://github.com/awesome-spectral-indices/xeo) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-23 - Awesome Earth Observation Instruments in Python.
...
* [rayshader](https://github.com/tylermorganwall/rayshader) ⭐ 2,175 | 🐛 48 | 🌐 R | 📅 2026-09-07 - rayshader is an open source R package for producing 2D and 3D hillshaded maps of elevation matrices using a combination of raytracing, spherical texture mapping, and ambient occlusion.
* [sf](https://github.com/r-spatial/sf) ⭐ 1,445 | 🐛 69 | 🌐 R | 📅 2026-09-10 - Simple Features for R.
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 948 | 🐛 18 | 🌐 R | 📅 2026-09-10 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 814 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 778 | 🐛 63 | 🌐 R | 📅 2026-09-07 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 710 | 🐛 16 | 🌐 R | 📅 2026-09-04 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 619 | 🐛 13 | 🌐 C++ | 📅 2026-09-08 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 612 | 🐛 26 | 🌐 R | 📅 2026-08-20 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 547 | 🐛 18 | 🌐 R | 📅 2026-08-31 - Satellite image time series package for R.
...
* [sfnetworks](https://github.com/luukvdmeer/sfnetworks) ⭐ 398 | 🐛 29 | 🌐 R | 📅 2026-05-14 - Tidy Geospatial Networks in R.
* [ggspatial](https://github.com/paleolimbot/ggspatial) ⭐ 392 | 🐛 39 | 🌐 R | 📅 2026-09-04 - A ggplot2 R extension for plotting Spatial\* objects.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
* [osmdata](https://github.com/ropensci/osmdata) ⭐ 342 | 🐛 21 | 🌐 R | 📅 2026-09-01 - R package for downloading OpenStreetMap data.
* [rnoaa](https://github.com/ropensci/rnoaa) ⭐ 341 | 🐛 28 | 🌐 R | 📅 2025-02-04 - R interface to many NOAA data sources.
* [getSpatialData](https://github.com/16EAGLE/getSpatialData) ⭐ 313 | 🐛 43 | 🌐 R | 📅 2023-07-10 - An R package making it easy to query, preview, download and preprocess multiple kinds of spatial data via R.
...
* [rnaturalearth](https://github.com/ropensci/rnaturalearth) ⭐ 267 | 🐛 5 | 🌐 R | 📅 2026-07-09 - An R package to hold and facilitate interaction with Natural Earth map data.
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 263 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [osrm R](https://github.com/rCarto/osrm) ⭐ 254 | 🐛 0 | 🌐 R | 📅 2026-09-10 - Interface Between R and the OpenStreetMap-Based Routing Service OSRM.
* [mapsf](https://github.com/riatelab/mapsf) ⭐ 247 | 🐛 2 | 🌐 R | 📅 2026-09-03 - Thematic cartography with R.
* [googleway](https://github.com/SymbolixAU/googleway) ⭐ 240 | 🐛 58 | 🌐 HTML | 📅 2024-09-24 - R Package for accessing and plotting Google Maps.
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 240 | 🐛 33 | 🌐 R | 📅 2026-09-01 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [osmextract](https://github.com/ropensci/osmextract) ⭐ 196 | 🐛 31 | 🌐 R | 📅 2026-09-03 - Download and import OpenStreetMap data from Geofabrik and other providers.
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 188 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,202 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [tidytransit](https://github.com/r-transit/tidytransit) ⭐ 172 | 🐛 4 | 🌐 R | 📅 2026-06-23 - 'sf'-compatible package to analyze transit schedules, routes, and stops.
...
* [Prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 19 | 🌐 R | 📅 2026-09-07 - The prioritizr R package uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
* [gdalcubes\_R](https://github.com/appelmar/gdalcubes_R) ⭐ 132 | 🐛 37 | 🌐 C++ | 📅 2026-05-29 - R package for gdalcubes to process collections of Earth observation image collection as on demand data cubes.
* [biomod2](https://github.com/biomodhub/biomod2) ⭐ 127 | 🐛 23 | 🌐 R | 📅 2026-09-01 - Computer platform for ensemble forecasting of species distributions, enabling the treatment of a range of methodological uncertainties in models and the examination of species-environment relationships.
* [mapboxapi](https://github.com/walkerke/mapboxapi) ⭐ 125 | 🐛 16 | 🌐 HTML | 📅 2026-01-23 - R interface to Mapbox web services.
* [spatialRF](https://github.com/BlasBenito/spatialRF) ⭐ 125 | 🐛 1 | 🌐 R | 📅 2026-07-15 - R package to fit spatial models with Random Forest.
...
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 100 | 🐛 29 | 🌐 R | 📅 2026-09-08 - Simplified Access to NCSS Soil Databases.
...
* [tidync](https://github.com/hypertidy/tidync) ⭐ 95 | 🐛 24 | 🌐 R | 📅 2026-07-31 - Systematic approaches to NetCDF data extraction, manipulation and visualization.
...
* [supercells](https://github.com/Nowosad/supercells) ⭐ 77 | 🐛 10 | 🌐 R | 📅 2026-09-07 - The goal of supercells is to utilize the concept of superpixels to a variety of spatial data.
...
* [biodivMapR](https://github.com/jbferet/biodivMapR) ⭐ 65 | 🐛 0 | 🌐 R | 📅 2026-09-08 - R package for α- and β-diversity mapping using remotely-sensed images.
...
* [gdalraster](https://github.com/USDAForestService/gdalraster) ⭐ 59 | 🐛 11 | 🌐 C++ | 📅 2026-09-01 - R Bindings to the GDAL Raster API.
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 56 | 🐛 17 | 🌐 R | 📅 2026-09-07 - R package to download data from Brazil's Population Census.
...
* [tmaptools](https://github.com/mtennekes/tmaptools) ⭐ 43 | 🐛 10 | 🌐 R | 📅 2026-09-09 - This package offers a set of handy tool functions for reading and processing spatial data.
...
* [ROSM](https://github.com/paleolimbot/rosm) ⭐ 29 | 🐛 6 | 🌐 R | 📅 2026-09-02 - Plot Open Street Map and Other Tiles in R.
...
* [rasterDT](https://github.com/JoshOBrien/rasterDT) ⭐ 27 | 🐛 0 | 🌐 R | 📅 2026-08-29 - rasterDT uses the fast indexing, aggregation, and assignment operations provided by data.table to power speedy alternatives to several raster package functions.
...
* [elsa](https://github.com/babaknaimi/elsa) ⭐ 16 | 🐛 1 | 🌐 R | 📅 2025-10-02 - ELSA (entropy-based local indicator of spatial association) is a novel spatial statistic to measure local spatial autocorrelation in both categorical and continuous spatial data.
...
* [Geokit](https://github.com/geokit/geokit) ⭐ 1,627 | 🐛 21 | 🌐 Ruby | 📅 2024-07-29 - A Ruby gem & Rails plugin for easier map-based applications.
* [Rgeo](https://github.com/rgeo/rgeo) ⭐ 1,059 | 🐛 37 | 🌐 Ruby | 📅 2026-04-28 - RGeo is a geospatial data library for Ruby. It provides an implementation of the Open Geospatial Consortium's Simple Features Specification
...
* [Agroclimatology](https://github.com/beaorn/agroclimatology) ⭐ 20 | 🐛 1 | 🌐 Ruby | 📅 2017-08-30 - Ruby client for interacting with the NASA (POWER) Agroclimatology Web Resource.
* [Evapotranspiration](https://github.com/beaorn/evapotranspiration) ⭐ 15 | 🐛 0 | 🌐 Ruby | 📅 2017-08-30 - Ruby library for calculating reference crop evapotranspiration (ETo).
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,801 | 🐛 124 | 🌐 Rust | 📅 2026-09-09 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,170 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,908 | 🐛 50 | 🌐 Rust | 📅 2026-09-10 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,930 | 🐛 135 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,753 | 🐛 137 | 🌐 Rust | 📅 2026-09-10 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,573 | 🐛 70 | 🌐 Rust | 📅 2026-09-04 - About Native Maps for Web, Mobile and Desktop.
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,202 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 914 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 821 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 641 | 🐛 43 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 639 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23 - 3D Gaussian Splatting renderer for WebAssembly with lock-free multithreading.
...
* [rstar](https://github.com/georust/rstar) ⭐ 557 | 🐛 50 | 🌐 Rust | 📅 2026-09-07 - R\*-tree library for the rust ecosystem.
* [h3o](https://github.com/HydroniumLabs/h3o) ⭐ 543 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 - Rust implementation of the H3 geospatial indexing system.
* [sguaba](https://github.com/helsing-ai/sguaba) ⭐ 512 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - Types for points and vectors in coordinate spaces and transformations based on rigid body transforms.
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 501 | 🐛 117 | 🌐 Rust | 📅 2026-09-10 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 471 | 🐛 45 | 🌐 Rust | 📅 2026-09-04 - Zero-Copy reading and writing of geospatial data.
* [gdal](https://github.com/georust/rust-gdal) ⭐ 448 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 425 | 🐛 85 | 🌐 Rust | 📅 2026-09-01 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
* [Ferrostar](https://github.com/stadiamaps/ferrostar) ⭐ 419 | 🐛 151 | 🌐 Kotlin | 📅 2026-09-08 - A FOSS navigation SDK built from the ground up for the future.
* [Airmail](https://github.com/ellenhp/airmail) ⭐ 382 | 🐛 17 | 🌐 Rust | 📅 2025-08-08 - Lightweight geocoder in pure Rust.
* [geojson](https://github.com/georust/rust-geojson) ⭐ 346 | 🐛 22 | 🌐 Rust | 📅 2026-04-29 - Library for serializing the GeoJSON vector GIS file format.
...
* [spade](https://github.com/Stoeoef/spade) ⭐ 337 | 🐛 16 | 🌐 Rust | 📅 2026-03-24 - Delaunay Triangulations for the Rust ecosystem.
* [rgis](https://github.com/frewsxcv/rgis) ⭐ 333 | 🐛 32 | 🌐 Rust | 📅 2026-06-13 - Performant, cross-platform (web, desktop) GIS app written in Rust
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 271 | 🐛 24 | 🌐 Rust | 📅 2026-09-10 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
* [Hecate](https://github.com/mapbox/Hecate) ⚠️ Archived - Fast Geospatial Feature Storage API.
* [delaunator-rs](https://github.com/mourner/delaunator-rs) ⭐ 253 | 🐛 5 | 🌐 Rust | 📅 2026-05-12 - A very fast static 2D Delaunay triangulation library for Rust.
* [Cavalier Contours](https://github.com/jbuckmccready/cavalier_contours) ⭐ 234 | 🐛 8 | 🌐 Rust | 📅 2026-08-30 - 2D polyline/shape library for offsetting, combining, etc.
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 208 | 🐛 3 | 🌐 Rust | 📅 2026-09-06 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
* [geo-index](https://github.com/kylebarron/geo-index) ⭐ 198 | 🐛 31 | 🌐 Rust | 📅 2026-09-09 - Fast, immutable, ABI-stable spatial indexes.
* [Polars ST](https://github.com/Oreilles/polars-st) ⭐ 194 | 🐛 9 | 🌐 Python | 📅 2026-08-06 - Spatial extension for Polars DataFrames.
* [proj](https://github.com/georust/rust-proj) ⭐ 185 | 🐛 40 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 180 | 🐛 13 | 🌐 Rust | 📅 2026-09-07 - Computational Geometry library written in Rust.
...
* [iTriangle](https://github.com/iShape-Rust/iTriangle) ⭐ 160 | 🐛 3 | 🌐 Rust | 📅 2026-08-24 - A fast, stable, and robust 2d triangulation library.
* [osm-renderer](https://github.com/dfyz/osm-renderer) ⭐ 160 | 🐛 0 | 🌐 Rust | 📅 2025-02-10 - OpenStreetMap raster tile renderer.
* [Solari](https://github.com/ellenhp/solari) ⭐ 149 | 🐛 0 | 🌐 Rust | 📅 2025-06-24 - Multimodal routing in Rust.
* [geos](https://github.com/georust/geos) ⭐ 147 | 🐛 16 | 🌐 Rust | 📅 2026-03-03 - Rust bindings for GEOS C API.
* [stac-rs](https://github.com/gadomski/stac-rs) ⭐ 144 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - Rust implementation of the SpatioTemporal Asset Catalog (STAC) specification.
...
* [RINEX](https://github.com/georust/rinex) ⭐ 126 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - RINEX analysis & and processing.
...
* [PMTiles (for Rust)](https://github.com/stadiamaps/pmtiles-rs) ⭐ 110 | 🐛 11 | 🌐 Rust | 📅 2026-09-10 - Rust implementation of PMTiles
* [tzf-rs](https://github.com/ringsaturn/tzf-rs) ⭐ 108 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Get timezone via longitude\&latitude in Rust in a fast way
* [Robust](https://github.com/georust/robust) ⭐ 107 | 🐛 8 | 🌐 Rust | 📅 2025-05-10 - Robust primitives for computational geometry.
* [las-rs](https://github.com/gadomski/las-rs) ⭐ 105 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - Read and write ASPRS las files.
* [netcdf](https://github.com/georust/netcdf) ⭐ 105 | 🐛 5 | 🌐 Rust | 📅 2026-09-05 - Medium-level netCDF bindings for Rust, allowing easy reading and writing of array-like structures to a file.
...
* [Karttapullautin](https://github.com/karttapullautin/karttapullautin) ⭐ 88 | 🐛 11 | 🌐 Rust | 📅 2026-09-08 - A fast and accurate map generator from classified LiDAR data.
...
* [Proj4rs](https://github.com/3liz/proj4rs) ⭐ 79 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - Rust adaptation of Proj4
* [gtfs-structures](https://github.com/rust-transit/gtfs-structure) ⭐ 78 | 🐛 22 | 🌐 Rust | 📅 2026-09-10 - Read GTFS files into structs, with smart references.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 74 | 🐛 13 | 🌐 Rust | 📅 2026-09-10 - Manage, convert and enrich transit data.
* [Bevy Point Cloud](https://github.com/rlamarche/bevy_pointcloud) ⭐ 67 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 - A Bevy plugin to render point clouds.
* [Polylabel-rs](https://github.com/urschrei/polylabel-rs) ⭐ 63 | 🐛 2 | 🌐 Rust | 📅 2026-08-21 - A Rust implementation of the Polylabel algorithm, with FFI.
* [earcut-rs](https://github.com/ciscorn/earcut-rs) ⭐ 58 | 🐛 3 | 🌐 Rust | 📅 2026-07-26 - Port of the Earcut polygon triangulation library with performance in mind.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 69 | 🌐 Jupyter Notebook | 📅 2026-09-10 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [OGC API](https://github.com/georust/ogcapi) ⭐ 42 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - OGC API building blocks.
...
* [osm-lump-ways](https://github.com/amandasaurus/osm-lump-ways) ⭐ 40 | 🐛 0 | 🌐 Rust | 📅 2026-08-25 - Group OSM ways based on topology & shared tags
...
* [osm-pbf-parquet](https://github.com/OvertureMaps/osm-pbf-parquet) ⭐ 31 | 🐛 3 | 🌐 Rust | 📅 2026-09-09 - Transcode OSM PBF file to parquet files.
...
* [RouteE Compass](https://github.com/NREL/routee-compass) ⭐ 29 | 🐛 88 | 🌐 Rust | 📅 2026-09-09 - An energy-aware vehicle routing engine.
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 3 | 🌐 Rust | 📅 2026-09-10 - utils & tiles w/ (rs & pyo3).
...
* [cql2-rs](https://github.com/developmentseed/cql2-rs) ⭐ 23 | 🐛 12 | 🌐 Rust | 📅 2026-09-07 - Library for parsing the OGC CQL2 filter language.
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-09-06 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
* [maplibre-legend](https://github.com/mvt-proj/maplibre-legend) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-08-15 - Maplibre legend generator crate.
...
* [auto-sea-way](https://github.com/auto-sea-way/asw) ⭐ 13 | 🐛 7 | 🌐 Rust | 📅 2026-08-03 - Open source maritime auto-routing engine that builds a global water-surface routing graph from OSM land polygons using an adaptive H3 hexagonal grid cascade.
...
* [cheap-ruler-rs](https://github.com/vipera/cheap-ruler-rs) ⭐ 10 | 🐛 1 | 🌐 Rust | 📅 2025-02-06 - Collection of very fast approximations to common geodesic measurements.
* [Quadbin](https://github.com/atsyplenkov/qbin) ⭐ 10 | 🐛 2 | 🌐 Rust | 📅 2026-03-03 - Hierarchical geospatial index tiling, similar to Quadkey.
* [pgstac-rs](https://github.com/gadomski/pgstac-rs) ⚠️ Archived - Rust interface for [pgstac](https://github.com/stac-utils/pgstac) ⭐ 223 | 🐛 74 | 🌐 PLpgSQL | 📅 2026-08-31.
...
* [pbfhogg](https://github.com/folknor/pbfhogg) ⭐ 3 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - Fast library and CLI to read, write, and transform OSM PBF files; parallel and pipelined decoding, planet-scale on modest hardware.
...
* [Routers](https://github.com/routers-org/routers) ⭐ 2 | 🐛 16 | 🌐 Rust | 📅 2026-09-07 - Set of routing tools designed for system-agnostic maps.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 249 | 🌐 Scala | 📅 2026-09-10 - GeoTrellis is a Scala library and framework that uses Spark to work with raster data.
* [RTree2D](https://github.com/plokhotnyuk/rtree2d) ⭐ 145 | 🐛 13 | 🌐 Scala | 📅 2026-09-09 - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 215 | 🌐 Swift | 📅 2026-09-10 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
* [turf-swift](https://github.com/mapbox/turf-swift) ⭐ 271 | 🐛 29 | 🌐 Swift | 📅 2026-06-29 - A Swift language port of Turf.js.
* [MapboxDirections.swift](https://github.com/mapbox/MapboxDirections.swift) ⭐ 206 | 🐛 32 | 🌐 Swift | 📅 2026-09-08 - Traffic-aware directions in Swift or Objective-C on iOS, macOS, tvOS, and watchOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,374 | 🐛 3,510 | 🌐 C++ | 📅 2026-09-10 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,602 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,015 | 🐛 48 | 🌐 Dart | 📅 2026-09-04 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,195 | 🐛 602 | 🌐 C++ | 📅 2026-09-10 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-10 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 569 | 🐛 37 | 🌐 Kotlin | 📅 2026-09-10 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,496 | 🐛 200 | 🌐 Scala | 📅 2026-09-09 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 249 | 🌐 Scala | 📅 2026-09-10 - GeoTrellis is a geographic data processing engine for high performance applications.
* [GeoWave](https://github.com/locationtech/geowave) ⭐ 528 | 🐛 91 | 🌐 Java | 📅 2025-09-29 - GeoWave provides geospatial and temporal indexing on top of Accumulo and HBase.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,369 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,399 | 🐛 70 | 🌐 Python | 📅 2026-09-10 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,172 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,116 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,344 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [circlize](https://github.com/jokergoo/circlize) ⭐ 1,020 | 🐛 67 | 🌐 R | 📅 2023-11-11 - Circular visualization in R. Circular layout is an efficient way for the visualization of huge amounts of information.
* [lonboard](https://github.com/developmentseed/lonboard) ⭐ 963 | 🐛 124 | 🌐 Python | 📅 2026-09-07 - Fast, interactive geospatial data visualization in Jupyter.
* [Kosmtik](https://github.com/kosmtik/kosmtik) ⭐ 749 | 🐛 112 | 🌐 JavaScript | 📅 2025-03-13 - Very lite but extendable mapping framework to create Mapnik ready maps with OpenStreetMap data (and more).
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 118 | 🌐 Python | 📅 2026-09-09 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [GeoJs](https://github.com/OpenGeoscience/geojs) ⭐ 471 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-10 - High-performance visualization and interactive data exploration of scientific and geospatial location aware datasets.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
...
* [deck.gl-raster](https://github.com/developmentseed/deck.gl-raster) ⭐ 228 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-04 - Client-side, GPU-accelerated Cloud-Optimized GeoTIFF visualization in deck.gl.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,354 | 🐛 61 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
* [Mapus](https://github.com/alyssaxuu/mapus) ⭐ 3,535 | 🐛 9 | 🌐 JavaScript | 📅 2022-07-02 - Mapus is a tool to explore and annotate collaboratively on a map.
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,170 | 🐛 111 | 🌐 Java | 📅 2026-09-10 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
* [Osm2pgsql](https://github.com/openstreetmap/osm2pgsql) ⭐ 1,684 | 🐛 36 | 🌐 C++ | 📅 2026-09-10 - osm2pgsql is a tool for loading OpenStreetMap data into a PostgreSQL.
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 977 | 🐛 223 | 🌐 C | 📅 2026-09-10 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 432 | 🐛 179 | 🌐 Python | 📅 2026-09-10 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
* [veins](https://github.com/sommer/veins) ⭐ 327 | 🐛 8 | 🌐 C++ | 📅 2026-06-16 - Open source vehicular network simulation framework.
* [exactextract](https://github.com/isciences/exactextract) ⭐ 322 | 🐛 29 | 🌐 C++ | 📅 2026-02-24 - Provides a fast and accurate algorithm for summarizing values in the portion of a raster dataset that is covered by a polygon, often referred to as zonal statistics.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 282 | 🐛 22 | 🌐 C++ | 📅 2026-09-07 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 282 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Magrit](https://github.com/riatelab/magrit) ⭐ 161 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-17 - Magrit is an online application for thematic mapping.
* [imscript](https://github.com/mnhrdt/imscript) ⭐ 122 | 🐛 1 | 🌐 C | 📅 2026-09-02 - A collection of small and standalone utilities for image processing.
* [DataPillager](https://github.com/gdherbert/DataPillager) ⭐ 77 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Download data from Esri service.
* [DsgTools](https://github.com/dsgoficial/DsgTools) ⭐ 64 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - DSGTools is a QGIS plugin that allow users to create and manipulate Geospatial Data according to Brazilian Law (ET-EDGV 2.1.3 and ET-EDGV 3.0)
...
* [GDAL](https://github.com/dwtkns/gdal-cheat-sheet) ⭐ 1,223 | 🐛 5 | 📅 2024-06-13 - Cheat sheet for GDAL/OGR command-line tools.
...
* [RoadDetections](https://github.com/microsoft/RoadDetections) ⭐ 638 | 🐛 9 | 🌐 C# | 📅 2026-05-05 - Road detections from Microsoft Maps aerial imagery.
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 317 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics.
* [AIforEarthDataSets](https://github.com/microsoft/AIforEarthDataSets) ⭐ 316 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2024-12-17 - Notebooks and documentation for AI-for-Earth-managed datasets on Azure Open Datasets.
* [Callisto Generated Datasets](https://github.com/Agri-Hub/Callisto-Dataset-Collection) ⭐ 188 | 🐛 1 | 📅 2023-11-21 - A list of datasets aiming to enable Artificial Intelligence applications that use Copernicus data.
...
* [ZipCheckup](https://github.com/artakulov/us-water-quality-data) ⭐ 4 | 🐛 0 | 📅 2026-09-01 - Free ZIP-level environmental safety data platform covering water quality, air quality, PFAS, radon, lead, flood risk and 11 more verticals across 42K US ZIP codes. Public API, CC BY 4.0.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,087 | 🐛 49 | 🌐 Python | 📅 2026-09-07 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
* [Geopython](https://github.com/urschrei/Geopython) ⭐ 382 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-31 - Notebooks and libraries for spatial/geo Python explorations.
* [Cloud Optimized Point Cloud Specification](https://github.com/copcio/copcio.github.io) ⭐ 140 | 🐛 3 | 🌐 Shell | 📅 2026-08-18 - Geospatial, compressed, range-readable, LAZ-compatible point cloud format.
...
* [Canadian Rental Address Research](https://github.com/Fink692/canadian-rental-data-sources) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Source-dated directory of official Canadian property, permit, tenancy, hazard, transit, and neighbourhood resources for pre-lease research.
...
* [font-GIS](https://github.com/Viglino/font-gis) ⭐ 325 | 🐛 2 | 🌐 CSS | 📅 2025-07-16 - A very very cool icon font set for use with GIS and spatial analysis tools.
...
* [Textures.js](https://github.com/riccardoscalco/textures) ⭐ 6,091 | 🐛 21 | 🌐 JavaScript | 📅 2023-01-01 - JavaScript library for creating SVG patterns, designed for data visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 319,786 | 🐛 20 | 🌐 Python | 📅 2026-09-01
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,250 | 🐛 0 | 📅 2026-09-04
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,503 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,516 | 🐛 67 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,626 | 🐛 3 | 📅 2026-08-10
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,538 | 🐛 0 | 📅 2026-09-01
* [Awesome-EarthObservation-Code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,382 | 🐛 9 | 🌐 HTML | 📅 2026-05-13
* [Awesome SAR](https://github.com/RadarCODE/awesome-sar) ⭐ 1,202 | 🐛 8 | 📅 2025-07-22
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,174 | 🐛 23 | 🌐 Python | 📅 2026-09-10
* [Awesome Frontend GIS](https://github.com/joewdavies/awesome-frontend-gis) ⭐ 857 | 🐛 8 | 📅 2026-08-18 - Geographic Information Systems (GIS) for web browsers. For managing, analyzing, editing, and visualizing geographic data.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 583 | 🐛 4 | 📅 2025-02-20
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 537 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-09-04
* [Awesome DEM](https://github.com/DahnJ/Awesome-DEM) ⭐ 455 | 🐛 6 | 📅 2024-05-25 - Overview of Digital Elevation Model (DEM) datasets.
* [Awesome Geo Rust](https://github.com/pka/awesome-georust) ⭐ 415 | 🐛 2 | 📅 2026-03-01
* [Awesome SQLite](https://github.com/planetopendata/awesome-sqlite) ⭐ 404 | 🐛 9 | 📅 2026-08-22
...
* [Awesome Spatial](https://github.com/RoboDonut/awesome-spatial/blob/master/README.md) ⭐ 222 | 🐛 101 | 📅 2018-01-04
...
* [Awesome Earth Observation Instruments](https://github.com/awesome-spectral-indices/awesome-earth-observation-instruments) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - A machine-readable catalogue of Earth observation instruments with spectral, spatial, temporal, and operational characteristics.
