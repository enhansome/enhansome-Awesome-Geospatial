...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,730 | 🐛 163 | 🌐 Go | 📅 2026-09-02 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 356 | 🌐 Java | 📅 2026-09-11 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 626 | 🐛 10 | 🌐 C | 📅 2026-09-11 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [Atlas4D](https://github.com/crisbez/atlas4d-base) ⭐ 17 | 🐛 9 | 🌐 HTML | 📅 2026-05-15 - Open-source 4D spatiotemporal platform with PostGIS, TimescaleDB, pgvector, and H3 hexagonal indexing.
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,285 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-11 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,309 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-09 - An SVG mapping component library for React, built on top of d3-geo.
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,166 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,068 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data into vector tiles on the fly.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,364 | 🐛 890 | 🌐 TypeScript | 📅 2026-09-11 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,181 | 🐛 24 | 🌐 Python | 📅 2026-09-11 - A dynamic Web Map tile server.
...
* [ArcGIS REST JS](https://github.com/Esri/arcgis-rest-js) ⭐ 391 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-05 - Compact, modular JavaScript wrappers for the ArcGIS REST API that run in Node.js and modern browsers.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 101 | 🌐 TypeScript | 📅 2026-09-11 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 191 | 🐛 1 | 🌐 Python | 📅 2026-09-11 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,605 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [Treetop](https://github.com/carlos-alberto-silva/weblidar-treetop) ⭐ 127 | 🐛 6 | 🌐 R | 📅 2025-05-14 - A Shiny-based Application for Extracting Forest Information from LiDAR data.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,128 | 🐛 456 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,835 | 🐛 103 | 🌐 Python | 📅 2026-09-08 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 264 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,947 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,176 | 🐛 219 | 🌐 Python | 📅 2026-09-09 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,143 | 🐛 6 | 🌐 Python | 📅 2026-09-07 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [SamGIS](https://github.com/trincadev/samgis-be) ⚠️ Archived – Image Segmentation machine learning based (Segment Anything by Meta - Facebook) applied to GIS and geo data also with GPU requirements. A Segment Anything HuggingFace demo [here](https://huggingface.co/spaces/aletrn/samgis) and an HuggingFace [demo](https://huggingface.co/spaces/aletrn/samgis-lisa-on-cuda) with natural language-based image segmentation capabilities via [LISA](https://github.com/dvlab-research/LISA) ⭐ 2,677 | 🐛 115 | 🌐 Python | 📅 2025-02-16.

## MCP Servers

* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
* [OSM Edit MCP](https://github.com/skywinder/osm-edit-mcp) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Python MCP server for inspecting OpenStreetMap data and previewing version-checked road-edit proposals from selected local GPX survey segments. Applying changes requires explicit user confirmation of the proposal digest. Alpha.
...
* [geoai-skills](https://github.com/muend/geoai-skills) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Vendor-neutral Agent Skills (SKILL.md) that make an AI coding agent check coordinate reference systems, spatial validation, comparability and uncertainty before a result becomes a claim. Works with Claude Code, Codex, Cursor and GitHub Copilot; ships a paired evaluation against a skills-disabled control arm, including the quality gate it fails.

## C

* [libvips](https://github.com/libvips/libvips) ⭐ 11,633 | 🐛 82 | 🌐 C | 📅 2026-09-11 - A fast image processing library with low memory needs.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,602 | 🐛 783 | 🌐 C++ | 📅 2026-09-11 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,464 | 🐛 112 | 🌐 Python | 📅 2026-09-10 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,192 | 🐛 942 | 🌐 C++ | 📅 2026-09-11 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,723 | 🐛 79 | 🌐 C++ | 📅 2026-09-08 - Computational geometry and spatial indexing on the sphere.
...
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,800 | 🐛 61 | 🌐 C | 📅 2026-09-11 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 64 | 🌐 C++ | 📅 2026-09-11 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,716 | 🐛 56 | 🌐 C# | 📅 2026-09-01 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [DEM Net Elevation API](https://github.com/dem-net/DEM.Net) ⭐ 355 | 🐛 18 | 🌐 C# | 📅 2026-04-18 - 3D terrain generation library, provides access to global DEM datasets (OpenTopography, Nasa ASTER) and tiled imagery services. GlTF and STL export formats supported. [Live demo](https://elevationapi.com)
...
* [MaxRev.Gdal.Core](https://github.com/MaxRev-Dev/gdal.netcore) ⭐ 211 | 🐛 4 | 🌐 C# | 📅 2026-08-31 - Bindings for GDAL and OGR (both win-x64 and linux-x64).
...
* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 114 | 🐛 35 | 🌐 Fortran | 📅 2026-09-11 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,504 | 🐛 182 | 🌐 Go | 📅 2026-09-09 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,687 | 🐛 242 | 🌐 Java | 📅 2026-09-11 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,045 | 🐛 46 | 🌐 Java | 📅 2026-09-07 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,715 | 🐛 1,662 | 🌐 JavaScript | 📅 2026-09-11 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,579 | 🐛 527 | 🌐 TypeScript | 📅 2026-09-11 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,497 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-03 - React friendly API wrapper around MapboxGL JS.
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,775 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,366 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
* [proj4js](https://github.com/proj4js/proj4js) ⭐ 2,240 | 🐛 102 | 🌐 JavaScript | 📅 2026-09-11 - JavaScript library to transform coordinates from one coordinate system to another, including datum transformations.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,239 | 🐛 257 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,084 | 🐛 246 | 🌐 JavaScript | 📅 2026-09-07 - Draw tools for mapbox-gl-js.
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,048 | 🐛 94 | 🌐 JavaScript | 📅 2026-05-26 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-11 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 11 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-07 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
* [searoute-ts](https://github.com/mayurrawte/searoute-ts) ⭐ 9 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-10 - Shortest maritime route between ports (UN/LOCODE) or coordinates on the Eurostat marnet, with canal/strait restrictions, vessel draft, ECA zones and CO₂e estimates. TypeScript, GeoJSON output.
...
* [railroute-ts](https://github.com/mayurrawte/railroutes) ⭐ 0 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-03 - Shortest rail route and distance between two points or station codes over OpenStreetMap / FRA rail networks (Europe, India, North America, China, CIS), with gauge, electrification and train-ferry awareness. TypeScript, runs in browser or Node, GeoJSON output.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 221 | 🐛 27 | 🌐 Julia | 📅 2026-09-11 - Generic Mapping Tools Library Wrapper for Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-11 - Interface for Reading from the Earth System Datacube.
...
* [SpectralIndices.jl](https://github.com/awesome-spectral-indices/SpectralIndices.jl) ⭐ 23 | 🐛 12 | 🌐 Julia | 📅 2026-08-15 - Julia package for working with spectral indices commonly used in remote sensing and earth observation applications.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,840 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,245 | 🐛 420 | 🌐 Python | 📅 2026-09-07 - Python tools for geographic data.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,362 | 🐛 8 | 🌐 Python | 📅 2026-09-07 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,572 | 🐛 156 | 🌐 Python | 📅 2026-09-05 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
...
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 892 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 64 | 🌐 C++ | 📅 2026-09-11 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 187 | 🌐 Python | 📅 2026-09-11 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [Verde](https://github.com/fatiando/verde) ⭐ 667 | 🐛 47 | 🌐 Python | 📅 2026-08-04 - Verde is a Python library for processing spatial data (bathymetry, geophysics surveys, etc) and interpolating it on regular grids (i.e., gridding).
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 648 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [Open Topo Data](https://github.com/ajnisbet/opentopodata) ⭐ 417 | 🐛 2 | 🌐 Python | 📅 2026-02-16 - Open Topo Data is a REST API server for your elevation data.
...
* [lidar](https://github.com/giswqs/lidar) ⭐ 302 | 🐛 9 | 🌐 Python | 📅 2026-05-25 - Terrain and hydrological analysis using digital elevation models (DEMs).
...
* [geosnap](https://github.com/spatialucr/geosnap) ⭐ 276 | 🐛 18 | 🌐 Python | 📅 2026-03-09 - geosnap makes it easier to explore, model, analyze, and visualize the social and spatial dynamics of neighborhoods.
...
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 49 | 🌐 Python | 📅 2026-09-11 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
...
* [gpdvega](https://github.com/iliatimofeev/gpdvega) ⭐ 53 | 🐛 5 | 🌐 Python | 📅 2020-06-24 - gpdvega is a bridge between GeoPandas and Altair that allows to seamlessly chart geospatial data.
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,445 | 🐛 65 | 🌐 R | 📅 2026-09-11 - Simple Features for R.
...
* [stars](https://github.com/r-spatial/stars) ⭐ 612 | 🐛 26 | 🌐 R | 📅 2026-09-11 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 547 | 🐛 19 | 🌐 R | 📅 2026-09-11 - Satellite image time series package for R.
...
* [osmextract](https://github.com/ropensci/osmextract) ⭐ 196 | 🐛 33 | 🌐 R | 📅 2026-09-11 - Download and import OpenStreetMap data from Geofabrik and other providers.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,819 | 🐛 124 | 🌐 Rust | 📅 2026-09-09 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,171 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,909 | 🐛 49 | 🌐 Rust | 📅 2026-09-11 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,930 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,753 | 🐛 136 | 🌐 Rust | 📅 2026-09-11 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,573 | 🐛 70 | 🌐 Rust | 📅 2026-09-11 - About Native Maps for Web, Mobile and Desktop.
...
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 915 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 821 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 642 | 🐛 43 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
...
* [rstar](https://github.com/georust/rstar) ⭐ 557 | 🐛 48 | 🌐 Rust | 📅 2026-09-11 - R\*-tree library for the rust ecosystem.
* [h3o](https://github.com/HydroniumLabs/h3o) ⭐ 543 | 🐛 1 | 🌐 Rust | 📅 2026-08-29 - Rust implementation of the H3 geospatial indexing system.
* [sguaba](https://github.com/helsing-ai/sguaba) ⭐ 512 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - Types for points and vectors in coordinate spaces and transformations based on rigid body transforms.
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 502 | 🐛 139 | 🌐 Rust | 📅 2026-09-11 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 472 | 🐛 45 | 🌐 Rust | 📅 2026-09-04 - Zero-Copy reading and writing of geospatial data.
* [gdal](https://github.com/georust/rust-gdal) ⭐ 449 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 425 | 🐛 84 | 🌐 Rust | 📅 2026-09-11 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
...
* [rgis](https://github.com/frewsxcv/rgis) ⭐ 334 | 🐛 32 | 🌐 Rust | 📅 2026-06-13 - Performant, cross-platform (web, desktop) GIS app written in Rust
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 271 | 🐛 24 | 🌐 Rust | 📅 2026-09-11 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [iOverlay](https://github.com/iShape-Rust/iOverlay) ⭐ 209 | 🐛 3 | 🌐 Rust | 📅 2026-09-06 - Boolean Operations for 2D Polygons: Supports intersection, union, difference, xor, and self-intersections for all polygon varieties.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 66 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 47 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [osm-lump-ways](https://github.com/amandasaurus/osm-lump-ways) ⭐ 40 | 🐛 0 | 🌐 Rust | 📅 2026-09-11 - Group OSM ways based on topology & shared tags
...
* [osm-pbf-parquet](https://github.com/OvertureMaps/osm-pbf-parquet) ⭐ 31 | 🐛 4 | 🌐 Rust | 📅 2026-09-11 - Transcode OSM PBF file to parquet files.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 3 | 🌐 Rust | 📅 2026-09-11 - utils & tiles w/ (rs & pyo3).
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-11 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [RTree2D](https://github.com/plokhotnyuk/rtree2d) ⭐ 145 | 🐛 13 | 🌐 Scala | 📅 2026-09-11 - RTree2D is a 2D immutable R-tree with STR (Sort-Tile-Recursive) packing for ultra-fast nearest and intersection queries.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 216 | 🌐 Swift | 📅 2026-09-11 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,387 | 🐛 3,514 | 🌐 C++ | 📅 2026-09-11 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,601 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,198 | 🐛 607 | 🌐 C++ | 📅 2026-09-11 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-11 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 572 | 🐛 40 | 🌐 Kotlin | 📅 2026-09-11 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,496 | 🐛 202 | 🌐 Scala | 📅 2026-09-09 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,371 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,399 | 🐛 70 | 🌐 Python | 📅 2026-09-11 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,174 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,116 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,344 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [lonboard](https://github.com/developmentseed/lonboard) ⭐ 964 | 🐛 124 | 🌐 Python | 📅 2026-09-07 - Fast, interactive geospatial data visualization in Jupyter.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 118 | 🌐 Python | 📅 2026-09-11 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,356 | 🐛 61 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,174 | 🐛 111 | 🌐 Java | 📅 2026-09-11 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 977 | 🐛 223 | 🌐 C | 📅 2026-09-11 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 432 | 🐛 178 | 🌐 Python | 📅 2026-09-11 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 282 | 🐛 2 | 🌐 Python | 📅 2026-09-11 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 318 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 320,057 | 🐛 22 | 🌐 Python | 📅 2026-09-01
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,252 | 🐛 0 | 📅 2026-09-04
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,503 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,519 | 🐛 68 | 📅 2026-07-21
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,176 | 🐛 23 | 🌐 Python | 📅 2026-09-10
