...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 623 | 🐛 9 | 🌐 C | 📅 2026-08-22 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,145 | 🐛 132 | 🌐 HTML | 📅 2026-05-16 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 65 | 🌐 TypeScript | 📅 2026-08-22 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 201 | 🐛 13 | 🌐 Python | 📅 2026-08-22 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [H3](https://github.com/uber/h3) ⭐ 6,483 | 🐛 165 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,925 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,154 | 🐛 199 | 🌐 Python | 📅 2026-08-22 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
...
* [libvips](https://github.com/libvips/libvips) ⭐ 11,586 | 🐛 83 | 🌐 C | 📅 2026-08-21 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,483 | 🐛 165 | 🌐 C | 📅 2026-08-20 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,586 | 🐛 769 | 🌐 C++ | 📅 2026-08-22 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
...
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,102 | 🐛 933 | 🌐 C++ | 📅 2026-08-22 - Open Source Routing Engine for OpenStreetMap.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,712 | 🐛 82 | 🌐 C# | 📅 2026-08-19 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,639 | 🐛 244 | 🌐 Java | 📅 2026-08-21 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,592 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-21 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,506 | 🐛 478 | 🌐 TypeScript | 📅 2026-08-22 - WebGL2 powered geospatial visualization layers.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,087 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-20 - A cross provider JavaScript library for drawing on maps
...
* [DataFrames.jl](https://github.com/JuliaStats/DataFrames.jl) ⭐ 1,830 | 🐛 160 | 🌐 Julia | 📅 2026-08-22 - Tools for working with tabular data in Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-22 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,825 | 🐛 1 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,228 | 🐛 431 | 🌐 Python | 📅 2026-08-12 - Python tools for geographic data.
* [geopy](https://github.com/geopy/geopy) ⭐ 4,851 | 🐛 53 | 🌐 Python | 📅 2026-07-12 - geopy is a Python 2 and 3 client for several popular geocoding web services.
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,017 | 🐛 53 | 🌐 Python | 📅 2026-08-22 - A Python package for interactive mapping with Google Earth Engine, ipyleaflet, and ipywidgets.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,761 | 🐛 3 | 🌐 Python | 📅 2026-08-17 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,316 | 🐛 6 | 🌐 Python | 📅 2026-08-17 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,792 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,407 | 🐛 37 | 🌐 Python | 📅 2026-08-09 - Implementation of Trajectory classes and functions built on top of GeoPandas.
...
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 180 | 🌐 Python | 📅 2026-08-22 - Pythonic interface for the Generic Mapping Tools (GMT).
* [networkit](https://github.com/networkit/networkit) ⭐ 871 | 🐛 42 | 🌐 C++ | 📅 2026-08-17 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 776 | 🐛 63 | 🌐 R | 📅 2026-08-17 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 704 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 617 | 🐛 13 | 🌐 C++ | 📅 2026-08-22 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
...
* [osmextract](https://github.com/ropensci/osmextract) ⭐ 194 | 🐛 28 | 🌐 R | 📅 2026-08-11 - Download and import OpenStreetMap data from Geofabrik and other providers.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,568 | 🐛 135 | 🌐 Rust | 📅 2026-08-18 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,843 | 🐛 76 | 🌐 Rust | 📅 2026-08-22 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,915 | 🐛 120 | 🌐 Rust | 📅 2026-08-22 - Geospatial primitives and algorithms for Rust.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 495 | 🐛 132 | 🌐 Rust | 📅 2026-08-22 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [MVT Server](https://github.com/mvt-proj/mvt-rs) ⭐ 46 | 🐛 0 | 🌐 Rust | 📅 2026-08-21 - Simple and high-speed vector tile server with a built-in web-based admin interface.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 4 | 🌐 Rust | 📅 2026-08-22 - utils & tiles w/ (rs & pyo3).
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-08-22 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,177 | 🐛 3,463 | 🌐 C++ | 📅 2026-08-22 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,158 | 🐛 569 | 🌐 C++ | 📅 2026-08-22 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
...
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 544 | 🐛 44 | 🌐 Kotlin | 📅 2026-08-22 - Add interactive vector tile maps to your Compose app
...
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,393 | 🐛 72 | 🌐 Python | 📅 2026-08-22 - Python Data. Leaflet.js Maps.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,149 | 🐛 113 | 🌐 Java | 📅 2026-08-18 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 975 | 🐛 232 | 🌐 C | 📅 2026-08-22 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 426 | 🐛 179 | 🌐 Python | 📅 2026-08-22 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 279 | 🐛 22 | 🌐 C++ | 📅 2026-08-21 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 276 | 🐛 0 | 🌐 Python | 📅 2026-08-22 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 315,501 | 🐛 23 | 🌐 Python | 📅 2026-08-22
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,236 | 🐛 0 | 📅 2026-08-02
...
* [Awesome SAR](https://github.com/RadarCODE/awesome-sar) ⭐ 1,198 | 🐛 8 | 📅 2025-07-22
