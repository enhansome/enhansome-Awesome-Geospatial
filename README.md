...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,731 | 🐛 163 | 🌐 Go | 📅 2026-09-02 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,985 | 🐛 360 | 🌐 Java | 📅 2026-09-14 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
...
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 626 | 🐛 12 | 🌐 C | 📅 2026-09-14 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [duckdb-raster](https://github.com/ahuarte47/duckdb-raster) ⭐ 56 | 🐛 0 | 🌐 C | 📅 2026-09-08 - DuckDB Extension for reading and writing raster files using SQL.
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,350 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,642 | 🐛 291 | 🌐 TypeScript | 📅 2026-09-14 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,536 | 🐛 120 | 🌐 HTML | 📅 2026-09-14 - An open-source JavaScript library for integrated 2D/3D maps.
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,170 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [geojson-vt](https://github.com/mapbox/geojson-vt) ⭐ 2,072 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-05 - A highly efficient JavaScript library for slicing GeoJSON data into vector tiles on the fly.
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,364 | 🐛 891 | 🌐 TypeScript | 📅 2026-09-14 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,184 | 🐛 24 | 🌐 Python | 📅 2026-09-14 - A dynamic Web Map tile server.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 37 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-14 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-14 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 246 | 🐛 30 | 🌐 Python | 📅 2026-09-14 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,606 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,841 | 🐛 104 | 🌐 Python | 📅 2026-09-14 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [PyLandStats](https://github.com/martibosch/pylandstats) ⭐ 112 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - An open-source Pythonic library to compute landscape metrics.
...
* [H3](https://github.com/uber/h3) ⭐ 6,536 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [OpenSky API](https://github.com/openskynetwork/opensky-api) ⭐ 466 | 🐛 14 | 🌐 Python | 📅 2026-09-14 - Retrieve live airspace information.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 778 | 🐛 64 | 🌐 R | 📅 2026-09-14 - Google Earth Engine for R.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,948 | 🐛 870 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,178 | 🐛 225 | 🌐 Python | 📅 2026-09-09 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,145 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [Deep Learning ArcGIS](https://github.com/Esri/deep-learning-frameworks) ⭐ 649 | 🐛 8 | 📅 2026-09-14 - Deep Learning Libraries Installers for ArcGIS.
...
* [aviary](https://github.com/geospaitial-lab/aviary) ⭐ 16 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Pythonic Framework for AI Inference on Geospatial Data.
* [SamGIS](https://github.com/trincadev/samgis-be) ⚠️ Archived – Image Segmentation machine learning based (Segment Anything by Meta - Facebook) applied to GIS and geo data also with GPU requirements. A Segment Anything HuggingFace demo [here](https://huggingface.co/spaces/aletrn/samgis) and an HuggingFace [demo](https://huggingface.co/spaces/aletrn/samgis-lisa-on-cuda) with natural language-based image segmentation capabilities via [LISA](https://github.com/dvlab-research/LISA) ⭐ 2,678 | 🐛 115 | 🌐 Python | 📅 2025-02-16.

## MCP Servers

* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
* [OSM Edit MCP](https://github.com/skywinder/osm-edit-mcp) ⭐ 4 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - Python MCP server for inspecting OpenStreetMap data and previewing version-checked road-edit proposals from selected local GPX survey segments. Applying changes requires explicit user confirmation of the proposal digest. Alpha.
...
* [geoai-skills](https://github.com/muend/geoai-skills) ⭐ 22 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Vendor-neutral Agent Skills (SKILL.md) that make an AI coding agent check coordinate reference systems, spatial validation, comparability and uncertainty before a result becomes a claim. Works with Claude Code, Codex, Cursor and GitHub Copilot; ships a paired evaluation against a skills-disabled control arm, including the quality gate it fails.

## C

* [libvips](https://github.com/libvips/libvips) ⭐ 11,642 | 🐛 79 | 🌐 C | 📅 2026-09-14 - A fast image processing library with low memory needs.
* [H3](https://github.com/uber/h3) ⭐ 6,536 | 🐛 170 | 🌐 C | 📅 2026-09-13 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,887 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 71 | 🐛 55 | 🌐 C | 📅 2026-09-14 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,605 | 🐛 779 | 🌐 C++ | 📅 2026-09-14 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,471 | 🐛 112 | 🌐 Python | 📅 2026-09-10 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,205 | 🐛 943 | 🌐 C++ | 📅 2026-09-14 - Open Source Routing Engine for OpenStreetMap.
...
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,800 | 🐛 61 | 🌐 C | 📅 2026-09-14 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 79 | 🌐 C++ | 📅 2026-09-14 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [S2](https://github.com/golang/geo) ⭐ 1,853 | 🐛 37 | 🌐 Go | 📅 2026-09-14 - S2 is a library for spherical geometry that aims to have the same robustness, flexibility, and performance as the best planar geometry libraries.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,692 | 🐛 242 | 🌐 Java | 📅 2026-09-14 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,053 | 🐛 45 | 🌐 Java | 📅 2026-09-14 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,235 | 🐛 225 | 🌐 Java | 📅 2026-09-05 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,725 | 🐛 1,667 | 🌐 JavaScript | 📅 2026-09-14 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,590 | 🐛 532 | 🌐 TypeScript | 📅 2026-09-14 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,500 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-03 - React friendly API wrapper around MapboxGL JS.
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,776 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,372 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,240 | 🐛 257 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,103 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-14 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,085 | 🐛 242 | 🌐 JavaScript | 📅 2026-09-14 - Draw tools for mapbox-gl-js.
...
* [flatten-js](https://github.com/alexbol99/flatten-js) ⭐ 652 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-18 - For manipulating geometrical shapes, finding intersections, checking inclusion, calculating distance, transformations, and more.
* [leaflet TimeDimension](https://github.com/socib/Leaflet.TimeDimension) ⭐ 452 | 🐛 88 | 🌐 JavaScript | 📅 2026-06-01 - Add time dimension capabilities on a Leaflet map.
...
* [leaflet-elevation](https://github.com/Raruto/leaflet-elevation) ⭐ 283 | 🐛 19 | 🌐 JavaScript | 📅 2026-07-26 - Leaflet plugin that allows to add elevation profiles using d3js
...
* [eurostat-map.js](https://github.com/eurostat/eurostat-map.js) ⭐ 103 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-14 - Reusable library to quickly create and customise web maps showing Eurostat data directly retrieved from Eurostat database.
...
* [Moveet](https://github.com/ivannovazzi/moveet) ⭐ 12 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-14 - Real-time vehicle fleet simulator with A\* pathfinding on real road networks.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 221 | 🐛 27 | 🌐 Julia | 📅 2026-09-14 - Generic Mapping Tools Library Wrapper for Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-14 - Interface for Reading from the Earth System Datacube.
...
* [SpectralIndices.jl](https://github.com/awesome-spectral-indices/SpectralIndices.jl) ⭐ 24 | 🐛 12 | 🌐 Julia | 📅 2026-08-15 - Julia package for working with spectral indices commonly used in remote sensing and earth observation applications.
...
* [Spatial K](https://github.com/maplibre/spatial-k) ⭐ 141 | 🐛 48 | 🌐 Kotlin | 📅 2026-09-14 - Spatial K - A set of Kotlin Multiplatform Libraries for working with geospatial data
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,844 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,248 | 🐛 421 | 🌐 Python | 📅 2026-09-14 - Python tools for geographic data.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,774 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,371 | 🐛 12 | 🌐 Python | 📅 2026-09-14 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,411 | 🐛 37 | 🌐 Python | 📅 2026-09-13 - Implementation of Trajectory classes and functions built on top of GeoPandas.
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,225 | 🐛 53 | 🌐 Python | 📅 2026-09-14 - For conversions between projections.
* [sentinelsat](https://github.com/sentinelsat/sentinelsat) ⚠️ Archived - Search and download Copernicus Sentinel satellite images.
* [xarray-spatial](https://github.com/makepath/xarray-spatial) ⭐ 972 | 🐛 80 | 🌐 Python | 📅 2026-09-09 - xarray-spatial implements common raster analysis functions using Numba and provides an easy-to-install, easy-to-extend codebase for raster analysis.
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 894 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 874 | 🐛 79 | 🌐 C++ | 📅 2026-09-14 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 874 | 🐛 185 | 🌐 Python | 📅 2026-09-14 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [Verde](https://github.com/fatiando/verde) ⭐ 670 | 🐛 47 | 🌐 Python | 📅 2026-08-04 - Verde is a Python library for processing spatial data (bathymetry, geophysics surveys, etc) and interpolating it on regular grids (i.e., gridding).
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 652 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
...
* [geospatial](https://github.com/giswqs/geospatial) ⭐ 435 | 🐛 16 | 🌐 Dockerfile | 📅 2026-09-14 - A collection of Python packages for geospatial analysis and data visualization.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 24 | 🌐 Python | 📅 2026-09-07 - Library and a CLI tool for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 310 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,205 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [HyperCoast](https://github.com/opengeos/HyperCoast) ⭐ 288 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A Python package for visualizing and analyzing hyperspectral data in coastal regions.
* [Detectree](https://github.com/martibosch/detectree) ⭐ 281 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - DetecTree is a Pythonic library to classify tree/non-tree pixels from aerial imagery.
...
* [fastkml](https://github.com/cleder/fastkml) ⭐ 256 | 🐛 21 | 🌐 Python | 📅 2026-09-14 - Fastkml is a library to read, write and manipulate KML files. It aims to keep it simple and fast (using lxml if available).
...
* [Siphon](https://github.com/unidata/siphon) ⭐ 246 | 🐛 82 | 🌐 Python | 📅 2026-09-14 - A collection of Python utilities for retrieving atmospheric and oceanic data from remote sources, focusing on being able to retrieve data from Unidata data technologies, such as the THREDDS data server.
...
* [Mapchete](https://github.com/ungarj/mapchete) ⭐ 211 | 🐛 48 | 🌐 Python | 📅 2026-09-14 - Mapchete processes raster and vector geodata in digestable chunks. Tile-based geodata processing.
...
* [pygeoif](https://github.com/cleder/pygeoif) ⭐ 74 | 🐛 18 | 🌐 Python | 📅 2026-09-14 - PyGeoIf provides a GeoJSON-like protocol for geo-spatial (GIS) vector data. A simple, pure Python implementation of geometric objects and operations, useful for basic GIS tasks.
...
* [sf](https://github.com/r-spatial/sf) ⭐ 1,445 | 🐛 65 | 🌐 R | 📅 2026-09-14 - Simple Features for R.
...
* [rgee](https://github.com/r-spatial/rgee) ⭐ 778 | 🐛 64 | 🌐 R | 📅 2026-09-14 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 710 | 🐛 16 | 🌐 R | 📅 2026-09-04 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 619 | 🐛 14 | 🌐 C++ | 📅 2026-09-14 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 612 | 🐛 26 | 🌐 R | 📅 2026-09-11 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 548 | 🐛 19 | 🌐 R | 📅 2026-09-11 - Satellite image time series package for R.
...
* [ggspatial](https://github.com/paleolimbot/ggspatial) ⭐ 392 | 🐛 40 | 🌐 R | 📅 2026-09-14 - A ggplot2 R extension for plotting Spatial\* objects.
...
* [rnoaa](https://github.com/ropensci/rnoaa) ⭐ 342 | 🐛 28 | 🌐 R | 📅 2025-02-04 - R interface to many NOAA data sources.
...
* [exactextractr](https://github.com/isciences/exactextractr) ⭐ 308 | 🐛 18 | 🌐 C++ | 📅 2026-06-03 - R package for fast and accurate raster zonal statistics.
...
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 240 | 🐛 32 | 🌐 R | 📅 2026-09-14 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [gdalraster](https://github.com/USDAForestService/gdalraster) ⭐ 59 | 🐛 11 | 🌐 C++ | 📅 2026-09-14 - R Bindings to the GDAL Raster API.
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 56 | 🐛 17 | 🌐 R | 📅 2026-09-14 - R package to download data from Brazil's Population Census.
...
* [tiff](https://github.com/s-u/tiff) ⭐ 11 | 🐛 5 | 🌐 C | 📅 2026-08-24 - Read and write TIFF images in R.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,871 | 🐛 126 | 🌐 Rust | 📅 2026-09-14 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,174 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,915 | 🐛 55 | 🌐 Rust | 📅 2026-09-14 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,934 | 🐛 136 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,754 | 🐛 137 | 🌐 Rust | 📅 2026-09-14 - A high-performance, general-purpose graph library for Python, written in Rust.
...
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 916 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 823 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 504 | 🐛 114 | 🌐 Rust | 📅 2026-09-14 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 271 | 🐛 20 | 🌐 Rust | 📅 2026-09-14 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [Polars ST](https://github.com/Oreilles/polars-st) ⭐ 196 | 🐛 9 | 🌐 Python | 📅 2026-09-14 - Spatial extension for Polars DataFrames.
* [proj](https://github.com/georust/rust-proj) ⭐ 185 | 🐛 40 | 🌐 Rust | 📅 2026-06-17 - Rust bindings for Proj.
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 180 | 🐛 8 | 🌐 Rust | 📅 2026-09-14 - Computational Geometry library written in Rust.
...
* [stac-rs](https://github.com/gadomski/stac-rs) ⭐ 145 | 🐛 30 | 🌐 Rust | 📅 2026-09-10 - Rust implementation of the SpatioTemporal Asset Catalog (STAC) specification.
* [osmpbfreader-rs](https://github.com/TeXitoi/osmpbfreader-rs) ⭐ 134 | 🐛 7 | 🌐 Rust | 📅 2026-04-07 - Read OpenStreetMap PBF files.
* [GeoTIFF](https://github.com/georust/geotiff) ⭐ 133 | 🐛 10 | 🌐 Rust | 📅 2026-07-31 - Work with GeoTIFF raster files.
...
* [tzf-rs](https://github.com/ringsaturn/tzf-rs) ⭐ 108 | 🐛 0 | 🌐 Rust | 📅 2026-09-14 - Get timezone via longitude\&latitude in Rust in a fast way
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 64 | 🌐 Jupyter Notebook | 📅 2026-09-14 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [cql2-rs](https://github.com/developmentseed/cql2-rs) ⭐ 23 | 🐛 11 | 🌐 Rust | 📅 2026-09-14 - Library for parsing the OGC CQL2 filter language.
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [pgstac-rs](https://github.com/gadomski/pgstac-rs) ⚠️ Archived - Rust interface for [pgstac](https://github.com/stac-utils/pgstac) ⭐ 223 | 🐛 74 | 🌐 PLpgSQL | 📅 2026-09-14.
...
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 243 | 🌐 Scala | 📅 2026-09-14 - GeoTrellis is a Scala library and framework that uses Spark to work with raster data.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 216 | 🌐 Swift | 📅 2026-09-14 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,420 | 🐛 3,517 | 🌐 C++ | 📅 2026-09-14 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,600 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,014 | 🐛 53 | 🌐 Dart | 📅 2026-09-13 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,206 | 🐛 609 | 🌐 C++ | 📅 2026-09-14 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-14 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 572 | 🐛 27 | 🌐 Kotlin | 📅 2026-09-14 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,496 | 🐛 202 | 🌐 Scala | 📅 2026-09-14 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
* [GeoTrellis](https://github.com/locationtech/geotrellis) ⭐ 1,374 | 🐛 243 | 🌐 Scala | 📅 2026-09-14 - GeoTrellis is a geographic data processing engine for high performance applications.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,377 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,400 | 🐛 70 | 🌐 Python | 📅 2026-09-14 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,179 | 🐛 163 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,117 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,345 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [lonboard](https://github.com/developmentseed/lonboard) ⭐ 964 | 🐛 124 | 🌐 Python | 📅 2026-09-14 - Fast, interactive geospatial data visualization in Jupyter.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 119 | 🌐 Python | 📅 2026-09-14 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [GeoJs](https://github.com/OpenGeoscience/geojs) ⭐ 471 | 🐛 47 | 🌐 JavaScript | 📅 2026-09-14 - High-performance visualization and interactive data exploration of scientific and geospatial location aware datasets.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,176 | 🐛 111 | 🌐 Java | 📅 2026-09-14 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 979 | 🐛 221 | 🌐 C | 📅 2026-09-14 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 432 | 🐛 178 | 🌐 Python | 📅 2026-09-14 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 283 | 🐛 2 | 🌐 Python | 📅 2026-09-14 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Magrit](https://github.com/riatelab/magrit) ⭐ 161 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-14 - Magrit is an online application for thematic mapping.
...
* [GDAL](https://github.com/dwtkns/gdal-cheat-sheet) ⭐ 1,224 | 🐛 5 | 📅 2024-06-13 - Cheat sheet for GDAL/OGR command-line tools.
...
* [Geopython](https://github.com/urschrei/Geopython) ⭐ 382 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-09-14 - Notebooks and libraries for spatial/geo Python explorations.
...
* [Textures.js](https://github.com/riccardoscalco/textures) ⭐ 6,092 | 🐛 21 | 🌐 JavaScript | 📅 2023-01-01 - JavaScript library for creating SVG patterns, designed for data visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 320,648 | 🐛 18 | 🌐 Python | 📅 2026-09-13
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,258 | 🐛 0 | 📅 2026-09-12
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,503 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,523 | 🐛 68 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,628 | 🐛 3 | 📅 2026-08-10
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,539 | 🐛 0 | 📅 2026-09-01
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,178 | 🐛 23 | 🌐 Python | 📅 2026-09-13
