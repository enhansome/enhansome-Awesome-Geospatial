...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,721 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 357 | 🌐 Java | 📅 2026-08-31 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 116 | 🌐 C++ | 📅 2026-07-01 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 826 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 624 | 🐛 7 | 🌐 C | 📅 2026-08-31 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [GeoDesk](https://github.com/clarisma/geodesk) ⭐ 199 | 🐛 43 | 🌐 Java | 📅 2026-07-17 - Fast and storage-efficient spatial database engine for OpenStreetMap data
...
* [L7](https://github.com/antvis/L7) ⭐ 4,057 | 🐛 214 | 🌐 TypeScript | 📅 2026-07-30 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,362 | 🐛 888 | 🌐 TypeScript | 📅 2026-08-27 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,154 | 🐛 26 | 🌐 Python | 📅 2026-08-29 - A dynamic Web Map tile server.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 33 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-31 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-31 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 215 | 🐛 34 | 🌐 Python | 📅 2026-08-31 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [PySAR](https://github.com/insarlab/PySAR) ⭐ 831 | 🐛 68 | 🌐 Python | 📅 2026-08-31 - InSAR time series analysis in Python.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 175 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,589 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 706 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
...
* [pyGEDI](https://github.com/EduinHSERNA/pyGEDI) ⭐ 109 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2022-07-17 - pyGEDI provides a high performance, lower cognitive load, and cleaner and more transparent code for data extraction, analysis, processing, and visualization of GEDI's products.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,818 | 🐛 83 | 🌐 Python | 📅 2026-08-31 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 17 | 🌐 R | 📅 2026-06-17 - R package that uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
...
* [H3](https://github.com/uber/h3) ⭐ 6,511 | 🐛 165 | 🌐 C | 📅 2026-08-27 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,162 | 🐛 210 | 🌐 Python | 📅 2026-08-31 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,129 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [AIDE](https://github.com/microsoft/aerial_wildlife_detection) ⭐ 245 | 🐛 29 | 🌐 Python | 📅 2026-06-10 - Annotation Interface for Data-driven Ecology: Tools for detecting wildlife in aerial images using active learning
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [H3](https://github.com/uber/h3) ⭐ 6,511 | 🐛 165 | 🌐 C | 📅 2026-08-27 - Hexagonal hierarchical geospatial indexing system.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,595 | 🐛 773 | 🌐 C++ | 📅 2026-08-31 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,434 | 🐛 114 | 🌐 Python | 📅 2026-08-31 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,141 | 🐛 938 | 🌐 C++ | 📅 2026-08-26 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,721 | 🐛 77 | 🌐 C++ | 📅 2026-08-25 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,846 | 🐛 52 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 39 | 🌐 C++ | 📅 2026-08-31 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,715 | 🐛 71 | 🌐 C# | 📅 2026-08-31 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,654 | 🐛 240 | 🌐 Java | 📅 2026-08-31 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,015 | 🐛 44 | 🌐 Java | 📅 2026-08-18 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
...
* [jpostal](https://github.com/openvenues/jpostal) ⭐ 142 | 🐛 3 | 🌐 Java | 📅 2025-07-01 - Java/JNI bindings to libpostal for fast international street address parsing/normalization.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,630 | 🐛 1,649 | 🌐 JavaScript | 📅 2026-08-31 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,540 | 🐛 489 | 🌐 TypeScript | 📅 2026-08-31 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,496 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-06 - React friendly API wrapper around MapboxGL JS.
...
* [leaflet-providers](https://github.com/leaflet-extras/leaflet-providers) ⭐ 2,378 | 🐛 21 | 🌐 JavaScript | 📅 2026-06-11 - An extension to Leaflet that contains configurations for various free tile providers.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,093 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-31 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,083 | 🐛 245 | 🌐 JavaScript | 📅 2026-08-31 - Draw tools for mapbox-gl-js.
* [geotiff.js](https://github.com/geotiffjs/geotiff.js) ⭐ 1,045 | 🐛 93 | 🌐 JavaScript | 📅 2026-05-26 - geotiff.js is a small library to parse TIFF files for visualization or analysis.
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 59 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-08-31 - Interface for Reading from the Earth System Datacube.
* [STAC.jl](https://github.com/JuliaClimate/STAC.jl) ⭐ 33 | 🐛 8 | 🌐 Julia | 📅 2026-08-31 - SpatioTemporal Asset Catalog (STAC) julia client.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,834 | 🐛 2 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,237 | 🐛 420 | 🌐 Python | 📅 2026-08-31 - Python tools for geographic data.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,340 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - GeoAI: Artificial Intelligence for Geospatial Data
* [Rasterio](https://github.com/mapbox/rasterio) ⭐ 2,566 | 🐛 156 | 🌐 Python | 📅 2026-08-30 - Rasterio employs GDAL under the hood for file I/O and raster formatting.
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,894 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [MovingPandas](https://github.com/anitagraser/movingpandas) ⭐ 1,409 | 🐛 34 | 🌐 Python | 📅 2026-08-28 - Implementation of Trajectory classes and functions built on top of GeoPandas.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 39 | 🌐 C++ | 📅 2026-08-31 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 187 | 🌐 Python | 📅 2026-08-31 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [Spectral Python](https://github.com/spectralpython/spectral) ⭐ 678 | 🐛 21 | 🌐 Python | 📅 2026-08-29 - Python module for hyperspectral image processing.
...
* [rio-tiler](https://github.com/mapbox/rio-tiler) ⭐ 592 | 🐛 18 | 🌐 Python | 📅 2026-08-26 - Get mercator tile from landsat, sentinel or other AWS hosted raster.
...
* [whitebox](https://github.com/giswqs/whitebox) ⭐ 422 | 🐛 1 | 🌐 Python | 📅 2026-01-31 - Python frontend for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,196 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [srai](https://github.com/kraina-ai/srai) ⭐ 389 | 🐛 104 | 🌐 Python | 📅 2026-08-03 - Spatial Representations for Artificial Intelligence. Set of tools for geospatial machine learning, data acquisition and wrangling.
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-08-03 - Library and a CLI tool for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [routing-py](https://github.com/gis-ops/routing-py) ⭐ 346 | 🐛 12 | 🌐 Python | 📅 2026-08-18 - Python library to access all public routing, isochrones and matrix APIs in a consistent manner.
...
* [WhiteboxTools-ArcGIS](https://github.com/giswqs/WhiteboxTools-ArcGIS) ⭐ 313 | 🐛 3 | 🌐 Python | 📅 2025-08-12 - ArcGIS Python Toolbox for [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,196 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [geeup](https://github.com/samapriya/geeup) ⭐ 140 | 🐛 0 | 🌐 Python | 📅 2025-12-31 - Simple CLI for Earth Engine Uploads.
* [LARD](https://github.com/deel-ai/LARD) ⭐ 137 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-11 - A runway dataset and a generator of synthetic aerial images with automatic labeling.
...
* [pyle38](https://github.com/iwpnd/pyle38) ⭐ 89 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Asynchronous Client for the worlds fastest in-memory geo-database Tile38
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 944 | 🐛 20 | 🌐 R | 📅 2026-08-31 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 813 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 777 | 🐛 63 | 🌐 R | 📅 2026-08-31 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 706 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 617 | 🐛 14 | 🌐 C++ | 📅 2026-08-31 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
...
* [ggspatial](https://github.com/paleolimbot/ggspatial) ⭐ 392 | 🐛 40 | 🌐 R | 📅 2025-08-24 - A ggplot2 R extension for plotting Spatial\* objects.
* [mapdeck](https://github.com/SymbolixAU/mapdeck) ⭐ 384 | 🐛 79 | 🌐 HTML | 📅 2025-03-21 - R interface to Deck.gl and Mapbox.
* [osmdata](https://github.com/ropensci/osmdata) ⭐ 342 | 🐛 22 | 🌐 R | 📅 2026-08-31 - R package for downloading OpenStreetMap data.
...
* [mapsf](https://github.com/riatelab/mapsf) ⭐ 246 | 🐛 3 | 🌐 R | 📅 2026-07-31 - Thematic cartography with R.
* [googleway](https://github.com/SymbolixAU/googleway) ⭐ 240 | 🐛 58 | 🌐 HTML | 📅 2024-09-24 - R Package for accessing and plotting Google Maps.
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 240 | 🐛 33 | 🌐 R | 📅 2026-08-31 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [whiteboxR](https://github.com/giswqs/whiteboxR) ⭐ 186 | 🐛 5 | 🌐 R | 📅 2025-10-21 - R frontend of [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,196 | 🐛 175 | 🌐 Rust | 📅 2026-05-26.
...
* [Prioritizr](https://github.com/prioritizr/prioritizr) ⭐ 137 | 🐛 17 | 🌐 R | 📅 2026-06-17 - The prioritizr R package uses integer linear programming (ILP) techniques to provide a flexible interface for building and solving conservation planning problems.
...
* [vapour](https://github.com/hypertidy/vapour) ⭐ 90 | 🐛 64 | 🌐 R | 📅 2026-08-25 - A lightweight GDAL API package for R.
...
* [biodivMapR](https://github.com/jbferet/biodivMapR) ⭐ 63 | 🐛 0 | 🌐 R | 📅 2026-08-30 - R package for α- and β-diversity mapping using remotely-sensed images.
...
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 55 | 🐛 15 | 🌐 R | 📅 2026-08-30 - R package to download data from Brazil's Population Census.
* [earthEngineGrabR](https://github.com/JesJehle/earthEngineGrabR) ⭐ 55 | 🐛 8 | 🌐 R | 📅 2020-06-24 - The earthEngineGrabR is an interface between R and the Google Earth Engine, which simplifies the acquisition of remote sensing data.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,686 | 🐛 146 | 🌐 Rust | 📅 2026-08-31 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,884 | 🐛 64 | 🌐 Rust | 📅 2026-08-31 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,920 | 🐛 124 | 🌐 Rust | 📅 2026-08-31 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,752 | 🐛 137 | 🌐 Rust | 📅 2026-08-31 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,569 | 🐛 68 | 🌐 Rust | 📅 2026-08-28 - About Native Maps for Web, Mobile and Desktop.
* [WhiteboxTools](https://github.com/jblindsay/whitebox-tools) ⭐ 1,196 | 🐛 175 | 🌐 Rust | 📅 2026-05-26 - An advanced geospatial data analysis platform.
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 911 | 🐛 27 | 🌐 Python | 📅 2025-12-10 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 818 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
...
* [rstar](https://github.com/georust/rstar) ⭐ 555 | 🐛 44 | 🌐 Rust | 📅 2026-08-23 - R\*-tree library for the rust ecosystem.
* [h3o](https://github.com/HydroniumLabs/h3o) ⭐ 541 | 🐛 0 | 🌐 Rust | 📅 2026-08-29 - Rust implementation of the H3 geospatial indexing system.
* [sguaba](https://github.com/helsing-ai/sguaba) ⭐ 510 | 🐛 2 | 🌐 Rust | 📅 2026-07-08 - Types for points and vectors in coordinate spaces and transformations based on rigid body transforms.
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 498 | 🐛 122 | 🌐 Rust | 📅 2026-08-31 - Single-node analytical database engine with geospatial as the first-class citizen.
* [geozero](https://github.com/georust/geozero) ⭐ 469 | 🐛 45 | 🌐 Rust | 📅 2026-08-31 - Zero-Copy reading and writing of geospatial data.
* [gdal](https://github.com/georust/rust-gdal) ⭐ 448 | 🐛 62 | 🌐 Rust | 📅 2026-07-06 - Rust bindings for GDAL.
* [geoarrow-rs](https://github.com/kylebarron/geoarrow-rs) ⭐ 423 | 🐛 86 | 🌐 Rust | 📅 2026-08-31 - GeoArrow in Rust and WebAssembly with vectorized geometry operations.
...
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 180 | 🐛 13 | 🌐 Rust | 📅 2026-08-17 - Computational Geometry library written in Rust.
...
* [stac-rs](https://github.com/gadomski/stac-rs) ⭐ 144 | 🐛 28 | 🌐 Rust | 📅 2026-08-27 - Rust implementation of the SpatioTemporal Asset Catalog (STAC) specification.
...
* [pasture](https://github.com/Mortano/pasture) ⭐ 94 | 🐛 4 | 🌐 Rust | 📅 2025-09-30 - A Rust library for working with point cloud data.
...
* [gtfs-structures](https://github.com/rust-transit/gtfs-structure) ⭐ 77 | 🐛 23 | 🌐 Rust | 📅 2026-08-27 - Read GTFS files into structs, with smart references.
...
* [transit\_model](https://github.com/hove-io/transit_model) ⭐ 73 | 🐛 14 | 🌐 Rust | 📅 2026-08-27 - Manage, convert and enrich transit data.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2026-08-31 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [OGC API](https://github.com/georust/ogcapi) ⭐ 42 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 - OGC API building blocks.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 3 | 🌐 Rust | 📅 2026-08-31 - utils & tiles w/ (rs & pyo3).
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [Routers](https://github.com/routers-org/routers) ⭐ 2 | 🐛 15 | 🌐 Rust | 📅 2026-08-30 - Set of routing tools designed for system-agnostic maps.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 215 | 🌐 Swift | 📅 2026-08-31 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
* [turf-swift](https://github.com/mapbox/turf-swift) ⭐ 271 | 🐛 29 | 🌐 Swift | 📅 2026-06-29 - A Swift language port of Turf.js.
* [MapboxDirections.swift](https://github.com/mapbox/MapboxDirections.swift) ⭐ 206 | 🐛 32 | 🌐 Swift | 📅 2026-08-25 - Traffic-aware directions in Swift or Objective-C on iOS, macOS, tvOS, and watchOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,266 | 🐛 3,477 | 🌐 C++ | 📅 2026-08-31 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
* [MAPS.ME](https://github.com/mapsme/omim) ⭐ 4,601 | 🐛 997 | 🌐 C++ | 📅 2022-10-05 - MAPS.ME — Offline OpenStreetMap maps for iOS and Android.
* [flutter\_map](https://github.com/fleaflet/flutter_map) ⭐ 3,013 | 🐛 48 | 🌐 Dart | 📅 2026-08-31 - A Dart implementation of Leaflet for Flutter apps.
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,174 | 🐛 578 | 🌐 C++ | 📅 2026-08-31 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 650 | 🐛 518 | 🌐 Kotlin | 📅 2026-08-31 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 558 | 🐛 45 | 🌐 Kotlin | 📅 2026-08-31 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,495 | 🐛 204 | 🌐 Scala | 📅 2026-08-31 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,334 | 🐛 320 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,395 | 🐛 68 | 🌐 Python | 📅 2026-08-31 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,135 | 🐛 162 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,114 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,342 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [lonboard](https://github.com/developmentseed/lonboard) ⭐ 964 | 🐛 125 | 🌐 Python | 📅 2026-08-31 - Fast, interactive geospatial data visualization in Jupyter.
...
* [deck.gl-raster](https://github.com/developmentseed/deck.gl-raster) ⭐ 226 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-03 - Client-side, GPU-accelerated Cloud-Optimized GeoTIFF visualization in deck.gl.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 975 | 🐛 222 | 🌐 C | 📅 2026-08-31 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 428 | 🐛 176 | 🌐 Python | 📅 2026-08-31 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
* [veins](https://github.com/sommer/veins) ⭐ 327 | 🐛 8 | 🌐 C++ | 📅 2026-06-16 - Open source vehicular network simulation framework.
* [exactextract](https://github.com/isciences/exactextract) ⭐ 320 | 🐛 29 | 🌐 C++ | 📅 2026-02-24 - Provides a fast and accurate algorithm for summarizing values in the portion of a raster dataset that is covered by a polygon, often referred to as zonal statistics.
* [DroneDB](https://github.com/DroneDB/DroneDB) ⭐ 282 | 🐛 22 | 🌐 C++ | 📅 2026-08-21 - Effortless aerial data management and sharing.
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 280 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [RoadDetections](https://github.com/microsoft/RoadDetections) ⭐ 635 | 🐛 9 | 🌐 C# | 📅 2026-05-05 - Road detections from Microsoft Maps aerial imagery.
...
* [ZipCheckup](https://github.com/artakulov/us-water-quality-data) ⭐ 4 | 🐛 0 | 📅 2026-08-28 - Free ZIP-level environmental safety data platform covering water quality, air quality, PFAS, radon, lead, flood risk and 11 more verticals across 42K US ZIP codes. Public API, CC BY 4.0.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,086 | 🐛 50 | 🌐 Python | 📅 2026-08-28 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
* [Geopython](https://github.com/urschrei/Geopython) ⭐ 381 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2026-08-31 - Notebooks and libraries for spatial/geo Python explorations.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 317,411 | 🐛 18 | 🌐 Python | 📅 2026-08-25
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,528 | 🐛 92 | 📅 2024-05-17
...
* [satellite-image-deep-learning](https://github.com/robmarkcole/satellite-image-deep-learning) ⭐ 10,240 | 🐛 1 | 📅 2026-08-02
* [Awesome Object Detection](https://github.com/amusi/awesome-object-detection) ⭐ 7,505 | 🐛 7 | 📅 2022-12-17
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,507 | 🐛 66 | 📅 2026-07-21
...
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,532 | 🐛 1 | 📅 2026-07-23
...
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 535 | 🐛 47 | 🌐 Jupyter Notebook | 📅 2026-08-28
* [Awesome DEM](https://github.com/DahnJ/Awesome-DEM) ⭐ 452 | 🐛 6 | 📅 2024-05-25 - Overview of Digital Elevation Model (DEM) datasets.
* [Awesome Geo Rust](https://github.com/pka/awesome-georust) ⭐ 414 | 🐛 1 | 📅 2026-03-01
