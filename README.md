...
* [Tile38](https://github.com/tidwall/tile38) ⭐ 9,723 | 🐛 162 | 🌐 Go | 📅 2026-08-07 - Tile38 is a geospatial database, spatial index, and realtime geofence.
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,984 | 🐛 356 | 🌐 Java | 📅 2026-09-01 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,074 | 🐛 117 | 🌐 C++ | 📅 2026-09-01 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 826 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 624 | 🐛 6 | 🌐 C | 📅 2026-09-01 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [GeoDesk](https://github.com/clarisma/geodesk) ⭐ 199 | 🐛 45 | 🌐 Java | 📅 2026-07-17 - Fast and storage-efficient spatial database engine for OpenStreetMap data
...
* [MapTalks.js](https://github.com/maptalks/maptalks.js) ⭐ 4,533 | 🐛 118 | 🌐 HTML | 📅 2026-08-25 - An open-source JavaScript library for integrated 2D/3D maps.
...
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,156 | 🐛 131 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,362 | 🐛 889 | 🌐 TypeScript | 📅 2026-09-01 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,155 | 🐛 25 | 🌐 Python | 📅 2026-09-01 - A dynamic Web Map tile server.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 34 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-31 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 1 | 🐛 90 | 🌐 TypeScript | 📅 2026-09-01 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 215 | 🐛 28 | 🌐 Python | 📅 2026-09-01 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [InSARHub](https://github.com/jldz9/InSARHub) ⭐ 177 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - A modular Python framework for end to end InSAR and time-series processing with GUI support.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,590 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 707 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
...
* [RTKLIB](https://github.com/tomojitakasu/RTKLIB) ⭐ 3,119 | 🐛 456 | 🌐 C | 📅 2024-05-28 - RTKLIB is an open source program package for standard and precise positioning
...
* [SIAC](https://github.com/MarcYin/SIAC) ⭐ 72 | 🐛 3 | 🌐 C | 📅 2026-09-01 - A sensor invariant Atmospheric Correction (SIAC).
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,819 | 🐛 87 | 🌐 Python | 📅 2026-09-01 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [PyLandStats](https://github.com/martibosch/pylandstats) ⭐ 111 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - An open-source Pythonic library to compute landscape metrics.
...
* [H3](https://github.com/uber/h3) ⭐ 6,516 | 🐛 164 | 🌐 C | 📅 2026-09-01 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,937 | 🐛 869 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,165 | 🐛 212 | 🌐 Python | 📅 2026-09-01 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,131 | 🐛 6 | 🌐 Python | 📅 2026-08-31 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [DeepForest](https://github.com/weecology/DeepForest) ⭐ 768 | 🐛 103 | 🌐 Python | 📅 2026-08-30 - Python Package for Tree Crown Detection in Airborne RGB imagery.
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 56 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [H3](https://github.com/uber/h3) ⭐ 6,516 | 🐛 164 | 🌐 C | 📅 2026-09-01 - Hexagonal hierarchical geospatial indexing system.
* [libpostal](https://github.com/openvenues/libpostal) ⭐ 4,881 | 🐛 299 | 🌐 C | 📅 2026-05-13 - A C library for parsing/normalizing street addresses around the world. Powered by statistical NLP and open geo data.
...
* [FORCE](https://github.com/davidfrantz/force) ⭐ 199 | 🐛 18 | 🌐 C | 📅 2026-08-27 - Framework for Operational Radiometric Correction for Environmental monitoring.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,595 | 🐛 777 | 🌐 C++ | 📅 2026-09-01 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,440 | 🐛 114 | 🌐 Python | 📅 2026-09-01 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,148 | 🐛 940 | 🌐 C++ | 📅 2026-08-31 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,722 | 🐛 78 | 🌐 C++ | 📅 2026-08-25 - Computational geometry and spatial indexing on the sphere.
* [VROOM](https://github.com/VROOM-Project/vroom) ⭐ 1,848 | 🐛 52 | 🌐 C++ | 📅 2026-05-11 - VROOM is an open-source optimization engine written in C++17 that aim at providing good solutions to various real-life vehicle routing problems (VRP) within a small computing time.
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,797 | 🐛 57 | 🌐 C | 📅 2026-08-31 - A free open source C++ geospatial toolkit.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 39 | 🌐 C++ | 📅 2026-09-01 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [OpenOrienteering Mapper](https://github.com/OpenOrienteering/mapper) ⭐ 494 | 🐛 556 | 🌐 C++ | 📅 2026-07-21 - OpenOrienteering Mapper is a software for creating maps for the orienteering sport.
...
* [geo-utils-cpp](https://github.com/gistrec/geo-utils-cpp) ⭐ 59 | 🐛 2 | 🌐 C++ | 📅 2026-08-21 - Header-only C++17 library for spherical (lat/lng) geometry: distance, bearing, area, point-in-polygon.
...
* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 114 | 🐛 35 | 🌐 Fortran | 📅 2026-07-23 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,503 | 🐛 181 | 🌐 Go | 📅 2026-08-20 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,654 | 🐛 240 | 🌐 Java | 📅 2026-09-01 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,017 | 🐛 43 | 🌐 Java | 📅 2026-08-18 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,228 | 🐛 226 | 🌐 Java | 📅 2026-08-13 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,635 | 🐛 1,650 | 🌐 JavaScript | 📅 2026-09-01 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,545 | 🐛 487 | 🌐 TypeScript | 📅 2026-09-01 - WebGL2 powered geospatial visualization layers.
* [react-map-gl](https://github.com/uber/react-map-gl) ⭐ 8,497 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-06 - React friendly API wrapper around MapboxGL JS.
* [gmaps.js](https://github.com/hpneo/gmaps) ⚠️ Archived - gmaps.js allows you to use the potential of Google Maps in a simple way.
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,936 | 🐛 15 | 🌐 JavaScript | 📅 2026-07-07 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,771 | 🐛 12 | 🌐 JavaScript | 📅 2026-07-21 - A high-performance JavaScript library for 2D spatial indexing.
* [leaflet-providers](https://github.com/leaflet-extras/leaflet-providers) ⭐ 2,378 | 🐛 23 | 🌐 JavaScript | 📅 2026-06-11 - An extension to Leaflet that contains configurations for various free tile providers.
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,353 | 🐛 32 | 🌐 JavaScript | 📅 2026-08-10 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,236 | 🐛 256 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,095 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-31 - A cross provider JavaScript library for drawing on maps
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 59 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-01 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
...
* [GeoData.jl](https://github.com/rafaqz/Rasters.jl) ⭐ 264 | 🐛 168 | 🌐 Julia | 📅 2026-08-26 - Standardising geospatial raster data in the Julia language.
...
* [GMT.jl](https://github.com/GenericMappingTools/GMT.jl) ⭐ 221 | 🐛 27 | 🌐 Julia | 📅 2026-08-31 - Generic Mapping Tools Library Wrapper for Julia.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-01 - Interface for Reading from the Earth System Datacube.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,240 | 🐛 421 | 🌐 Python | 📅 2026-08-31 - Python tools for geographic data.
...
* [leafmap](https://github.com/giswqs/leafmap) ⭐ 3,768 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - A Python package for geospatial analysis and interactive mapping with minimal coding in a Jupyter environment.
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,343 | 🐛 8 | 🌐 Python | 📅 2026-08-31 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,897 | 🐛 3 | 🌐 Python | 📅 2026-08-18 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [PyProj](https://github.com/jswhit/pyproj) ⭐ 1,222 | 🐛 58 | 🌐 Python | 📅 2026-08-21 - For conversions between projections.
...
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 888 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 873 | 🐛 39 | 🌐 C++ | 📅 2026-09-01 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 873 | 🐛 188 | 🌐 Python | 📅 2026-09-01 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [GeoSQL](https://github.com/dekart-xyz/geosql) ⭐ 616 | 🐛 0 | 🌐 Python | 📅 2026-08-31 - Claude/Codex skill (Python package) for cost-safe geospatial SQL on BigQuery and Snowflake. Validates results, prunes partitions, renders interactive maps.
* [pyroSAR](https://github.com/johntruckenbrodt/pyroSAR) ⭐ 613 | 🐛 46 | 🌐 Python | 📅 2026-08-28 - A Python Framework for Large-Scale SAR Satellite Data Processing.
...
* [PySTAC](https://github.com/stac-utils/pystac) ⭐ 460 | 🐛 82 | 🌐 Python | 📅 2026-09-01 - Python library for working with any SpatioTemporal Asset Catalog (STAC).
...
* [geospatial](https://github.com/giswqs/geospatial) ⭐ 433 | 🐛 13 | 🌐 Dockerfile | 📅 2026-09-01 - A collection of Python packages for geospatial analysis and data visualization.
* [pandana](https://github.com/UDST/pandana) ⭐ 423 | 🐛 44 | 🌐 C++ | 📅 2026-08-27 - Pandas Network Analysis - dataframes of network queries, quickly.
...
* [routing-py](https://github.com/gis-ops/routing-py) ⭐ 346 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - Python library to access all public routing, isochrones and matrix APIs in a consistent manner.
...
* [RichDEM](https://github.com/r-barnes/richdem) ⭐ 324 | 🐛 64 | 🌐 C++ | 📅 2024-06-24 - High-performance Terrain and Hydrology Analysis.
* [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 324 | 🐛 42 | 🌐 Python | 📅 2026-08-31 - STAC API implementation with FastAPI.
...
* [urbanaccess](https://github.com/UDST/urbanaccess) ⭐ 265 | 🐛 23 | 🌐 Python | 📅 2026-08-26 - A tool for computing GTFS transit and OSM pedestrian networks for accessibility analysis.
...
* [xyzservices](https://github.com/geopandas/xyzservices) ⭐ 229 | 🐛 14 | 🌐 Python | 📅 2026-08-15 - A unified source of XYZ tile providers in Python.
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 944 | 🐛 18 | 🌐 R | 📅 2026-09-01 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 813 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 777 | 🐛 63 | 🌐 R | 📅 2026-08-31 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 707 | 🐛 16 | 🌐 R | 📅 2026-08-14 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 617 | 🐛 15 | 🌐 C++ | 📅 2026-09-01 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 611 | 🐛 26 | 🌐 R | 📅 2026-08-20 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 546 | 🐛 18 | 🌐 R | 📅 2026-08-31 - Satellite image time series package for R.
...
* [ggspatial](https://github.com/paleolimbot/ggspatial) ⭐ 392 | 🐛 41 | 🌐 R | 📅 2026-09-01 - A ggplot2 R extension for plotting Spatial\* objects.
...
* [landscapemetrics](https://github.com/r-spatialecology/landscapemetrics) ⭐ 263 | 🐛 12 | 🌐 R | 📅 2026-03-17 - landscapemetrics is an R package for calculating landscape metrics for categorical landscape patterns in a tidy workflow.
* [osrm R](https://github.com/rCarto/osrm) ⭐ 254 | 🐛 3 | 🌐 R | 📅 2026-03-12 - Interface Between R and the OpenStreetMap-Based Routing Service OSRM.
* [mapsf](https://github.com/riatelab/mapsf) ⭐ 246 | 🐛 3 | 🌐 R | 📅 2026-09-01 - Thematic cartography with R.
...
* [geodist](https://github.com/hypertidy/geodist) ⭐ 96 | 🐛 10 | 🌐 C | 📅 2026-09-01 - Ultra lightweight, ultra fast calculation of geo distances.
...
* [giscoR](https://github.com/rOpenGov/giscoR) ⭐ 81 | 🐛 0 | 🌐 R | 📅 2026-08-31 - An API package that helps to retrieve data from Eurostat - GISCO (the Geographic Information System of the COmmission).
...
* [biodivMapR](https://github.com/jbferet/biodivMapR) ⭐ 64 | 🐛 0 | 🌐 R | 📅 2026-08-30 - R package for α- and β-diversity mapping using remotely-sensed images.
...
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 55 | 🐛 16 | 🌐 R | 📅 2026-08-30 - R package to download data from Brazil's Population Census.
* [earthEngineGrabR](https://github.com/JesJehle/earthEngineGrabR) ⭐ 55 | 🐛 8 | 🌐 R | 📅 2020-06-24 - The earthEngineGrabR is an interface between R and the Google Earth Engine, which simplifies the acquisition of remote sensing data.
...
* [ROSM](https://github.com/paleolimbot/rosm) ⭐ 29 | 🐛 7 | 🌐 R | 📅 2026-09-01 - Plot Open Street Map and Other Tiles in R.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,693 | 🐛 142 | 🌐 Rust | 📅 2026-09-01 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
...
* [Martin](https://github.com/urbica/martin) ⭐ 3,888 | 🐛 65 | 🌐 Rust | 📅 2026-09-01 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,920 | 🐛 123 | 🌐 Rust | 📅 2026-09-01 - Geospatial primitives and algorithms for Rust.
...
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,570 | 🐛 68 | 🌐 Rust | 📅 2026-08-28 - About Native Maps for Web, Mobile and Desktop.
...
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 637 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23 - 3D Gaussian Splatting renderer for WebAssembly with lock-free multithreading.
...
* [rstar](https://github.com/georust/rstar) ⭐ 555 | 🐛 45 | 🌐 Rust | 📅 2026-08-23 - R\*-tree library for the rust ecosystem.
* [h3o](https://github.com/HydroniumLabs/h3o) ⭐ 541 | 🐛 0 | 🌐 Rust | 📅 2026-08-29 - Rust implementation of the H3 geospatial indexing system.
* [sguaba](https://github.com/helsing-ai/sguaba) ⭐ 510 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - Types for points and vectors in coordinate spaces and transformations based on rigid body transforms.
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 500 | 🐛 120 | 🌐 Rust | 📅 2026-09-01 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [Ferrostar](https://github.com/stadiamaps/ferrostar) ⭐ 413 | 🐛 151 | 🌐 Kotlin | 📅 2026-08-25 - A FOSS navigation SDK built from the ground up for the future.
...
* [tzf-rs](https://github.com/ringsaturn/tzf-rs) ⭐ 108 | 🐛 1 | 🌐 Rust | 📅 2026-09-01 - Get timezone via longitude\&latitude in Rust in a fast way
...
* [las-rs](https://github.com/gadomski/las-rs) ⭐ 104 | 🐛 6 | 🌐 Rust | 📅 2026-08-25 - Read and write ASPRS las files.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 56 | 🌐 Jupyter Notebook | 📅 2026-09-01 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [RouteE Compass](https://github.com/NREL/routee-compass) ⭐ 29 | 🐛 86 | 🌐 Rust | 📅 2026-08-31 - An energy-aware vehicle routing engine.
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 7 | 🌐 Rust | 📅 2026-09-01 - utils & tiles w/ (rs & pyo3).
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 215 | 🌐 Swift | 📅 2026-09-01 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,281 | 🐛 3,479 | 🌐 C++ | 📅 2026-09-01 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,179 | 🐛 581 | 🌐 C++ | 📅 2026-09-01 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 650 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-01 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 559 | 🐛 39 | 🌐 Kotlin | 📅 2026-09-01 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,495 | 🐛 198 | 🌐 Scala | 📅 2026-09-01 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,336 | 🐛 320 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,395 | 🐛 69 | 🌐 Python | 📅 2026-09-01 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,137 | 🐛 162 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,114 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,342 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [deck.gl-raster](https://github.com/developmentseed/deck.gl-raster) ⭐ 227 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-01 - Client-side, GPU-accelerated Cloud-Optimized GeoTIFF visualization in deck.gl.
...
* [Open Location Code](https://github.com/google/open-location-code) ⭐ 4,348 | 🐛 61 | 🌐 Java | 📅 2026-03-30 - Open Location Code is a library to generate short codes, called "plus codes", that can be used as digital addresses where street addresses don't exist.
* [Mapus](https://github.com/alyssaxuu/mapus) ⭐ 3,533 | 🐛 9 | 🌐 JavaScript | 📅 2022-07-02 - Mapus is a tool to explore and annotate collaboratively on a map.
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,162 | 🐛 114 | 🌐 Java | 📅 2026-08-18 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [eodag](https://github.com/CS-SI/eodag) ⭐ 428 | 🐛 180 | 🌐 Python | 📅 2026-09-01 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 280 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 317,778 | 🐛 16 | 🌐 Python | 📅 2026-09-01
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,533 | 🐛 92 | 📅 2024-05-17
...
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,509 | 🐛 67 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,623 | 🐛 3 | 📅 2026-08-10
* [GeoJSON](https://github.com/tmcw/awesome-geojson) ⭐ 2,535 | 🐛 0 | 📅 2026-09-01
* [Awesome-EarthObservation-Code](https://github.com/acgeospatial/awesome-earthobservation-code) ⭐ 1,380 | 🐛 6 | 🌐 HTML | 📅 2026-05-13
* [Awesome SAR](https://github.com/RadarCODE/awesome-sar) ⭐ 1,200 | 🐛 8 | 📅 2025-07-22
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,170 | 🐛 22 | 🌐 Python | 📅 2026-08-30
* [Awesome Frontend GIS](https://github.com/joewdavies/awesome-frontend-gis) ⭐ 855 | 🐛 8 | 📅 2026-08-18 - Geographic Information Systems (GIS) for web browsers. For managing, analyzing, editing, and visualizing geographic data.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 583 | 🐛 3 | 📅 2025-02-20
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 535 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-09-01
...
* [Awesome SQLite](https://github.com/planetopendata/awesome-sqlite) ⭐ 404 | 🐛 6 | 📅 2026-08-22
