...
* [OrientDB](https://github.com/orientechnologies/orientdb) ⭐ 4,985 | 🐛 357 | 🌐 Java | 📅 2026-09-17 - OrientDB is an Open Source Multi-Model NoSQL DBMS with the support of Native Graphs, Documents Full-Text, Reactivity, Geo-Spatial and Object Oriented concepts.
* [TileDB](https://github.com/TileDB-Inc/TileDB) ⭐ 2,078 | 🐛 117 | 🌐 C++ | 📅 2026-09-18 - TileDB is a powerful engine for storing and accessing dense and sparse multi-dimensional arrays, which can help you model any complex data efficiently.
* [Neo4j Spatial](https://github.com/neo4j-contrib/spatial) ⭐ 825 | 🐛 80 | 🌐 Java | 📅 2026-02-28 - Library of spatial utilities for Neo4j.
* [MobilityDB](https://github.com/ULB-CoDE-WIT/MobilityDB) ⭐ 627 | 🐛 9 | 🌐 C | 📅 2026-09-18 - An extension to the Postgres database which adds support for temporal and spatio-temporal objects
...
* [Geolibre](https://github.com/opengeos/GeoLibre) ⭐ 7,463 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-18 - A lightweight, cloud-native GIS platform for visualizing, exploring, and analyzing geospatial data. It runs in the web browser, on the desktop, on mobile, and inside Jupyter notebooks.
...
* [MapLibre GL](https://github.com/maplibre/maplibre-gl-js) ⭐ 11,693 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-18 - Is a community led fork derived from Mapbox GL JS prior to their switch to a non-OSS license.
...
* [L7](https://github.com/antvis/L7) ⭐ 4,063 | 🐛 216 | 🌐 TypeScript | 📅 2026-09-08 - Large-scale WebGL-powered Geospatial Data Visualization By Ant Financial
...
* [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) ⭐ 3,316 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-12 - An SVG mapping component library for React, built on top of d3-geo.
* [globe.gl](https://github.com/vasturiano/globe.gl) ⭐ 3,175 | 🐛 133 | 🌐 HTML | 📅 2026-08-22 - This library is a convenience wrapper around the three-globe plugin, using ThreeJS/WebGL for 3D rendering.
...
* [TerriaJS](https://github.com/TerriaJS/terriajs) ⭐ 1,365 | 🐛 885 | 🌐 TypeScript | 📅 2026-09-17 - A library for building rich, web-based geospatial data explorers.
* [titiler](https://github.com/developmentseed/titiler) ⭐ 1,186 | 🐛 25 | 🌐 Python | 📅 2026-09-18 - A dynamic Web Map tile server.
...
* [d3-geo](https://github.com/d3/d3-geo) ⭐ 1,104 | 🐛 34 | 🌐 JavaScript | 📅 2024-06-28 - A library for creating maps based on D3.js.
...
* [ArcGIS REST JS](https://github.com/Esri/arcgis-rest-js) ⭐ 390 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-18 - Compact, modular JavaScript wrappers for the ArcGIS REST API that run in Node.js and modern browsers.
...
* [Pumperly](https://github.com/GeiserX/pumperly) ⭐ 38 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-18 - Open-source fuel and EV route planner that finds the cheapest stations along your route using PostGIS spatial queries, MapLibre GL JS, Valhalla routing, and Photon geocoding. Covers 36 European countries with real-time pricing.
...
* [Honua SDK JS](https://github.com/honua-io/honua-sdk-js) ⭐ 2 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-18 - TypeScript geospatial client for ArcGIS/Esri GeoServices, OGC API, WFS, WMS/WMTS, STAC, OData, and GeoParquet with a MapLibre runtime and an ArcGIS migration codemod. [Example](https://honua-io.github.io/honua-sdk-js/guides/quickstart.html)
...
* [GeoLens](https://github.com/geolens-io/geolens) ⭐ 247 | 🐛 9 | 🌐 Python | 📅 2026-09-18 - Self-hosted geospatial catalog and map builder on PostGIS; upload data, get vector tiles, style and share maps. Implements OGC API - Features/Records, STAC and DCAT.
...
* [potree](https://github.com/potree/potree/) ⭐ 5,613 | 🐛 822 | 🌐 JavaScript | 📅 2026-01-08 - Potree is a free open-source WebGL based point cloud renderer for large point clouds. PotreeConverter provides all files to view your point cloud with only a basic webserver running.
...
* [Mesa](https://github.com/projectmesa/mesa) ⭐ 3,848 | 🐛 98 | 🌐 Python | 📅 2026-09-17 - Mesa is an Apache2 licensed agent-based modeling (or ABM) framework in Python.
...
* [H3](https://github.com/uber/h3) ⭐ 6,543 | 🐛 168 | 🌐 C | 📅 2026-09-18 - Hexagonal hierarchical geospatial indexing system, written in C with bindings/ports in Python, JavaScript, Java, R, Rust, Go, Swift, and C#.
...
* [OpenSky API](https://github.com/openskynetwork/opensky-api) ⭐ 467 | 🐛 14 | 🌐 Python | 📅 2026-09-14 - Retrieve live airspace information.
...
* [mmsegmentation](https://github.com/open-mmlab/mmsegmentation) ⭐ 9,953 | 🐛 870 | 🌐 Python | 📅 2024-08-13 - MMSegmentation is an open source semantic segmentation toolbox based on PyTorch. It is a part of the OpenMMLab project.
* [TorchGeo](https://github.com/microsoft/torchgeo) ⭐ 4,185 | 🐛 225 | 🌐 Python | 📅 2026-09-18 - TorchGeo is a PyTorch domain library, similar to torchvision, that provides datasets, transforms, samplers, and pre-trained models specific to geospatial data.
* [segment-geospatial](https://github.com/opengeos/segment-geospatial) ⭐ 4,144 | 🐛 6 | 🌐 Python | 📅 2026-09-14 - Meta AI' Segment Anything Model (SAM) for Geospatial Data
...
* [emem](https://github.com/Vortx-AI/emem) ⭐ 58 | 🐛 0 | 🌐 Rust | 📅 2026-09-17 - Earth memory MCP server that gives AI agents signed geospatial facts and cite-able receipts for place-based questions.
...
* [udunits2](https://github.com/Unidata/UDUNITS-2) ⭐ 71 | 🐛 58 | 🌐 C | 📅 2026-09-14 - API and utility for arithmetic manipulation of units of physical quantities.
...
* [Halide](https://github.com/halide/Halide) ⭐ 6,608 | 🐛 774 | 🌐 C++ | 📅 2026-09-18 - Halide is a programming language designed to make it easier to write high-performance image processing code on modern machines.
* [OpenDroneMap](https://github.com/OpenDroneMap/OpenDroneMap) ⭐ 6,478 | 🐛 111 | 🌐 Python | 📅 2026-09-16 - OpenDroneMap is a tool to postprocess drone, balloon, kite, and street view data to geographic data including orthophotos, point clouds, & textured mesh.
* [valhalla](https://github.com/valhalla/valhalla) ⭐ 6,225 | 🐛 940 | 🌐 C++ | 📅 2026-09-17 - Open Source Routing Engine for OpenStreetMap.
...
* [S2 Geometry](https://github.com/google/s2geometry) ⭐ 2,726 | 🐛 86 | 🌐 C++ | 📅 2026-09-15 - Computational geometry and spatial indexing on the sphere.
...
* [osgearth](https://github.com/gwaldron/osgearth) ⭐ 1,801 | 🐛 63 | 🌐 C | 📅 2026-09-17 - A free open source C++ geospatial toolkit.
* [networkit](https://github.com/networkit/networkit) ⭐ 875 | 🐛 78 | 🌐 C++ | 📅 2026-09-18 - NetworKit is a growing open-source toolkit for large-scale network analysis.
...
* [geo-utils-cpp](https://github.com/gistrec/geo-utils-cpp) ⭐ 56 | 🐛 2 | 🌐 C++ | 📅 2026-08-21 - Header-only C++17 library for spherical (lat/lng) geometry: distance, bearing, area, point-in-polygon.
...
* [NTS Net Topology Suite](https://github.com/NetTopologySuite/NetTopologySuite) ⭐ 1,716 | 🐛 55 | 🌐 C# | 📅 2026-09-18 - A .NET GIS solution that is fast and reliable for the .NET platform.
...
* [MaxRev.Gdal.Core](https://github.com/MaxRev-Dev/gdal.netcore) ⭐ 212 | 🐛 3 | 🌐 C# | 📅 2026-09-18 - Bindings for GDAL and OGR (both win-x64 and linux-x64).
...
* [SPECFEM3D\_GLOBE](https://github.com/geodynamics/specfem3d_globe) ⭐ 115 | 🐛 36 | 🌐 Fortran | 📅 2026-09-18 - SPECFEM3D\_GLOBE simulates global and regional (continental-scale) seismic wave propagation.
...
* [Tegola](https://github.com/go-spatial/tegola) ⭐ 1,504 | 🐛 185 | 🌐 Go | 📅 2026-09-18 - Tegola is a vector tile server delivering Mapbox Vector Tiles with support for PostGIS and GeoPackage data providers.
...
* [GraphHopper Routing Engine](https://github.com/graphhopper/graphhopper) ⭐ 6,696 | 🐛 241 | 🌐 Java | 📅 2026-09-18 - GraphHopper is a fast and memory efficient Java routing engine, released under Apache License 2.0. By default it uses OpenStreetMap and GTFS data, but it can import other data sources.
* [Photon](https://github.com/komoot/photon) ⭐ 3,061 | 🐛 42 | 🌐 Java | 📅 2026-09-17 - Photon is an open source geocoder built for OpenStreetMap data. It is based on elasticsearch.
* [JTS Topology Suite](https://github.com/locationtech/jts) ⭐ 2,237 | 🐛 225 | 🌐 Java | 📅 2026-09-15 - JTS Topology Suite is an API of 2D spatial predicates and functions.
...
* [CesiumJS](https://github.com/AnalyticalGraphicsInc/cesium) ⭐ 15,751 | 🐛 1,658 | 🌐 JavaScript | 📅 2026-09-18 - An open-source JavaScript library for world-class 3D globes and maps.
* [deck.gl](https://github.com/uber/deck.gl) ⭐ 14,597 | 🐛 543 | 🌐 TypeScript | 📅 2026-09-18 - WebGL2 powered geospatial visualization layers.
...
* [pixelmatch](https://github.com/mapbox/pixelmatch) ⭐ 6,951 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-15 - The smallest, simplest and fastest JavaScript pixel-level image comparison library.
...
* [rbush](https://github.com/mourner/rbush) ⭐ 2,779 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-03 - A high-performance JavaScript library for 2D spatial indexing.
...
* [Supercluster](https://github.com/mapbox/supercluster) ⭐ 2,376 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-03 - A crazy fast geospatial point clustering library for browsers and Node.
...
* [flatbush](https://github.com/mourner/flatbush) ⭐ 1,601 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-08 - A really fast static spatial index for 2D points and rectangles in JavaScript.
...
* [overpass-turbo](https://github.com/tyrasd/overpass-turbo) ⭐ 1,242 | 🐛 258 | 🌐 TypeScript | 📅 2026-07-19 - A web based data mining tool for OpenStreetMap using Overpass API.
...
* [Terra Draw](https://github.com/JamesLMilner/terra-draw) ⭐ 1,104 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-17 - A cross provider JavaScript library for drawing on maps
* [mapbox-gl-draw](https://github.com/mapbox/mapbox-gl-draw) ⭐ 1,087 | 🐛 241 | 🌐 JavaScript | 📅 2026-09-14 - Draw tools for mapbox-gl-js.
...
* [FlatGeoBuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 825 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [flatten-js](https://github.com/alexbol99/flatten-js) ⭐ 653 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-18 - For manipulating geometrical shapes, finding intersections, checking inclusion, calculating distance, transformations, and more.
...
* [leaflet-elevation](https://github.com/Raruto/leaflet-elevation) ⭐ 282 | 🐛 17 | 🌐 JavaScript | 📅 2026-09-18 - Leaflet plugin that allows to add elevation profiles using d3js
...
* [geoblaze](https://github.com/GeoTIFF/geoblaze) ⭐ 191 | 🐛 55 | 🌐 JavaScript | 📅 2024-08-05 - Geoblaze is a geospatial raster processing engine written purely in javascript.
...
* [Euclid.ts](https://github.com/mathigon/euclid.js) ⭐ 137 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-12 - 2D Euclidean geometry classes, utilities, and drawing tools.
...
* [PureJsImage](https://github.com/a-r-d/PureJsImage) ⭐ 55 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-12 - Zero-dependency TypeScript library for GeoTIFF, COG, GeoZarr, ENVI, and range-backed raster access in browsers and Node.js.
...
* [EarthDataLab.jl](https://github.com/JuliaDataCubes/EarthDataLab.jl) ⭐ 34 | 🐛 51 | 🌐 Julia | 📅 2026-09-18 - Interface for Reading from the Earth System Datacube.
...
* [osmnx](https://github.com/gboeing/osmnx) ⭐ 5,845 | 🐛 3 | 🌐 Python | 📅 2026-07-31 - A tool for downloading, analyzing, and visualizing street networks based on OpenStreetMap data and networkx.
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,251 | 🐛 422 | 🌐 Python | 📅 2026-09-16 - Python tools for geographic data.
...
* [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,383 | 🐛 12 | 🌐 Python | 📅 2026-09-14 - GeoAI: Artificial Intelligence for Geospatial Data
...
* [city2graph](https://github.com/c2g-dev/city2graph) ⭐ 1,919 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Geospatial dataset → graphs (networks) for spatial network analysis and GeoAI with GNNs (Graph Neural Networks)
...
* [CoastSat](https://github.com/kvos/CoastSat) ⭐ 897 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2026-06-05 - CoastSat is an open-source software toolkit written in Python that enables users to obtain time-series of shoreline position at any coastline worldwide from 30+ years (and growing) of publicly available satellite imagery.
...
* [networkit](https://github.com/networkit/networkit) ⭐ 875 | 🐛 78 | 🌐 C++ | 📅 2026-09-18 - NetworKit is a growing open-source toolkit for large-scale network analysis.
* [pyGMT](https://github.com/GenericMappingTools/pygmt) ⭐ 874 | 🐛 190 | 🌐 Python | 📅 2026-09-18 - Pythonic interface for the Generic Mapping Tools (GMT).
...
* [QuackOSM](https://github.com/kraina-ai/quackosm) ⭐ 375 | 🐛 23 | 🌐 Python | 📅 2026-09-18 - Library and a CLI tool for downloading, filtering and transforming `*.osm.pbf` files into `GeoParquet` files using DuckDB.
...
* [routing-py](https://github.com/gis-ops/routing-py) ⭐ 350 | 🐛 13 | 🌐 Python | 📅 2026-09-01 - Python library to access all public routing, isochrones and matrix APIs in a consistent manner.
...
* [RichDEM](https://github.com/r-barnes/richdem) ⭐ 324 | 🐛 64 | 🌐 C++ | 📅 2024-06-24 - High-performance Terrain and Hydrology Analysis.
* [stac-fastapi](https://github.com/stac-utils/stac-fastapi) ⭐ 324 | 🐛 40 | 🌐 Python | 📅 2026-09-09 - STAC API implementation with FastAPI.
...
* [lidar](https://github.com/giswqs/lidar) ⭐ 303 | 🐛 9 | 🌐 Python | 📅 2026-05-25 - Terrain and hydrological analysis using digital elevation models (DEMs).
...
* [HyperCoast](https://github.com/opengeos/HyperCoast) ⭐ 289 | 🐛 3 | 🌐 Python | 📅 2026-09-14 - A Python package for visualizing and analyzing hyperspectral data in coastal regions.
...
* [geosnap](https://github.com/spatialucr/geosnap) ⭐ 276 | 🐛 19 | 🌐 Python | 📅 2026-03-09 - geosnap makes it easier to explore, model, analyze, and visualize the social and spatial dynamics of neighborhoods.
...
* [geobr](https://github.com/ipeaGIT/geobr) ⭐ 950 | 🐛 19 | 🌐 Python | 📅 2026-09-18 - Package to download official spatial data sets of Brazil.
* [ranger](https://github.com/imbs-hl/ranger) ⭐ 815 | 🐛 108 | 🌐 C++ | 📅 2026-02-01 - A Fast Implementation of Random Forests.
* [rgee](https://github.com/r-spatial/rgee) ⭐ 777 | 🐛 64 | 🌐 R | 📅 2026-09-14 - Google Earth Engine for R.
* [lidR](https://github.com/Jean-Romain/lidR) ⭐ 710 | 🐛 16 | 🌐 R | 📅 2026-09-04 - R package for airborne LiDAR data manipulation and visualisation for forestry application.
* [terra](https://github.com/rspatial/terra) ⭐ 620 | 🐛 17 | 🌐 C++ | 📅 2026-09-16 - terra is an R package that replaces raster. It has a very similar, but simpler, interface, and it is much faster.
* [stars](https://github.com/r-spatial/stars) ⭐ 612 | 🐛 26 | 🌐 R | 📅 2026-09-11 - Spatiotemporal tidy arrays for R.
* [sits](https://github.com/e-sensing/sits) ⭐ 548 | 🐛 19 | 🌐 R | 📅 2026-09-17 - Satellite image time series package for R.
...
* [r5r](https://github.com/ipeaGIT/r5r) ⭐ 241 | 🐛 32 | 🌐 R | 📅 2026-09-14 - Package for rapid realistic routing on multimodal transport networks (walk, bike, public transport and car).
...
* [Makurhini](https://github.com/connectscape/Makurhini) ⭐ 57 | 🐛 14 | 🌐 HTML | 📅 2026-06-22 - R package for calculating fragmentation and landscape connectivity indices used in conservation planning.
* [censobr](https://github.com/ipeaGIT/censobr) ⭐ 56 | 🐛 9 | 🌐 R | 📅 2026-09-17 - R package to download data from Brazil's Population Census.
...
* [Mongoid Geospatial](https://github.com/nofxx/mongoid-geospatial) ⭐ 80 | 🐛 12 | 🌐 Ruby | 📅 2026-09-18 - A Mongoid Extension that simplifies the use of MongoDB spatial features.
...
* [Arnis](https://github.com/louis-e/arnis) ⭐ 17,979 | 🐛 128 | 🌐 Rust | 📅 2026-09-18 - Generate any location from the real world in Minecraft Java Edition with a high level of detail.
* [A/B Street](https://github.com/dabreegster/abstreet) ⭐ 8,179 | 🐛 234 | 🌐 Rust | 📅 2025-09-10 - A traffic simulation game exploring how small changes to roads affect cyclists, transit users, pedestrians, and drivers.
* [Martin](https://github.com/urbica/martin) ⭐ 3,926 | 🐛 51 | 🌐 Rust | 📅 2026-09-18 - Martin is a PostGIS vector tiles server suitable for large databases. Martin is written in Rust using Actix web framework.
* [geo](https://github.com/georust/rust-geo) ⭐ 1,938 | 🐛 137 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives and algorithms for Rust.
* [rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,758 | 🐛 136 | 🌐 Rust | 📅 2026-09-18 - A high-performance, general-purpose graph library for Python, written in Rust.
* [maplibre-rs](https://github.com/maplibre/maplibre-rs) ⭐ 1,574 | 🐛 70 | 🌐 Rust | 📅 2026-09-18 - About Native Maps for Web, Mobile and Desktop.
...
* [GeoPolars](https://github.com/geopolars/geopolars) ⭐ 917 | 🐛 27 | 🌐 Python | 📅 2026-09-18 - Geospatial extensions for Polars.
* [FlatGeobuf](https://github.com/flatgeobuf/flatgeobuf) ⭐ 825 | 🐛 35 | 🌐 Rust | 📅 2026-08-21 - A performant binary encoding for geographic data based on flatbuffers.
* [Galileo](https://github.com/Maximkaaa/galileo) ⭐ 645 | 🐛 43 | 🌐 Rust | 📅 2026-07-30 - General purpose cross-platform geo-rendering library.
* [Gauzilla](https://github.com/BladeTransformerLLC/gauzilla) ⭐ 642 | 🐛 0 | 🌐 JavaScript | 📅 2025-05-23 - 3D Gaussian Splatting renderer for WebAssembly with lock-free multithreading.
...
* [rstar](https://github.com/georust/rstar) ⭐ 560 | 🐛 48 | 🌐 Rust | 📅 2026-09-11 - R\*-tree library for the rust ecosystem.
...
* [SedonaDB](https://github.com/apache/sedona-db) ⭐ 504 | 🐛 120 | 🌐 Rust | 📅 2026-09-18 - Single-node analytical database engine with geospatial as the first-class citizen.
...
* [Ferrostar](https://github.com/stadiamaps/ferrostar) ⭐ 424 | 🐛 142 | 🌐 Kotlin | 📅 2026-09-15 - A FOSS navigation SDK built from the ground up for the future.
...
* [zarrs](https://github.com/LDeakin/zarrs) ⭐ 271 | 🐛 21 | 🌐 Rust | 📅 2026-09-15 - A rust library for the Zarr V3 storage format for multidimensional arrays and metadata.
...
* [rgeometry](https://github.com/rgeometry/rgeometry) ⭐ 182 | 🐛 8 | 🌐 Rust | 📅 2026-09-15 - Computational Geometry library written in Rust.
...
* [iTriangle](https://github.com/iShape-Rust/iTriangle) ⭐ 160 | 🐛 4 | 🌐 Rust | 📅 2026-08-24 - A fast, stable, and robust 2d triangulation library.
...
* [Karttapullautin](https://github.com/karttapullautin/karttapullautin) ⭐ 90 | 🐛 11 | 🌐 Rust | 📅 2026-09-08 - A fast and accurate map generator from classified LiDAR data.
...
* [Geo Engine](https://github.com/geo-engine/geoengine) ⭐ 49 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-18 - Cloud-ready geospatial data processing platform with workflows, raster *and* vector support and OGC-compliant interfaces.
...
* [utiles](https://github.com/jessekrubin/utiles) ⭐ 29 | 🐛 4 | 🌐 Rust | 📅 2026-09-18 - utils & tiles w/ (rs & pyo3).
...
* [jord](https://github.com/ofmooseandmen/jord-rs) ⭐ 16 | 🐛 1 | 🌐 Rust | 📅 2026-09-18 - Geographical Position Calculations (spherical + ellipsoidal models and local frames).
...
* [rusqlite-gpkg](https://github.com/yutannihilation/rusqlite-gpkg) ⭐ 14 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 - GeoPackage reader/writer built on top of rusqlite.
...
* [Mapbox Navigation SDK for iOS](https://github.com/mapbox/mapbox-navigation-ios) ⭐ 918 | 🐛 216 | 🌐 Swift | 📅 2026-09-18 - Turn-by-turn navigation logic and UI in Swift or Objective-C on iOS.
...
* [Organic Maps](https://github.com/organicmaps/organicmaps) ⭐ 15,449 | 🐛 3,524 | 🌐 C++ | 📅 2026-09-18 - Organic Maps is a better fork of MAPS.ME, an Android & iOS offline maps app for travelers, tourists, hikers, and cyclists based on top of crowd-sourced OpenStreetMap data and curated with love by MAPS.ME founders. No ads, no tracking, no data collection, no crapware.
...
* [MapLibre GL Native](https://github.com/maplibre/maplibre-gl-native) ⭐ 2,216 | 🐛 616 | 🌐 C++ | 📅 2026-09-18 - The open-source alternative to Mapbox GL Native. SDKs for iOS, Android and other platforms
* [mapbox-navigation-android](https://github.com/mapbox/mapbox-navigation-android) ⭐ 651 | 🐛 518 | 🌐 Kotlin | 📅 2026-09-18 - Mapbox Navigation SDK for Android.
* [MapLibre Compose](https://github.com/maplibre/maplibre-compose) ⭐ 573 | 🐛 21 | 🌐 Kotlin | 📅 2026-09-18 - Add interactive vector tile maps to your Compose app
...
* [GeoMesa](https://github.com/locationtech/geomesa) ⭐ 1,497 | 🐛 199 | 🌐 Scala | 📅 2026-09-18 - GeoMesa is a suite of tools for working with big geo-spatial data in a distributed fashion.
...
* [GeoWave](https://github.com/locationtech/geowave) ⭐ 528 | 🐛 93 | 🌐 Java | 📅 2026-09-18 - GeoWave provides geospatial and temporal indexing on top of Accumulo and HBase.
...
* [Blender GIS](https://github.com/domlysz/BlenderGIS) ⭐ 9,396 | 🐛 321 | 🌐 Python | 📅 2025-12-20 - Blender addons to make the bridge between Blender and geographic data.
* [Folium](https://github.com/python-visualization/folium) ⭐ 7,400 | 🐛 71 | 🌐 Python | 📅 2026-09-18 - Python Data. Leaflet.js Maps.
* [PlotJuggler](https://github.com/facontidavide/PlotJuggler) ⭐ 6,188 | 🐛 164 | 🌐 C++ | 📅 2026-08-10 - PlotJuggler is a tool to visualize time series that is fast, powerful and intuitive.
* [tippecanoe](https://github.com/mapbox/tippecanoe) ⭐ 3,120 | 🐛 217 | 🌐 C++ | 📅 2026-06-29 - Build vector tilesets from large collections of GeoJSON features.
* [procedural-gl-js](https://github.com/felixpalmer/procedural-gl-js) ⭐ 1,345 | 🐛 22 | 🌐 JavaScript | 📅 2021-05-11 - Procedural GL JS is a library for creating 3D map experiences on the web, written in JavaScript and WebGL. It is built on top THREE.js.
...
* [circlize](https://github.com/jokergoo/circlize) ⭐ 1,022 | 🐛 67 | 🌐 R | 📅 2023-11-11 - Circular visualization in R. Circular layout is an efficient way for the visualization of huge amounts of information.
...
* [GeoViews](https://github.com/holoviz/geoviews) ⭐ 634 | 🐛 118 | 🌐 Python | 📅 2026-09-18 - GeoViews is a Python library that makes it easy to explore and visualize any data that includes geographic locations.
...
* [Planetiler](https://github.com/onthegomap/planetiler) ⭐ 2,181 | 🐛 111 | 🌐 Java | 📅 2026-09-18 - Flexible tool to build planet-scale vector tilesets from OpenStreetMap data in a few hours.
...
* [Generic Mapping Tools](https://github.com/GenericMappingTools/gmt) ⭐ 980 | 🐛 217 | 🌐 C | 📅 2026-09-18 - GMT is an open source collection of about 90 command-line tools for manipulating geographic and Cartesian data sets.
* [eodag](https://github.com/CS-SI/eodag) ⭐ 434 | 🐛 174 | 🌐 Python | 📅 2026-09-18 - Command line tool and a plugin-oriented Python framework for searching, aggregating results and downloading remote sensed images while offering a unified API for data access regardless of the data provider.
...
* [nextgisweb](https://github.com/nextgis/nextgisweb) ⭐ 283 | 🐛 2 | 🌐 Python | 📅 2026-09-18 - Server based application/server-side framework for geodata storage, management and visualization.
...
* [RoadDetections](https://github.com/microsoft/RoadDetections) ⭐ 639 | 🐛 9 | 🌐 C# | 📅 2026-05-05 - Road detections from Microsoft Maps aerial imagery.
* [Ookla internet speed data](https://github.com/teamookla/ookla-open-data) ⭐ 320 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-04-16 - Global network performance metrics.
...
* [GeoParquet](https://github.com/opengeospatial/geoparquet) ⭐ 1,090 | 🐛 49 | 🌐 Python | 📅 2026-09-07 - Specification for storing geospatial vector data (point, line, polygon) in Parquet.
...
* [Awesome Python](https://github.com/vinta/awesome-python/blob/master/README.md) ⭐ 321,541 | 🐛 24 | 🌐 Python | 📅 2026-09-15
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,562 | 🐛 97 | 📅 2024-05-17
...
* [Awesome GIS - sshuair](https://github.com/sshuair/awesome-gis) ⭐ 5,528 | 🐛 72 | 📅 2026-07-21
* [Awesome Satellite Imagery Datasets](https://github.com/chrieke/awesome-satellite-imagery-datasets) ⚠️ Archived
* [Vector Tiles](https://github.com/mapbox/awesome-vector-tiles) ⭐ 2,631 | 🐛 3 | 📅 2026-08-10
...
* [Awesome Spectral Indices](https://github.com/awesome-spectral-indices/awesome-spectral-indices) ⭐ 1,180 | 🐛 23 | 🌐 Python | 📅 2026-09-13
...
* [Digital Earth Australia notebooks and tools repository](https://github.com/GeoscienceAustralia/dea-notebooks) ⭐ 540 | 🐛 46 | 🌐 Jupyter Notebook | 📅 2026-09-15
...
* [Awesome GERS](https://github.com/OvertureMaps/awesome-gers) ⭐ 2 | 🐛 0 | 📅 2026-05-01 - A curated list of GERS resources: docs, tools (overturemaps-py, overtureR, Fused UDFs), platform integrations (Esri, CARTO, Databricks, Wherobots), tutorials, talks, and case studies.
